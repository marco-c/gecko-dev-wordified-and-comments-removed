...
def
verify_final_fields_only_class
(
clazz
)
:
...
def
verify_method_name_not_kotlin_operator
(
clazz
)
:
...
def
verify_collections_over_arrays
(
clazz
)
:
...
None
def
get_deprecation_schedule_annotation
(
subject
)
:
