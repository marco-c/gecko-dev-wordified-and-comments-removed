...
:
'
Zanwuyekalo_Fewuruyekalo_Marisikalo_Awirilikalo_M
kalo_Zuw
nkalo_Zuluyekalo_Utikalo_S
tanburukalo_
kut
burukalo_Nowanburukalo_Desanburukalo
'
.
split
(
...
Kari_Nt
n
n_Tarata_Araba_Alamisa_Juma_Sibiri
'
.
split
(
...
\
'
hwevrer_Meurzh_Ebrel_Mae_Mezheven_Gouere_Eost_Gwengolo_Here_Du_Kerzu
'
.
split
(
...
\
'
hwe_Meu_Ebr_Mae_Eve_Gou_Eos_Gwe_Her_Du_Ker
'
.
split
(
...
:
'
nedjelja_ponedjeljak_utorak_srijeda_
etvrtak_petak_subota
'
.
split
(
...
'
gener_febrer_mar
_abril_maig_juny_juliol_agost_setembre_octubre_novembre_desembre
'
.
split
(
...
'
s
ndag_mandag_tirsdag_onsdag_torsdag_fredag_l
rdag
'
.
split
...
:
'
januaro_februaro_marto_aprilo_majo_junio_julio_a
...
:
'
domingo_lunes_martes_mi
rcoles_jueves_viernes_s
bado
'
.
split
...
'
jaan_veebr_m
rts_apr_mai_juuni_juuli_aug_sept_okt_nov_dets
'
.
split
(
...
kuu_hein
kuu_elokuu_syyskuu_lokakuu_marraskuu_joulukuu
'
.
split
(
...
:
'
januar_februar_mars_apr
l_mai_juni_juli_august_september_oktober_november_desember
'
.
split
(
...
'
janvier_f
vrier_mars_avril_mai_juin_juillet_ao
t_septembre_octobre_novembre_d
cembre
'
.
split
...
:
'
xaneiro_febreiro_marzo_abril_maio_xu
...
:
'
domingo_luns_martes_m
rcores_xoves_venres_s
bado
'
.
split
...
:
'
Aitar_Somar_Mongllar_Budvar_Brestar_Sukrar_Son
\
'
var
'
...
ri
judagur_mi
vikudagur_fimmtudagur_f
studagur_laugardagur
'
.
split
(
...
Januar_Februar_M
erz_Abr
ll_Mee_Juni_Juli_August_September_Oktober_November_Dezember
'
.
split
(
...
indeg_D
nschdeg_M
ttwoch_Donneschdeg_Freideg_Samschdeg
'
.
split
(
...
:
'
sausis_vasaris_kovas_balandis_gegu
_bir
elis_liepa_rugpj
tis_rugs
...
:
'
sekmadienis_pirmadienis_antradienis_tre
iadienis_ketvirtadienis_penktadienis_
e
tadienis
'
.
...
lis_maijs_j
nijs_j
lijs_augusts_septembris_oktobris_novembris_decembris
'
.
split
(
...
:
'
jan_feb_mar_apr_mai_j
n_j
l_aug_sep_okt_nov_dec
'
.
split
(
...
:
'
Jannar_Frar_Marzu_April_Mejju_
unju_Lulju_Awwissu_Settembru_Ottubru_Novembru_Di
embru
'
.
split
...
'
sundag_m
ndag_tysdag_onsdag_torsdag_fredag_laurdag
'
.
split
(
...
'
stycze
_luty_marzec_kwiecie
_maj_czerwiec_lipiec_sierpie
_wrzesie
_pa
dziernik_listopad_grudzie
'
.
split
(
...
:
'
sty_lut_mar_kwi_maj_cze_lip_sie_wrz_pa
_lis_gru
'
.
split
...
:
'
Janeiro_Fevereiro_Mar
o_Abril_Maio_Junho_Julho_Agosto_Setembro_Outubro_Novembro_Dezembro
'
.
split
(
...
'
o
j_guov_njuk_cuo_mies_geas_suoi_borg_
ak
_golg_sk
b_juov
'
...
rga_ma
eb
rga_gaskavahkku_duorastat_bearjadat_l
vvardat
'
.
split
...
'
nede
a_pondelok_utorok_streda_
tvrtok_piatok_sobota
'
.
split
(
...
:
'
Janar_Shkurt_Mars_Prill_Maj_Qershor_Korrik_Gusht_Shtator_Tetor_N
ntor_Dhjetor
'
.
split
...
:
'
Jan_Shk_Mar_Pri_Maj_Qer_Kor_Gus_Sht_Tet_N
n_Dhj
'
.
split
...
:
'
nedelja_ponedeljak_utorak_sreda_
etvrtak_petak_subota
'
.
split
...
'
lenkhulu_Mabasa_Inkhwekhweti_Inhlaba_Kholwane_Ingci_Inyoni_Imphala_Lweti_Ingongoni
"
.
split
(
...
s
ndag_m
ndag_tisdag_onsdag_torsdag_fredag_l
rdag
'
.
split
...
:
'
Dom_Seg_Ters_Kua_Kint_Sest_Sab
'
.
split
(
...
pagh_wa
_cha
_wej_loS_vagh_jav_Soch_chorgh_Hut
'
.
split
(
...
_Avr
u_Mai_G
n_Julia_Guscht_Setemvar_Listop
ts_Noemvar_Zecemvar
'
.
split
...
:
'
Jan_Fev_Mar_Avr_Mai_G
n_Jul_Gus_Set_Lis_Noe_Zec
'
.
split
(
...
:
'
asamas_aynas_asinas_akras_akwas_asimwas_asi
yas
'
.
split
