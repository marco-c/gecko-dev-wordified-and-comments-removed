...
runBlocking
{
getDefaultSearchEngineIdentifierForTelemetry
(
context
)
}
...
JvmStatic
fun
openLinkInFullBrowserFromCustomTabEvent
(
)
{
withSessionCounts
...
fun
reorderAutocompleteDomainEvent
(
from
:
Int
...
JvmStatic
fun
respondToSearchSuggestionPrompt
(
enable
:
Boolean
