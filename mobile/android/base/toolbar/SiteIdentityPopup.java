...
private
DoorHanger
mTrackingContentNotification
;
private
DoorHanger
mSelectLoginDoorhanger
;
private
final
OnButtonClickListener
mContentButtonClickListener
;
public
SiteIdentityPopup
(
...
=
new
ContentNotificationButtonListener
(
)
;
EventDispatcher
...
id
.
site_identity_unknown_container
)
;
mTitle
=
...
;
toggleIdentityKnownContainerVisibility
(
isIdentityKnown
)
;
...
string
.
doorhanger_login_select_toast_copy_error
Toast
.
LENGTH_SHORT
)
...
string
.
doorhanger_login_select_message
)
.
replace
(
...
private
void
addTrackingContentNotification
(
boolean
blocked
)
...
string
.
loaded_tracking_content_message_top
)
+
"
\
...
string
.
loaded_tracking_content_message_bottom
)
)
;
}
