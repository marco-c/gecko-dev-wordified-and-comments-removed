...
void
AssertSpanOfThreeCharsViaString
(
const
nsACString
&
...
SPAN_TEST
(
from_nullptr_length_constructor
)
{
{
Span
...
SPAN_TEST
(
from_mozilla_array_constructor
)
{
mozilla
:
...
SPAN_TEST
(
from_const_mozilla_array_constructor
)
{
const
mozilla
...
SPAN_TEST
(
from_mozilla_array_const_constructor
)
{
mozilla
:
...
SPAN_TEST
(
split_at_dynamic_with_dynamic_extent
)
{
static
constexpr
...
SPAN_TEST
(
split_at_dynamic_with_static_extent
)
{
static
constexpr
...
SPAN_TEST
(
construct_from_iterators_dynamic
)
{
const
int
...
SPAN_TEST
(
construct_from_iterators_static
)
{
static
constexpr
...
SPAN_TEST
(
construct_from_container_with_type_deduction
)
{
std
:
