...
:
:
LoadLightweightMemoryTableFromDisk
(
)
{
MOZ_ASSERT
...
:
:
LoadHeavyweightMemoryTableFromDisk
(
)
{
MOZ_ASSERT
...
(
new
OriginAttrsPatternMatchOriginSQLFunction
(
aOriginAttributesPattern
)
)
...
(
"
ORIGIN_ATTRS_PATTERN_MATCH_ORIGIN
"
_ns
1
patternMatchFunction
...
auto
constexpr
deletePrincipalQueryLightweight
=
"
DELETE
FROM
...
auto
constexpr
deleteBaseDomainQueryLightweight
=
"
DELETE
FROM
...
(
"
PRIVATE_BROWSING_PATTERN_MATCH_ORIGIN
"
_ns
1
patternMatchFunction
