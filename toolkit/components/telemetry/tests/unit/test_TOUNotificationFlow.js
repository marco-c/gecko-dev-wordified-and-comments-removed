...
async
function
test_modal_not_shown_on_non_eligible_linux
(
)
{
if
...
async
function
test_modal_shown_on_eligible_linux
(
)
{
if
...
async
function
test_as_telemetry_pref_set_before_tou_acceptance
(
)
{
const
...
;
const
ACTIVITY_STREAM_TELEMETRY_PREF
=
"
browser
.
...
async
function
test_linux_tou_eligible_blocks_upload_before_acceptance
(
)
{
Services
...
async
function
test_linux_tou_eligible_allows_upload_after_acceptance
(
)
{
Services
...
async
function
test_linux_non_mozilla_distro_upload_unblocked
(
)
{
Services
...
async
function
test_showModal_passes_browser_element_to_handleAction
(
)
{
const
