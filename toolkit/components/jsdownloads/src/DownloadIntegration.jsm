...
:
false
shouldBlockInTestForRuntimePermissions
:
false
#
ifdef
...
shouldBlockInTestForApplicationReputation
:
false
...
(
function
task_DI_initializePublicDownloadList
(
)
{
if
...
:
function
DI_shouldBlockForRuntimePermissions
(
)
{
if
