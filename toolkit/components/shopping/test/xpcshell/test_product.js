...
poll
/
poll_analysis_response
.
json
"
;
const
API_ANALYSIS_IN_PROGRESS
=
"
http
:
...
=
"
1ALhiNLkZ2yR4al5lcP1Npbtlpl5toDfKRgJOATjeieAL6i5Dul99l9
+
ZTiIWyybUzGysChAdrOA6BWrMqr0EvjoymiH3veZ
+
+
XuOvJnC0y1NB
/
IQQtUzlYEO028XqVUJWJeJte47nPhnK2pSm2QhbdeKbxEnauKAty1cFQeEaBUP7LkvUgxh1GDzflwcVfuKcgMr7hOM3NzjYR2RN3vhmT385Ps4wUj
-
-
cv2ucc
+
...
data
/
analysis_status_pending_response
.
json
"
)
...
data
/
analysis_status_in_progress_response
.
json
"
)
...
data
/
analysis_status_completed_response
.
json
"
)
...
async
function
test_product_requestAnalysis_invalid_allowed
(
)
{
let
...
async
function
test_product_requestAnalysis_invalid_allowed_ohttp
(
)
{
let
...
async
function
test_product_sendAttributionEvent_impression
(
)
{
let
...
async
function
test_product_sendAttributionEvent_click
(
)
{
let
...
async
function
test_product_sendAttributionEvent_impression_OHTTP
(
)
{
let
...
async
function
test_product_sendAttributionEvent_click_OHTTP
(
)
{
let
...
async
function
test_product_sendAttributionEvent_placement_OHTTP
(
)
{
let
...
async
function
test_product_requestAnalysis_poll
(
)
{
let
...
async
function
test_product_requestAnalysis_poll_max
(
)
{
let
...
async
function
test_product_requestAnalysisCreationStatus
(
)
{
let
...
async
function
test_product_requestCreateAnalysis
(
)
{
let
...
async
function
test_product_analysisProgress_event
(
)
{
let
