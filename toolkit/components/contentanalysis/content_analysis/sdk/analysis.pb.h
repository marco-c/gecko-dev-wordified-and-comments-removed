...
const
uint32_t
AnalysisConnector_internal_data_
[
]
;
enum
...
const
uint32_t
ClientDownloadRequest_ResourceType_internal_data_
[
]
;
enum
...
const
uint32_t
ContentAnalysisAcknowledgement_FinalAction_internal_data_
[
]
;
enum
...
const
uint32_t
ContentAnalysisAcknowledgement_Status_internal_data_
[
]
;
enum
...
const
uint32_t
ContentAnalysisRequest_Reason_internal_data_
[
]
;
enum
...
const
uint32_t
ContentAnalysisResponse_Result_Status_internal_data_
[
]
;
enum
...
const
uint32_t
ContentAnalysisResponse_Result_TriggeredRule_Action_internal_data_
[
]
;
enum
...
const
uint32_t
ContentMetaData_PrintMetadata_PrinterType_internal_data_
[
]
;
class
...
extern
ClientDownloadRequestGlobalsTypeInternal
ClientDownloadRequest_globals_
;
extern
const
:
...
:
ClassDataLite
ClientDownloadRequest_class_data_
;
#
else
extern
...
extern
ClientDownloadRequest_ResourceGlobalsTypeInternal
ClientDownloadRequest_Resource_globals_
;
extern
const
:
...
:
ClassDataLite
ClientDownloadRequest_Resource_class_data_
;
#
else
extern
...
extern
ClientMetadata_BrowserGlobalsTypeInternal
ClientMetadata_Browser_globals_
;
extern
const
:
...
:
ClassDataLite
ClientMetadata_Browser_class_data_
;
#
else
extern
...
extern
ContentAnalysisAcknowledgementGlobalsTypeInternal
ContentAnalysisAcknowledgement_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisAcknowledgement_class_data_
;
#
else
extern
...
extern
ContentAnalysisCancelRequestsGlobalsTypeInternal
ContentAnalysisCancelRequests_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisCancelRequests_class_data_
;
#
else
extern
...
extern
ContentAnalysisRequestGlobalsTypeInternal
ContentAnalysisRequest_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisRequest_class_data_
;
#
else
extern
...
extern
ContentAnalysisRequest_PrintDataGlobalsTypeInternal
ContentAnalysisRequest_PrintData_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisRequest_PrintData_class_data_
;
#
else
extern
...
extern
ContentAnalysisResponseGlobalsTypeInternal
ContentAnalysisResponse_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisResponse_class_data_
;
#
else
extern
...
extern
ContentAnalysisResponse_ResultGlobalsTypeInternal
ContentAnalysisResponse_Result_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisResponse_Result_class_data_
;
#
else
extern
...
extern
ContentAnalysisResponse_Result_TriggeredRuleGlobalsTypeInternal
ContentAnalysisResponse_Result_TriggeredRule_globals_
;
extern
const
:
...
:
ClassDataLite
ContentAnalysisResponse_Result_TriggeredRule_class_data_
;
#
else
extern
...
extern
ContentMetaData_PrintMetadataGlobalsTypeInternal
ContentMetaData_PrintMetadata_globals_
;
extern
const
:
...
:
ClassDataLite
ContentMetaData_PrintMetadata_class_data_
;
#
else
extern
...
inline
bool
ContentMetaData_PrintMetadata_PrinterType_IsValid
(
int
value
)
...
string
&
ContentMetaData_PrintMetadata_PrinterType_Name
(
ContentMetaData_PrintMetadata_PrinterType
value
)
...
bool
ContentMetaData_PrintMetadata_PrinterType_Parse
(
:
:
absl
...
inline
bool
ContentAnalysisRequest_Reason_IsValid
(
int
value
)
...
bool
ContentAnalysisRequest_Reason_Parse
(
:
:
absl
...
inline
bool
ContentAnalysisResponse_Result_TriggeredRule_Action_IsValid
(
int
value
)
...
bool
ContentAnalysisResponse_Result_TriggeredRule_Action_Parse
(
:
:
absl
...
inline
bool
ContentAnalysisResponse_Result_Status_IsValid
(
int
value
)
...
string
&
ContentAnalysisResponse_Result_Status_Name
(
ContentAnalysisResponse_Result_Status
value
)
...
bool
ContentAnalysisResponse_Result_Status_Parse
(
:
:
absl
...
inline
bool
ContentAnalysisAcknowledgement_Status_IsValid
(
int
value
)
...
string
&
ContentAnalysisAcknowledgement_Status_Name
(
ContentAnalysisAcknowledgement_Status
value
)
...
bool
ContentAnalysisAcknowledgement_Status_Parse
(
:
:
absl
...
inline
bool
ContentAnalysisAcknowledgement_FinalAction_IsValid
(
int
value
)
...
string
&
ContentAnalysisAcknowledgement_FinalAction_Name
(
ContentAnalysisAcknowledgement_FinalAction
value
)
...
bool
ContentAnalysisAcknowledgement_FinalAction_Parse
(
:
:
absl
...
int
{
kPrinterNameFieldNumber
=
1
kPrinterTypeFieldNumber
=
2
}
;
...
*
PROTOBUF_NULLABLE
release_printer_name
(
)
;
void
set_allocated_printer_name
(
:
:
std
...
*
PROTOBUF_NONNULL
_internal_mutable_printer_name
(
)
;
public
...
:
ContentMetaData_PrintMetadata_PrinterType
_internal_printer_type
(
)
const
;
void
_internal_set_printer_type
(
:
:
content_analysis
...
*
PROTOBUF_NONNULL
_internal_mutable_request_token
(
)
;
public
...
*
PROTOBUF_NULLABLE
release_machine_user
(
)
;
void
set_allocated_machine_user
(
:
:
std
...
*
PROTOBUF_NONNULL
_internal_mutable_machine_user
(
)
;
public
...
:
int
_internal_triggered_rules_size
(
)
const
;
...
*
PROTOBUF_NONNULL
_internal_mutable_triggered_rules
(
)
;
public
...
;
void
unsafe_arena_set_allocated_browser
(
:
:
content_analysis
...
=
5
kTabTitleFieldNumber
=
9
kCsdFieldNumber
=
4
kPrintMetadataFieldNumber
=
11
}
;
...
;
void
unsafe_arena_set_allocated_csd
(
:
:
content_analysis
...
;
void
unsafe_arena_set_allocated_print_metadata
(
:
:
content_analysis
...
=
16
kRequestDataFieldNumber
=
10
kClientMetadataFieldNumber
=
12
kAnalysisConnectorFieldNumber
=
9
kReasonFieldNumber
=
19
kExpiresAtFieldNumber
=
15
kUserActionRequestsCountFieldNumber
=
17
kTextContentFieldNumber
=
13
kFilePathFieldNumber
=
14
kPrintDataFieldNumber
=
18
}
;
...
;
void
unsafe_arena_set_allocated_request_data
(
:
:
content_analysis
...
*
PROTOBUF_NULLABLE
unsafe_arena_release_request_data
(
)
;
private
...
*
PROTOBUF_NONNULL
_internal_mutable_request_data
(
)
;
public
...
*
PROTOBUF_NULLABLE
unsafe_arena_release_client_metadata
(
)
;
private
...
*
PROTOBUF_NONNULL
_internal_mutable_client_metadata
(
)
;
public
...
:
int64_t
_internal_expires_at
(
)
const
;
void
_internal_set_expires_at
(
:
:
int64_t
...
bool
has_user_action_requests_count
(
)
const
;
void
clear_user_action_requests_count
(
)
;
[
...
:
int64_t
_internal_user_action_requests_count
(
)
const
;
void
_internal_set_user_action_requests_count
(
:
:
int64_t
...
*
PROTOBUF_NONNULL
_internal_mutable_text_content
(
)
;
public
...
;
void
unsafe_arena_set_allocated_print_data
(
:
:
content_analysis
...
*
PROTOBUF_NULLABLE
unsafe_arena_release_print_data
(
)
;
private
...
;
void
unsafe_arena_set_allocated_ack
(
:
:
content_analysis
...
;
void
unsafe_arena_set_allocated_cancel
(
:
:
content_analysis
