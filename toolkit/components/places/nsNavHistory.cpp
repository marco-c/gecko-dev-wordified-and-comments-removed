...
:
:
GetIsAlternativeFrecencyEnabled
(
bool
*
_out
...
:
:
GetShouldStartFrecencyRecalculation
(
bool
*
_out
...
:
:
SetShouldStartFrecencyRecalculation
(
bool
aVal
)
