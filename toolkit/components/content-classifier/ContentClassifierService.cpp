...
;
bool
HasAnyActiveRemoteSettingsFeatures
(
)
{
nsTArray
...
ListBytesPromise
>
FetchListBytesFromRemoteSettings
(
nsIContentClassifierRemoteSettingsClient
*
aClient
...
:
:
privacy_trackingprotection_content_protection_enabled
(
)
)
{
