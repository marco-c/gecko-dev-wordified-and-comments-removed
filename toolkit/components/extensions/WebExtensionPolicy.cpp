...
#
define
BASE_CSP_PREF_V3_WITH_LOCALHOST
\
"
extensions
.
...
#
define
DEFAULT_BASE_CSP_V3_WITH_LOCALHOST
\
"
script
-
...
:
:
extensions_webextensions_fileSchemeAccess_requireOptIn
(
)
)
{
...
:
:
ClearCachedIgnoreQuarantineValue
(
this
)
;
...
:
:
SetHasRecommendedState
(
bool
aHasRecommendedState
)
{
mCore
-
...
{
LogMozExtExecuteScriptDeprecationWarning
(
aURL
innerWindowID
allowed
...
:
:
MatchMozExtensionDocumentExtra
(
Some
(
nsAtomCString
