...
#
define
GROWL_USER_CHOSE_NOT_TO_INSTALL_NOTIFICATION
"
User
chose
not
...
notificationDictionaryByFillingInDictionary
:
(
NSDictionary
*
...
NSObject
(
GrowlApplicationBridgeDelegate_InformalProtocol
)
-
(
NSDictionary
...
NSObject
(
GrowlApplicationBridgeDelegate_Installation_InformalProtocol
)
-
(
NSString
...
GrowlApplicationBridge
(
GrowlInstallationPrompt_private
)
+
(
void
