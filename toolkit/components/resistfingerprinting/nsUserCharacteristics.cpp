...
:
:
prefs_browser_display_use_document_fonts
.
Set
(
mozilla
...
:
:
prefs_network_cookie_cookiebehavior
.
Set
(
StaticPrefs
...
*
const
kFingerprintingProtectionOverridesPref
=
"
privacy
.
