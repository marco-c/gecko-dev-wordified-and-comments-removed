...
:
void
IPAddressIsNotInKnownModuleTestImpl
(
bool
has_corrupt_symbols
)
...
(
GetCallerFrame
ReturnAddressIsNotInKnownModule
)
{
MockCodeModule
msvcrt_dll
...
(
GetCallerFrame
HandleAlignmentInProgramString
)
{
MockCodeModule
chrome_dll
...
;
Label
bogus_stack_location_1
;
Label
bogus_stack_location_2
;
Label
bogus_stack_location_3
;
stack_section
.
start
...
(
GetCallerFrame
IPAddressIsNotInKnownModule_CorruptSymbols
)
{
IPAddressIsNotInKnownModuleTestImpl
(
