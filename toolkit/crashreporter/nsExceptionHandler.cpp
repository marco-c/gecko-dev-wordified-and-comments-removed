...
const
int
kTotalVirtualMemoryParameterLen
=
sizeof
(
kTotalVirtualMemoryParameter
...
const
int
kAvailableVirtualMemoryParameterLen
=
sizeof
(
kAvailableVirtualMemoryParameter
...
const
int
kAvailablePageFileParameterLen
=
sizeof
(
kAvailablePageFileParameter
...
const
int
kTotalPhysicalMemoryParameterLen
=
sizeof
(
kTotalPhysicalMemoryParameter
...
const
char
kAvailablePhysicalMemoryParameter
[
]
=
"
...
const
int
kAvailablePhysicalMemoryParameterLen
=
sizeof
(
kAvailablePhysicalMemoryParameter
...
const
char
kEventLoopNestingLevelParameter
[
]
=
"
...
const
int
kEventLoopNestingLevelParameterLen
=
sizeof
(
kEventLoopNestingLevelParameter
...
const
char
kBreakpadReserveAddressParameter
[
]
=
"
...
const
int
kBreakpadReserveAddressParameterLen
=
sizeof
(
kBreakpadReserveAddressParameter
...
const
int
kBreakpadReserveSizeParameterLen
=
sizeof
(
kBreakpadReserveSizeParameter
