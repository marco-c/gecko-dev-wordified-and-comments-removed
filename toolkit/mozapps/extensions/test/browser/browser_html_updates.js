...
async
function
waitForUpdateAvailableCountUpdatedAfterUpdateCheck
(
)
{
await
...
async
function
testPromptOnBackgroundUpdateCheck
(
)
{
const
...
async
function
testNoUpdateAvailableOnUnrelatedAddonCards
(
)
{
let
