...
:
Add
Preamble_PLDHashTable
)
#
define
FOR_EACH_DIAGNOSTIC_MEMBER_PTR_REDIRECTION
(
MACRO
)
\
...
#
define
MAKE_DIAGNOSTIC_ENTRY_WITH_TYPE
(
aType
aAddress
aPreamble
