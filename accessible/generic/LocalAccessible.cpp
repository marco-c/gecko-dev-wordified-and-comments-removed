...
static
bool
ShouldHintPopoverEstablishDetailsRelation
(
dom
:
:
...
static
bool
ShouldHintPopoverEstablishDescribedByRelation
(
dom
:
:
...
:
:
accessibility_anchorPositionedAsDetails_enabled
(
)
)
{
