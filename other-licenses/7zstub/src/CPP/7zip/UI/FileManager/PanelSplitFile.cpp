...
MyFormatNew
(
IDS_SPLIT_CONFIRM_MESSAGE
s
)
LangString
(
IDS_SPLIT_CONFIRM_TITLE
)
MB_YESNOCANCEL
|
MB_ICONQUESTION
...
MessageBox_Error_LangID
(
IDS_COMBINE_CANT_DETECT_SPLIT_FILE
)
;
return
;
...
MessageBox_Error_LangID
(
IDS_COMBINE_CANT_FIND_MORE_THAN_ONE_PART
)
;
return
;
