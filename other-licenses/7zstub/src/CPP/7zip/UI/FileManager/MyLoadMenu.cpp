...
{
IDM_VIEW_ARANGE_BY_TYPE
1020
}
{
IDM_VIEW_ARANGE_BY_DATE
1012
}
{
IDM_VIEW_ARANGE_BY_SIZE
1007
}
}
;
...
CheckItemByID
(
IDM_VIEW_TOOLBARS_LARGE_BUTTONS
g_App
.
LargeButtons
)
...
CheckItemByID
(
IDM_VIEW_TOOLBARS_SHOW_BUTTONS_TEXT
g_App
.
ShowButtonsLables
)
...
CheckItemByID
(
IDM_VIEW_AUTO_REFRESH
g_App
.
Get_AutoRefresh_Mode
(
)
)
;
