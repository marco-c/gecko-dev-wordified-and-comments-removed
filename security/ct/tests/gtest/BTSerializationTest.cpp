...
;
mTestInclusionProofUnexpectedData
=
GetTestInclusionProofUnexpectedData
(
)
;
mTestInclusionProofInvalidHashSize
=
GetTestInclusionProofInvalidHashSize
(
)
;
mTestInclusionProofInvalidHash
=
GetTestInclusionProofInvalidHash
(
)
;
mTestInclusionProofMissingLogId
=
...
;
mTestInclusionProofNullTreeSize
=
...
(
BTSerializationTest
FailsDecodingInclusionProofUnexpectedData
)
{
Input
encodedProofInput
...
(
BTSerializationTest
FailsDecodingPathLengthTooSmall
)
{
Input
encodedProofInput
...
(
BTSerializationTest
FailsDecodingPathLengthTooLarge
)
{
Input
encodedProofInput
...
(
BTSerializationTest
FailsDecodingLeafIndexOutOfBounds
)
{
Input
encodedProofInput
