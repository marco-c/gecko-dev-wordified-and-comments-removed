...
:
:
ReasonsForNotFalseStartingLabel
>
(
reasonsForNotFalseStarting
)
...
const
nsLiteralCString
KeyExchangeAlgorithmNameFromType
(
SSLKEAType
keaType
)
...
:
:
security_ssl_treat_unsafe_negotiation_as_broken
(
)
;
bool
