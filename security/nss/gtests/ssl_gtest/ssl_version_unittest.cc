...
(
TlsConnectStreamTls13
Ssl30ServerHelloWithSupportedVersions
)
{
MakeTlsFilter
<
TlsServerHelloVersionSetter
>
(
server_
SSL_LIBRARY_VERSION_3_0
...
(
DtlsConnectTest
Dtls13VersionWorkaround
)
{
static
const
uint16_t
kExpectVersionsWorkaround
[
]
=
{
...
(
TlsConnectGenericPre13
ClientHelloUnsupportedTlsVersion
)
{
StartConnect
(
