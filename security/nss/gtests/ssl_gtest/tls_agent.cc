...
expected_received_alert_
(
kTlsAlertCloseNotify
)
expected_received_alert_level_
(
kTlsAlertWarning
)
...
;
client_auth_callback_type_
=
callbackType
;
client_auth_callback_success_
=
callbackSuccess
;
if
