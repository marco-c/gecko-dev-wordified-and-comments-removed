...
(
TlsConnectStreamTls13
ZeroRttUsingLateTicketClientAuth
)
{
ResetAntiReplay
(
...
(
TlsConnectTls13
ZeroRttDifferentCompatibleCipher
)
{
EnsureTlsSetup
(
...
(
TlsConnectTls13
ZeroRttDifferentIncompatibleCipher
)
{
EnsureTlsSetup
(
...
(
TlsConnectStreamTls13
SuppressEndOfEarlyDataClientOnly
)
{
SetupForZeroRtt
(
...
(
TlsConnectGeneric
SuppressEndOfEarlyDataNoZeroRtt
)
{
EnsureTlsSetup
(
