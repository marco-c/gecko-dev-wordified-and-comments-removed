...
(
GreasePresenceAbsenceTestTlsStream13
GreaseCertificateRequestSigAlg
)
{
SetupGrease
(
...
(
GreasePresenceAbsenceTestTlsStream13
GreaseNewSessionTicketExtension
)
{
SetupGrease
(
...
(
GreaseOnlyTestStreamTls13
GreaseOnlyClientSupportedGroup
)
{
std
:
...
(
GreaseOnlyTestStreamTls13
GreaseOnlyClientSignatureAlgorithm
)
{
std
:
...
(
GreaseOnlyTestStreamTls13
GreaseOnlyClientSupportedVersion
)
{
std
:
...
;
class
TlsCertificateRequestSigAlgSetterFilter
:
public
TlsHandshakeFilter
{
...
(
GreaseTestStreamTls12
GreaseOnlyServerTLS12CertificateRequestSigAlg
)
{
EnsureTlsSetup
(
...
(
GreaseTestStreamTls12
GreasedTLS12ServerKexEccSigAlg
)
{
MakeTlsFilter
<
...
(
GreaseTestStreamTls12
GreasedTLS12ServerKexDheSigAlg
)
{
MakeTlsFilter
<
...
(
GreaseTestStreamTls12
GreasedTLS12ServerKexEcdheNamedCurve
)
{
MakeTlsFilter
<
ECCServerKEXNamedCurveReplacer
>
(
server_
grease_
...
(
GreaseTestStreamTls12
GreasedTLS12ClientCertificateVerifySigAlg
)
{
client_
-
...
(
GreaseTestStreamTls13
GreasedTLS13ClientCertificateVerifySigAlg
)
{
client_
-
...
(
GreaseTestStreamTls13
GreasedHelloRetryRequestVersion
)
{
EnsureTlsSetup
(
...
(
GreaseTestStreamTls13
GreasedClientCertificateExtensions
)
{
client_
-
...
(
TlsConnectStreamTls13
GreaseClientHelloExtensionPermutation
)
{
EnsureTlsSetup
(
