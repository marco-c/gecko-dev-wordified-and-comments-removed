...
TestSignatureAlgorithm
&
aEndEntitySignatureAlgorithm
const
TestSignatureAlgorithm
&
aOptionalIntSignatureAlgorithm
const
TestSignatureAlgorithm
&
aRootSignatureAlgorithm
bool
aIsValid
)
:
