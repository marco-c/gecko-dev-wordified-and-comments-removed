...
static
SECStatus
sec_pkcs12_decoder_begin_nested_safe_contents
(
sec_PKCS12SafeContentsContext
*
safeContentsCtx
...
static
SECStatus
sec_pkcs12_decoder_init_new_safe_bag
(
sec_PKCS12SafeContentsContext
*
safeContentsCtx
...
static
SECStatus
sec_pkcs12_decoder_unsafe_parity_outcome
(
SEC_PKCS12DecoderContext
*
p12dcx
...
SECItem
*
sec_pkcs12_get_attribute_value
(
sec_PKCS12SafeBag
*
bag
...
SECItem
*
sec_pkcs12_get_nickname_for_cert
(
sec_PKCS12SafeBag
*
cert
...
static
void
sec_pkcs12_validate_key_by_cert
(
sec_PKCS12SafeBag
*
cert
...
SECItem
*
sec_pkcs12_get_public_value_and_type
(
const
SECKEYPublicKey
*
...
static
SECStatus
sec_pkcs12_add_item_to_bag_list
(
sec_PKCS12SafeBag
*
*
...
SECKEYPublicKey
*
sec_pkcs12_get_public_key_and_usage
(
sec_PKCS12SafeBag
*
certBag
...
static
SECStatus
sec_pkcs12_decoder_append_bag_to_context
(
SEC_PKCS12DecoderContext
*
p12dcx
...
sec_PKCS12SafeBag
*
sec_pkcs12_decoder_convert_old_key
(
SEC_PKCS12DecoderContext
*
p12dcx
...
sec_PKCS12SafeBag
*
sec_pkcs12_decoder_create_cert
(
SEC_PKCS12DecoderContext
*
p12dcx
...
*
*
sec_pkcs12_decoder_convert_old_cert
(
SEC_PKCS12DecoderContext
*
p12dcx
...
static
SECStatus
sec_pkcs12_decoder_convert_old_key_and_certs
(
SEC_PKCS12DecoderContext
*
p12dcx
