...
static
void
sec_pkcs12_destroy_nickname_list
(
SECItem
*
*
...
static
void
sec_pkcs12_destroy_certificate_list
(
CERTCertificate
*
*
...
static
void
sec_pkcs12_destroy_cinfos_for_cert_bags
(
...
static
void
sec_pkcs12_destroy_cert_content_infos
(
...
*
*
sec_pkcs12_convert_nickname_list
(
char
*
*
...
static
SECStatus
sec_pkcs12_propagate_thumbprints
(
SECItem
*
*
...
static
SECStatus
sec_pkcs12_append_unshrouded_bag
(
SEC_PKCS12BaggageItem
*
bag
...
static
SECStatus
sec_pkcs12_package_certs_and_keys
(
SECItem
*
*
...
SECItem
*
sec_pkcs12_encode_safe_contents
(
SEC_PKCS12SafeContents
*
safe
