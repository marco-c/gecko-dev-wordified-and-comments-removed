...
const
SEC_ASN1Template
nsslowkey_PointerToEncryptedPrivateKeyInfoTemplate
[
]
=
{
...
{
return
nsslowkey_StoreKeyByPublicKeyAlg
(
handle
privkey
pubKeyData
...
NSSLOWKEYPrivateKey
*
seckey_decode_encrypted_private_key
(
NSSLOWKEYDBKey
*
dbkey
...
char
*
nsslowkey_FindKeyNicknameByPublicKey
(
NSSLOWKEYDBHandle
*
handle
