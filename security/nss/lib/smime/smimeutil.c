...
const
int
implemented_key_encipherment_len
=
PR_ARRAY_SIZE
(
implemented_key_encipherment
...
static
SECOidTag
smime_get_policy_tag_from_key_length
(
SECOidTag
algtag
unsigned
...
optFlags
&
NSS_KEY_SIZE_POLICY_SMIME_FLAG
)
{
return
PR_TRUE
...
static
SECOidTag
nss_SMIME_FindCipherForSMIMECap
(
NSSSMIMECapability
*
cap
