...
const
SEC_ASN1Template
NSSCMSContentInfoTemplate
[
]
;
struct
NSSCMSContentInfoPrivateStr
{
NSSCMSCipherContext
*
ciphcx
...
SEC_BEGIN_PROTOS
SECStatus
NSS_CMSContentInfo_Private_Init
(
NSSCMSContentInfo
*
cinfo
...
extern
SECStatus
NSS_CMSSignedData_AddTempCertificate
(
NSSCMSSignedData
*
sigd
...
;
void
NSS_CMSGenericWrapperData_Destroy
(
SECOidTag
type
...
;
SECStatus
NSS_CMSGenericWrapperData_Encode_BeforeStart
(
SECOidTag
type
NSSCMSGenericWrapperData
...
;
SECStatus
NSS_CMSGenericWrapperData_Encode_BeforeData
(
SECOidTag
type
NSSCMSGenericWrapperData
