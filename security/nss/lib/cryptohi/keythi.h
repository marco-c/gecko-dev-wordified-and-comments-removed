...
struct
SECKEYKyberPublicKeyStr
SECKEYKyberPublicKey
;
struct
SECKEYMLDSAPublicKeyStr
{
SECOidTag
paramSet
;
...
#
define
SECKEYPRIVATEKEY_IS_TEMP_FLAG
0x01
#
define
SECKEYPRIVATEKEY_IS_OWNED_FLAG
0x02
#
define
