...
SECItem
*
ocsp_GetEncodedOCSPResponseFromRequest
(
PLArenaPool
*
arena
...
static
SECStatus
ocsp_GetDecodedVerifiedSingleResponseForID
(
CERTCertDBHandle
*
handle
...
static
void
ocsp_RemoveCacheItemFromLinkedList
(
OCSPCacheData
*
cache
...
static
SECStatus
ocsp_CreateCacheItemAndConsumeCertID
(
OCSPCacheData
*
cache
...
char
*
defaultResponderNickname
;
CERTCertificate
*
defaultResponderCert
;
}
ocspCheckingContext
;
...
const
SEC_ASN1Template
ocsp_BasicOCSPResponseTemplate
[
]
=
{
...
const
SEC_ASN1Template
ocsp_CertStatusRevokedTemplate
[
]
=
{
...
const
SEC_ASN1Template
ocsp_CertStatusUnknownTemplate
[
]
=
{
...
static
SECStatus
ocsp_AddServiceLocatorExtension
(
ocspSingleRequest
*
singleRequest
...
static
SECStatus
ocsp_FinishDecodingSingleResponses
(
PLArenaPool
*
reqArena
...
SECItem
*
ocsp_GetEncodedOCSPResponseForSingleCert
(
PLArenaPool
*
arena
...
static
PRBool
ocsp_CertIsOCSPDesignatedResponder
(
CERTCertificate
*
cert
...
CERTOCSPSingleResponse
*
ocsp_GetSingleResponseForCertID
(
CERTOCSPSingleResponse
*
*
...
static
PRBool
ocsp_AuthorizedResponderForCertID
(
CERTCertDBHandle
*
handle
