...
*
crmf_create_encr_pivkey_option
(
CRMFEncryptedKey
*
inEncryptedKey
...
CRMFPKIArchiveOptions
*
crmf_create_keygen_param_option
(
SECItem
*
inKeyGenParams
...
static
SECStatus
crmf_check_and_adjust_archoption
(
CRMFControl
*
inControl
...
SEC_ASN1Template
*
crmf_get_pkiarchive_subtemplate
(
CRMFControl
*
inControl
...
retTemplate
=
CRMFEncryptedKeyWithEncryptedValueTemplate
;
inControl
-
>
