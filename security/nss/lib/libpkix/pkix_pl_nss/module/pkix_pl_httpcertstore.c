...
PKIX_ERROR
(
PKIX_NOCONTENTTYPEINHTTPRESPONSE
)
;
}
if
...
PKIX_ERROR
(
PKIX_NORESPONSEDATAINHTTPRESPONSE
)
;
}
PKIX_CHECK
...
PKIX_ERROR
(
PKIX_UNSUPPORTEDVERSIONOFHTTPCLIENT
)
;
}
hcv1
...
PKIX_ERROR
(
PKIX_HTTPCLIENTCREATESESSIONFAILED
)
;
}
httpCertStore
