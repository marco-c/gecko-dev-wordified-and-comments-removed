...
static
PRStatus
ssl_SetDefaultsFromEnvironmentCallOnce
(
void
)
;
...
static
PRBool
ssl_VersionIsSupportedByPolicy
(
SSLProtocolVariant
protocolVariant
SSL3ProtocolVersion
...
PRCallOnceType
gWeakDHParamsRegisterOnce
;
int
gWeakDHParamsRegisterError
;
PRCallOnceType
gWeakDHParamsOnce
;
...
static
PRBool
ssl3_HasConflictingSSLVersions
(
const
SSLVersionRange
*
...
EXP
(
DestroyMaskingContext
)
EXP
(
DestroyResumptionTokenInfo
)
EXP
(
EnableTls13BackendEch
...
EXP
(
HkdfVariantExpandLabel
)
EXP
(
HkdfVariantExpandLabelWithMech
)
EXP
(
KeyUpdate
