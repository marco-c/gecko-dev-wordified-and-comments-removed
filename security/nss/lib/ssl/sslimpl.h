...
;
PRUint64
dtlsHandhakeKeyUpdateMessage
;
sslExtensionBuilder
*
chExtensionPermutation
;
sslBuffer
dtls13ClientMessageBuffer
;
}
SSL3HandshakeState
;
...
supportedCertCompressionAlgorithms
[
MAX_SUPPORTED_CERTIFICATE_COMPRESSION_ALGS
]
;
PRUint8
supportedCertCompressionAlgorithmsCount
;
}
;
#
...
sslEphemeralKeyPair
*
ssl_NewEphemeralKeyPairWithKeys
(
const
sslNamedGroupDef
*
...
;
SECStatus
SSLExp_RecordLayerWriteCallback
(
PRFileDesc
*
fd
...
;
SECStatus
SSLExp_SetDtls13VersionWorkaround
(
PRFileDesc
*
fd
...
;
SECStatus
SSLExp_CreateVariantMaskingContext
(
PRUint16
version
PRUint16
...
;
SECStatus
SSLExp_CallExtensionWriterOnEchInner
(
PRFileDesc
*
fd
