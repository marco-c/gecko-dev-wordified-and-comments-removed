...
srv
=
CMMF_KeyRecRepContentSetPKIStatusInfoStatus
(
repContent
cmmfGrantedWithMods
)
...
srv
=
CMMF_KeyRecRepContentSetNewSignCert
(
repContent
cert
)
...
srv
=
CMMF_KeyRecRepContentSetCACerts
(
repContent
list
)
...
srv
=
CMMF_KeyRecRepContentSetCertifiedKeyPair
(
repContent
cert
privKey
...
certKeyPair
=
CMMF_KeyRecRepContentGetCertKeyAtIndex
(
keyRecRep
0
)
...
rv
=
CMMF_CertifiedKeyPairUnwrapPrivKey
(
certKeyPair
caPrivKey
&
...
;
CMMF_DestroyPOPODecKeyChallContent
(
chalContent
)
;
...
rv
=
CMMF_EncodePOPODecKeyRespContent
(
randomNums
numChallengesSet
WriteItOut
