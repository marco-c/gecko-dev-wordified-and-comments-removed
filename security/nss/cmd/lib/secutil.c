...
#
define
DEFN_EXTEN_EXT_VALUE_ENCODER
(
mmm
)
\
SECStatus
EXTEN_EXT_VALUE_ENCODER_
#
#
mmm
(
...
static
void
secu_PrintRawStringQuotesOptional
(
FILE
*
out
...
char
*
SECU_SignatureSchemeGetNextScheme
(
size_t
i
)
