...
CMMF_CertResponseSetPKIStatusInfoStatus
(
currResponse
cmmfGranted
)
;
CMMF_CertResponseSetCertificate
(
currResponse
issuedCerts
[
...
srv
=
CMMF_CertRepContentSetCertResponses
(
certRepContent
responses
numCerts
...
{
CMMF_DestroyPOPODecKeyRespContent
(
respContent
)
;
