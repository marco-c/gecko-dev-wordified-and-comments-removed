...
#
define
CRLGEN_ISSUER_CONTEXT
1
#
define
CRLGEN_UPDATE_CONTEXT
2
#
define
CRLGEN_NEXT_UPDATE_CONTEXT
3
#
define
...
typedef
struct
CRLGENEntriesSortedDataStr
CRLGENEntriesSortedData
;
extern
SECStatus
CRLGEN_ExtHandleInit
(
CRLGENGeneratorData
*
crlGenData
...
extern
SECStatus
CRLGEN_CommitExtensionsAndEntries
(
CRLGENGeneratorData
*
crlGenData
