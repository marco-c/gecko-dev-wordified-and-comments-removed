...
(
pkixder_pki_types_tests
AlgorithmIdentifierNoParams
)
{
const
uint8_t
DER_ALGORITHM_IDENTIFIER_NO_PARAMS
[
]
=
{
...
(
pkixder_pki_types_tests
AlgorithmIdentifierNullParams
)
{
const
uint8_t
DER_ALGORITHM_IDENTIFIER_NULL_PARAMS
[
]
=
{
...
(
pkixder_pki_types_tests
OptionalVersionV1ExplicitEncodingNotAllowed
)
{
const
uint8_t
