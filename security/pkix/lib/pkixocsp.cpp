...
:
:
ERROR_OCSP_RESPONDER_CERT_INVALID
;
}
rv
=
...
inline
Result
MapBadDERToMalformedOCSPResponse
(
Result
rv
)
...
unsigned
int
totalLenWithoutSerialNumberData
=
2
+
2
