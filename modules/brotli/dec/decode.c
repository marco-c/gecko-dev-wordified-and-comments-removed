...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_EXUBERANT_NIBBLE
)
;
}
s
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_EXUBERANT_META_NIBBLE
)
;
}
s
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_SIMPLE_HUFFMAN_ALPHABET
)
;
}
s
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_SIMPLE_HUFFMAN_SAME
)
;
}
}
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_HUFFMAN_SPACE
)
;
}
table_size
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_CONTEXT_MAP
)
;
}
if
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_CONTEXT_MAP_REPEAT
)
;
}
do
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_BLOCK_LENGTH_1
)
;
}
memcpy
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_RING_BUFFER_1
)
;
}
for
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_DICTIONARY
)
;
}
}
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_WINDOW_BITS
)
;
break
;
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_BLOCK_TYPE_TREES
)
;
break
;
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_CONTEXT_MODES
)
;
break
;
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_TREE_GROUPS
)
)
;
}
...
BROTLI_FAILURE
(
BROTLI_ERROR_ALLOC_RING_BUFFER_2
)
;
break
;
...
BROTLI_FAILURE
(
BROTLI_ERROR_FORMAT_BLOCK_LENGTH_2
)
;
break
;
