...
gMetroPrefs
.
pushDesktopControlledPrefToMetro
(
prefName
)
;
...
:
function
BrowserOnClick_onAboutCertError
(
aTargetElm
aOwnerDoc
)
...
:
function
BrowserOnClick_ignoreWarningButton
(
aIsMalware
)
{
...
:
function
BrowserOnClick_onAboutNetError
(
aTargetElm
aOwnerDoc
)
...
mixedDisplayContent
"
IDENTITY_MODE_MIXED_ACTIVE_LOADED
:
"
unknownIdentity
mixedContent
mixedActiveContent
"
IDENTITY_MODE_MIXED_DISPLAY_LOADED_ACTIVE_BLOCKED
:
"
unknownIdentity
mixedContent
mixedDisplayContent2
"
