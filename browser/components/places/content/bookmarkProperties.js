...
:
function
BPP__appendFolderItemToMenupopup
(
aMenupopup
aFolderId
)
...
:
function
BPP__getLoadInSidebarAnnotation
(
aLoadInSidebar
)
{
...
:
function
BPP__getCreateNewBookmarkTransaction
(
aContainer
aIndex
)
...
:
function
BPP__getTransactionsForURIList
(
)
{
var
...
:
function
BPP__getCreateNewFolderTransaction
(
aContainer
aIndex
)
...
:
function
BPP__getCreateNewLivemarkTransaction
(
aContainer
aIndex
)
