...
;
let
lastOpenManagementBrowserId
=
null
;
let
lastOpenManagementEventTime
=
Number
.
NEGATIVE_INFINITY
...
this
.
onAboutLoginsRecordTelemetryEvent
(
event
)
;
