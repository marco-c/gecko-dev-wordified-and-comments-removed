...
(
function
GroupItem_addAppTab_onAppTabMousedown
(
event
)
{
...
(
function
GroupItem_addAppTab_onAppTabClick
(
event
)
{
...
(
function
GroupItems__updateAppTabIcons_forEach
(
icon
)
{
...
xulTab
function
GroupItems_getAppTabFavIconUrl_getFavIconUrlForTab
(
iconUrl
)
{
