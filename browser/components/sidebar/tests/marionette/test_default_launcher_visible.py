...
def
test_horizontal_hide_launcher_persists
(
self
)
:
...
def
test_horizontal_legacy_hide_sidebar_migrates
(
self
)
:
...
def
test_vertical_hide_sidebar_revealed_launcher_persists
(
self
)
:
...
def
test_vertical_hide_sidebar_hidden_launcher_persists
(
self
)
:
