...
logWarningAboutStringTooLong
:
function
WCF_logWarningAboutStringTooLong
(
)
{
let
...
:
function
JST__variablesViewSimpleValueEvalMacro
(
aItem
aCurrentString
)
...
:
function
JST__variablesViewOverrideValueEvalMacro
(
aItem
aCurrentString
)
...
:
function
JST__variablesViewGetterOrSetterEvalMacro
(
aItem
aCurrentString
)
...
:
function
Utils_categoryForConsoleMessage
(
aMessage
)
{
