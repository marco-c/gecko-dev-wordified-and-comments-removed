...
:
:
ICU4XLineBreakStrictness_Strict
;
case
LineBreakRule
:
...
:
:
ICU4XLineBreakStrictness_Loose
;
case
LineBreakRule
:
...
:
:
ICU4XLineBreakStrictness_Normal
;
case
LineBreakRule
:
...
:
:
ICU4XLineBreakStrictness_Anywhere
;
}
MOZ_ASSERT_UNREACHABLE
(
...
:
:
ICU4XLineBreakWordOption_Normal
;
case
WordBreakRule
:
...
:
:
ICU4XLineBreakWordOption_BreakAll
;
case
WordBreakRule
:
...
:
:
ICU4XLineBreakWordOption_KeepAll
;
}
MOZ_ASSERT_UNREACHABLE
(
