#
ifndef
GOOGLE_PROTOBUF_INCLUDED_CoreDump_2eproto
#
define
GOOGLE_PROTOBUF_INCLUDED_CoreDump_2eproto
#
...
:
void
unsafe_arena_set_allocated_parent
(
:
:
mozilla
...
:
bool
_internal_has_functiondisplayname
(
)
const
;
...
:
bool
_internal_has_functiondisplaynameref
(
)
const
;
...
:
void
unsafe_arena_set_allocated_allocationstack
(
:
:
mozilla
...
StackFrame
*
unsafe_arena_release_allocationstack
(
)
;
bool
...
:
bool
_internal_has_jsobjectclassname
(
)
const
;
...
:
bool
_internal_has_jsobjectclassnameref
(
)
const
;
...
:
bool
_internal_has_scriptfilenameref
(
)
const
;
...
:
bool
_internal_has_descriptivetypename
(
)
const
;
...
:
bool
_internal_has_descriptivetypenameref
(
)
const
;
