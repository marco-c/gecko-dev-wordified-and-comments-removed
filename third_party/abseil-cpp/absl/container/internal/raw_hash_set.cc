...
probe_till_first_non_full_group
(
const
ctrl_t
*
...
constexpr
uint64_t
GetOverflowGrowthLeftFromPacked
(
uint64_t
...
GetGrowthInfoLowerBoundFromPacked
(
uint64_t
packed_full_growth_info
)
...
constexpr
uint64_t
GetGrowthLeftLowerBoundFromPacked
(
uint64_t
packed_full_growth_info
)
...
inline
void
SetCtrlInSingleGroupTableNoSanitizeImpl
(
const
CommonFields
&
...
{
size_t
FindNewPositionsAndTransferSlots
(
CommonFields
&
common
...
ABSL_ATTRIBUTE_NOINLINE
void
ReportSingleGroupTableGrowthToInfoz
(
CommonFields
&
common
...
;
void
InitializeMirroredControlBytes
(
ctrl_t
*
new_ctrl
...
+
=
DecodeAndInsertToTableOverflow
(
common
policy
old_slots
...
size_t
GrowToNextCapacityThatFitsInLocalBuffer
(
CommonFields
&
common
...
size_t
GrowToNextCapacity4BytesEncoder
(
CommonFields
&
common
...
size_t
GrowToNextCapacity8BytesEncoder
(
CommonFields
&
common
...
size_t
GrowToNextCapacity16BytesEncoder
(
CommonFields
&
common
...
size_t
GrowToNextCapacityOverflowLocalBuffer
(
CommonFields
&
common
