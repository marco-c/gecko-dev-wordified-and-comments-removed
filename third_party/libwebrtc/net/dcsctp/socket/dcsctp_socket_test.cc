...
(
DcSctpSocketTest
T2ShutdownTimerExpiresResendsShutdownAck
)
{
SocketUnderTest
a
...
(
DcSctpSocketTest
ShutdownResendsShutdownAckWhenInShutdownAckSent
)
{
DcSctpOptions
options_a
...
(
DcSctpSocketTest
ShutdownIgnoredInShutdownReceived
)
{
SocketUnderTest
a
...
(
DcSctpSocketTest
ShutdownIgnoredInShutdownPending
)
{
SocketUnderTest
a
...
(
DcSctpSocketParametrizedTest
ConnectSocketOutOfBandInvalidToken
)
{
std
:
