...
(
StreamResetHandlerTest
ChunkWithNoParametersReturnsError
)
{
EXPECT_CALL
(
...
(
StreamResetHandlerTest
ChunkWithInvalidParametersReturnsError
)
{
Parameters
:
...
(
StreamResetHandlerTest
FailToDeliverWithoutResettingStream
)
{
reasm_
-
...
(
StreamResetHandlerTest
ResetStreamsDeferredOnlySelectedStreams
)
{
Parameters
:
...
(
StreamResetHandlerTest
ResetMultipleStreamsInOneRequest
)
{
EXPECT_CALL
(
...
(
StreamResetHandlerTest
SendOutgoingResettingOnPositiveResponse
)
{
EXPECT_CALL
(
...
(
StreamResetHandlerTest
SendOutgoingResetRollbackOnError
)
{
EXPECT_CALL
(
...
(
StreamResetHandlerTest
SendOutgoingResetRetransmitOnInProgress
)
{
static
constexpr
...
(
StreamResetHandlerTest
ResetWhileRequestIsSentWillQueue
)
{
EXPECT_CALL
(
...
(
StreamResetHandlerTest
SendIncomingResetJustReturnsNothingPerformed
)
{
Parameters
:
...
(
StreamResetHandlerTest
SendSameRequestTwiceIsIdempotent
)
{
for
(
...
(
StreamResetHandlerTest
HandoverAfterHavingResetOneStream
)
{
{
EXPECT_CALL
...
(
StreamResetHandlerTest
PerformCloseAfterOneFirstFailing
)
{
Parameters
:
...
(
StreamResetHandlerTest
ResetStreamsDeferredWithNewSeqNumSuccess
)
{
EXPECT_THAT
(
...
(
StreamResetHandlerTest
ResetStreamsSuccessIdempotency
)
{
data_tracker_
-
