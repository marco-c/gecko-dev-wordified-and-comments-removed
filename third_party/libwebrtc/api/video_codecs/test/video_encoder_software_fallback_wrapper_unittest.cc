...
:
EncoderInfo
GetEncoderInfoWithTrustedRateController
(
bool
trusted_rate_controller
)
{
VideoEncoder
:
...
:
EncoderInfo
GetEncoderInfoWithHardwareAccelerated
(
bool
...
(
ForcedFallbackTestEnabled
FallbackIfAtMaxResolutionLimit
)
{
InitEncode
(
...
(
ForcedFallbackTestEnabled
FallbackIsKeptWhenInitEncodeIsCalled
)
{
InitEncode
(
...
(
ForcedFallbackTestEnabled
FallbackIsEndedWhenResolutionIsTooLarge
)
{
InitEncode
(
...
(
ForcedFallbackTestEnabled
FallbackIsEndedForNonValidSettings
)
{
InitEncode
(
...
(
ForcedFallbackTestEnabled
GetScaleSettingsWithNoFallback
)
{
InitEncode
(
...
TEST
(
SoftwareFallbackEncoderTest
BothRateControllersNotTrusted
)
{
auto
*
...
(
SoftwareFallbackEncoderTest
ConfigureHardwareOnSecondAttempt
)
{
auto
*
...
(
PreferTemporalLayersFallbackTest
UsesMainWhenNeitherSupportsTemporal
)
{
codec_settings
.
...
(
PreferTemporalLayersFallbackTest
UsesFallbackWhenLayersAreUndefined
)
{
codec_settings
.
...
struct
ResolutionBasedFallbackTestParams
{
std
:
:
...
=
"
ResolutionAboveFallbackThreshold
"
.
field_trials
=
...
=
"
ResolutionEqualFallbackThreshold
"
.
field_trials
=
...
=
"
GenericFallbackSettingsTakePrecedence
"
.
field_trials
=
