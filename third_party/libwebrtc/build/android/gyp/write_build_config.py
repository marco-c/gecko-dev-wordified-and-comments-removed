...
(
#
target_java_annotation_processor
)
...
(
#
target_android_app_bundle_module
)
...
[
'
static_library_proguard_mapping_output_paths
'
]
:
Additional
...
def
_ExtractSharedLibsFromRuntimeDeps
(
runtime_deps_file
)
:
...
def
_CreateJavaLocaleListFromAssets
(
assets
locale_paks
)
...
android_resources_library_deps
=
_DepsFromPathsWithFilters
(
...
all_library_deps_sorted_for_classpath
=
sorted
(
...
classpath_entries_by_owning_config
=
collections
.
defaultdict
...
options
.
secondary_abi_shared_libraries_runtime_deps
:
