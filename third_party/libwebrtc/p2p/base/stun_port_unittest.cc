...
(
StunPortTest
TestStunCandidateDiscardedWithMdnsObfuscationNotEnabled
)
{
CreateSharedUdpPort
(
...
(
StunPortTest
TestStunCandidateGeneratedWithMdnsObfuscationEnabled
)
{
EnableMdnsObfuscation
(
...
(
StunPortTest
TestStunPacketsHaveDscpPacketOption
)
{
MockAsyncPacketSocket
*
