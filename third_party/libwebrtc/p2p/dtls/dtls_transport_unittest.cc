...
-
>
set_drop_non_stun_unless_writable
(
true
)
;
...
int
received_dtls_ciphertext_packets
(
)
const
{
...
(
DtlsTransportInternalImplTest
TestSendSrtpBypassPacketWithOptions
)
{
PrepareDtls
(
...
(
DtlsTransportInternalImplTest
TestPacketOptionsResetAfterWriteError
)
{
PrepareDtls
(
...
enum
DtlsTransportInternalImplEvent
{
...
INSTANTIATE_TEST_SUITE_P
(
DtlsTransportLastHandshakePacket12Test
DtlsTransportLastHandshakePacketTest
:
:
testing
...
INSTANTIATE_TEST_SUITE_P
(
DtlsTransportLastHandshakePacket13Test
DtlsTransportLastHandshakePacketTest
:
:
testing
