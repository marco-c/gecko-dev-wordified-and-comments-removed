...
{
"
incoming_rtcp_fraction_lost
"
"
outgoing_rtcp_fraction_lost
"
"
incoming_rtcp_cumulative_lost
"
"
outgoing_rtcp_cumulative_lost
"
"
incoming_rtcp_highest_seq_number
"
"
...
(
"
incoming_sequence_number_delta
"
[
&
]
...
(
"
incoming_layer_bitrate_allocation
"
[
&
]
...
(
"
outgoing_layer_bitrate_allocation
"
[
&
]
...
{
CreateAudioEncoderTargetBitrateGraph
(
parsed_log
config
plot
...
{
CreateAudioEncoderFrameLengthGraph
(
parsed_log
config
plot
...
{
CreateAudioEncoderPacketLossGraph
(
parsed_log
config
plot
...
{
CreateAudioEncoderEnableFecGraph
(
parsed_log
config
plot
...
{
CreateAudioEncoderEnableDtxGraph
(
parsed_log
config
plot
...
{
CreateAudioEncoderNumChannelsGraph
(
parsed_log
config
plot
...
:
:
conversational_speech_en_wav_len
)
;
has_generated_wav_file
=
