...
void
CreateOutgoingEcnFeedbackGraph
(
const
ParsedRtcEventLog
&
...
void
CreateIncomingEcnFeedbackGraph
(
const
ParsedRtcEventLog
&
...
{
struct
PacketLossPerFeedback
{
Timestamp
timestamp
;
int
num_packets_in_feedback
=
0
;
int
...
+
=
previous_lost_sequence_numbers_
.
count
(
last_unwrapped_sequence_number_
...
&
&
previous_feedback_highest_seq_number_
.
has_value
(
)
...
;
TimeSeries
reordered_packets_between_feedback
(
"
Ratio
of
