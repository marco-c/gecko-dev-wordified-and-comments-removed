...
(
ScalabilityStructureTest
FrameInfoMatchesFrameDependencyStructure
)
{
FrameDependencyStructure
structure
...
(
ScalabilityStructureTest
FrameDependsOnSameOrLowerLayer
)
{
std
:
...
(
ScalabilityStructureTest
NoFrameDependsThroughSwitchIndication
)
{
FrameDependencyStructure
structure
