...
(
LibaomAv1EncoderTest
NoBitrateOnTopSpatialLayerProduceDeltaFrames
)
{
std
:
...
(
LibaomAv1EncoderTest
SetsEndOfPictureForLastFrameInTemporalUnit
)
{
...
(
LibaomAv1EncoderTest
CheckOddDimensionsWithSpatialLayers
)
{
VideoBitrateAllocation
allocation
...
INSTANTIATE_TEST_SUITE_P
(
LibaomAv1EncoderMaxConsecDropTests
LibaomAv1EncoderMaxConsecDropTest
Values
(
1
...
(
LibaomAv1EncoderTest
EncoderInfoWithoutResolutionBitrateLimits
)
{
std
:
...
(
LibaomAv1EncoderTest
EncoderInfoWithBitrateLimitsFromFieldTrial
)
{
auto
field_trials
...
(
LibaomAv1EncoderTest
EncoderInfoProvidesFpsAllocation
)
{
std
:
...
(
LibaomAv1EncoderTest
AdheresToTargetBitrateDespiteUnevenFrameTiming
)
{
std
:
...
(
LibaomAv1EncoderTest
L1T2RepeatFrameNotDroppedIfDeltaTooLarge
)
{
if
(
...
(
LibaomAv1EncoderTest
TriggerFrameDropOnLayer0WhileLayer1Encoded
)
{
std
:
