...
(
TestVp8Impl
ErrorResilienceDisabledForNoTemporalLayers
)
{
codec_settings_
.
...
(
TestVp8Impl
DefaultErrorResilienceEnabledForTemporalLayers
)
{
codec_settings_
.
...
TEST
(
LibvpxVp8EncoderTest
GetEncoderInfoReturnsStaticInformation
)
{
auto
*
...
(
LibvpxVp8EncoderTest
RequestedResolutionAlignmentFromFieldTrial
)
{
test
:
...
(
LibvpxVp8EncoderTest
ResolutionBitrateLimitsFromFieldTrial
)
{
test
:
...
(
TestVp8Impl
GetEncoderInfoFpsAllocationNoLayers
)
{
FramerateFractions
...
(
TestVp8Impl
GetEncoderInfoFpsAllocationTwoTemporalLayers
)
{
EXPECT_EQ
(
...
(
TestVp8Impl
GetEncoderInfoFpsAllocationThreeTemporalLayers
)
{
EXPECT_EQ
(
...
(
TestVp8Impl
GetEncoderInfoFpsAllocationScreenshareLayers
)
{
EXPECT_EQ
(
