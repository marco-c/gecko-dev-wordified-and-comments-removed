...
constexpr
char
kCaptureFullscreenDetectorHistogram
[
]
=
"
...
class
WgcCapturerFullScreenDetectorTest
:
public
WgcCapturerWindowTest
{
...
(
WgcCapturerTextureTest
MultipleCapturesProduceValidTextures
)
{
if
(
...
(
WgcCapturerTextureTest
CaptureDoesNotStarveWithTextureBuffers
)
{
if
(
...
constexpr
int
kNumCapturesToFlushTextureBuffers
=
WgcCaptureSession
:
:
