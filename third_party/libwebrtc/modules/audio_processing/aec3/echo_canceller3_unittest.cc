...
(
EchoCanceller3FieldTrials
Aec3SuppressorTuningOverrideAllParams
)
{
FieldTrials
field_trials
...
"
"
detection_enr_threshold
:
1
.
3
dominant_nearend_detection_enr_exit_
"
"
threshold
:
...
"
"
nearend_detection_hold_duration
:
10
dominant_nearend_detection_trigger_
"
"
threshold
:
...
(
EchoCanceller3FieldTrials
Aec3SuppressorTuningOverrideOneParam
)
{
FieldTrials
field_trials
...
(
EchoCanceller3FieldTrials
Aec3BufferingMaxAllowedExcessRenderBlocks
)
{
FieldTrials
field_trials
...
aec3
.
StereoRenderProcessingActiveForTesting
(
)
)
;
...
(
EchoCanceller3
InjectedNeuralResidualEchoEstimatorIsUsed
)
{
class
...
override
{
residual_echo_estimate_requested_
=
true
;
for
...
bool
residual_echo_estimate_requested
(
)
const
{
...
TEST
(
EchoCanceller3InputCheckDeathTest
