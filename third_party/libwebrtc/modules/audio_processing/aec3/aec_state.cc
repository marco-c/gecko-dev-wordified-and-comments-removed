...
delay_state_
.
DirectPathFilterDelays
(
)
filter_quality_state_
.
UsableLinearFilterOutputs
(
)
stationary_block
)
...
int
>
analyzer_filter_delay_estimates_blocks
const
absl
:
:
...
external_delay
size_t
blocks_with_proper_filter_adaptation
)
{
if
(
...
const
bool
delay_estimator_may_not_have_converged
=
blocks_with_proper_filter_adaptation
<
2
...
usable_linear_filter_estimates_
(
num_capture_channels
false
)
...
false
;
filter_update_blocks_since_reset_
=
0
;
}
...
0
;
filter_update_blocks_since_start_
+
=
filter_update
?
