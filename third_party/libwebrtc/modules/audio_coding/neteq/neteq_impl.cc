...
int
GetDelayChainLengthMs
(
int
config_extra_delay_ms
)
{
constexpr
char
kExtraDelayFieldTrial
[
]
=
"
...
false
;
delayed_last_output_sample_rate_hz_
=
last_output_sample_rate_hz_
;
}
...
size_t
sum_samples_in_output_delay_chain
=
0
;
for
