...
(
PacketRouterTest
Sanity_NoModuleRegistered_GeneratePadding
)
{
constexpr
DataSize
...
(
PacketRouterTest
Sanity_NoModuleRegistered_SendRemb
)
{
const
std
...
(
PacketRouterTest
Sanity_NoModuleRegistered_SendTransportFeedback
)
{
std
:
...
(
PacketRouterTest
SupportsRtxPayloadPaddingFalseIfNoRtxSendModule
)
{
EXPECT_FALSE
(
...
(
PacketRouterTest
SupportsRtxPayloadPaddingTrueIfRtxSendModule
)
{
NiceMock
<
...
(
PacketRouterTest
GeneratePaddingPrioritizesVideo
)
{
const
uint16_t
...
(
PacketRouterTest
AllocatesRtpSequenceNumbersIfPacketCanBeSent
)
{
const
uint16_t
...
(
PacketRouterTest
DoNotAllocatesRtpSequenceNumbersIfPacketCanNotBeSent
)
{
const
uint16_t
...
(
PacketRouterTest
AllocatesTransportSequenceNumbers
)
{
const
uint16_t
...
(
PacketRouterTest
SendPacketWithoutTransportSequenceNumbers
)
{
const
uint16_t
...
(
PacketRouterTest
DoesNotIncrementTransportSequenceNumberOnSendFailure
)
{
NiceMock
<
...
(
PacketRouterTest
ForwardsAbortedRetransmissions
)
{
NiceMock
<
...
(
PacketRouterTest
RoutesBatchCompleteToActiveModules
)
{
NiceMock
<
...
(
PacketRouterDeathTest
DoubleRegistrationOfSendModuleDisallowed
)
{
NiceMock
<
