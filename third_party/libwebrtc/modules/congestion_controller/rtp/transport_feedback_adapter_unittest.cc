...
packets_per_ssrc
int64_t
first_transport_sequence_number
=
99
)
{
...
BuildRtcpCongestionControlFeedbackPacket
(
ArrayView
<
const
...
:
bool
UseRfc8888CongestionControlFeedback
(
)
const
{
...
TEST
(
TransportFeedbackAdapterCongestionFeedbackTest
...
(
TransportFeedbackAdapterTest
SmoothedRttIsInfiniteForTransportFeedback
)
{
TransportFeedbackAdapter
adapter
