...
constexpr
DataRate
kMinRateHaveMultiplicativeRateChange
=
DataRate
:
:
...
(
MonitorIntervalLengthStrategy
:
:
kFixed
)
monitor_interval_duration_ratio_
(
kMonitorIntervalDurationRatio
)
sampling_step_
...
monitor_interval_timeout_ratio_
(
kTimeoutRatio
)
