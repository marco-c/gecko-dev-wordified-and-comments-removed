...
(
RtpRtcpImplTest
SenderReportStatsNotUpdatedWithUnexpectedSsrc
)
{
constexpr
uint32_t
kUnexpectedSenderSsrc
=
0x87654321
;
static_assert
...
(
RtpRtcpImplTest
SenderReportStatsCheckStatsFromLastReport
)
{
using
SenderReportStats
...
(
RtpRtcpImplTest
SenderReportStatsArrivalTimestampSet
)
{
SendFrame
(
...
(
RtpRtcpImplTest
SenderReportStatsPacketByteCounters
)
{
using
SenderReportStats
