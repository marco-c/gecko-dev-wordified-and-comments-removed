...
(
RtcpTransceiverImplTest
NeedToStopPeriodicTaskToDestroyOnTaskQueue
)
{
FakeRtcpTransport
transport
...
(
RtcpTransceiverImplTest
CanBeDestroyedRightAfterCreation
)
{
FakeRtcpTransport
transport
...
(
RtcpTransceiverImplTest
SendsNoRtcpWhenNetworkStateIsDown
)
{
MockFunction
<
...
(
RtcpTransceiverImplTest
SendsPeriodicRtcpWhenNetworkStateIsUp
)
{
auto
queue
...
(
RtcpTransceiverImplTest
AvoidsEmptyReceiverReportsInReducedMode
)
{
RtcpPacketParser
rtcp_parser
...
(
RtcpTransceiverImplTest
SetRembSendsImmediatelyIfSendRembOnChange
)
{
const
uint32_t
...
(
RtcpTransceiverImplTest
CallsObserverOnByeBySenderSsrc
)
{
const
uint32_t
...
(
RtcpTransceiverImplTest
CallsObserverOnTargetBitrateBySenderSsrc
)
{
const
uint32_t
...
(
RtcpTransceiverImplTest
SkipsIncorrectTargetBitrateEntries
)
{
const
uint32_t
...
(
RtcpTransceiverImplTest
CallsObserverOnByeBehindUnknownRtcpPacket
)
{
const
uint32_t
...
(
RtcpTransceiverImplTest
IgnoresReceivedFirWithRepeatedSequenceNumber
)
{
static
constexpr
...
(
RtcpTransceiverImplTest
ReceivedFirTracksSequenceNumberPerRemoteSsrc
)
{
static
constexpr
...
(
RtcpTransceiverImplTest
CanReplyToRrtrOnceForAllLocalSsrcs
)
{
static
constexpr
...
(
RtcpTransceiverImplTest
CanReplyToRrtrForEachLocalSsrc
)
{
static
constexpr
...
(
RtcpTransceiverImplTest
CalculatesRoundTripTimeFromReportBlocks
)
{
MockNetworkLinkRtcpObserver
link_observer
...
(
RtcpTransceiverImplTest
ParsesCongestionControlFeedback
)
{
MockNetworkLinkRtcpObserver
link_observer
...
(
RtcpTransceiverImplTest
FailsToRegisterTwoSendersWithTheSameSsrc
)
{
RtcpTransceiverImpl
rtcp_transceiver
...
(
RtcpTransceiverImplTest
RotatesSendersWhenAllSenderReportDoNotFit
)
{
static
constexpr
...
(
RtcpTransceiverImplTest
SkipsSenderReportForInactiveSender
)
{
static
constexpr
