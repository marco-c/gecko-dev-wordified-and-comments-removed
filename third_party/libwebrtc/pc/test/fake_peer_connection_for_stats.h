#
ifndef
PC_TEST_FAKE_PEER_CONNECTION_FOR_STATS_H_
#
define
PC_TEST_FAKE_PEER_CONNECTION_FOR_STATS_H_
#
...
;
class
FakeVoiceMediaSendChannelForStats
:
public
...
;
class
FakeVideoMediaSendChannelForStats
:
public
...
;
UpdateJsepTransportController
(
mid
transport_name
)
;
SetChannelAndPushMediaChannels
(
transceiver
std
:
