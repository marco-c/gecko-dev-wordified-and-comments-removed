...
(
PeerConnectionFieldTrialTest
EnableDependencyDescriptorAdvertised
)
{
std
:
...
#
define
MAYBE_InjectDependencyDescriptor
DISABLED_InjectDependencyDescriptor
#
else
#
define
MAYBE_InjectDependencyDescriptor
InjectDependencyDescriptor
#
endif
TEST_F
(
