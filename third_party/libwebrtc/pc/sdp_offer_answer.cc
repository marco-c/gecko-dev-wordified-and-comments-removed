...
RTCError
FindDuplicateHeaderExtensionIds
(
const
RtpExtension
extension
...
RTCError
ValidateBundledRtpHeaderExtensions
(
const
SessionDescription
&
...
RTCError
ValidateRtpHeaderExtensionsForSpecSimulcast
(
const
SessionDescription
&
...
bool
GetInitialSimulcastLayersAndRejectionStatus
(
ContentSource
source
const
...
RTC_DCHECK_IS_ON
bool
SessionDescriptionStructureEquals
(
const
SessionDescriptionInterface
&
...
{
bool
previously_fired_direction_is_recv
=
transceiver
-
>
...
;
bool
all_rtp_have_same_cc_ack_type
=
true
;
bool
any_rtp_has_cc_ack_type
=
false
;
std
...
;
bool
remote_any_rtp_has_cc_ack_type
=
false
;
std
