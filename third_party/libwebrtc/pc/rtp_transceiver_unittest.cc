...
RtpTransceiver
>
CreateAudioTransceiverWithChannel
(
const
Environment
&
...
RtpTransceiver
>
CreateVideoTransceiverWithChannel
(
const
Environment
&
...
(
RtpTransceiverTest
CannotSetChannelOnStoppedTransceiver
)
{
const
std
...
(
RtpTransceiverTest
CanUnsetChannelOnStoppedTransceiver
)
{
const
std
...
;
Codec
cricket_sendonly_codec
;
RtpCodecCapability
sendonly_codec
;
Codec
cricket_recvonly_codec
;
RtpCodecCapability
recvonly_codec
;
...
(
RtpTransceiverTestWithFakeCall
OnNetworkRouteChangedForwardsToChannel
)
{
const
std
...
(
RtpTransceiverUnifiedPlanTest
SframeEnabledIsNulloptByDefault
)
{
scoped_refptr
<
...
(
RtpTransceiverUnifiedPlanTest
TryToEnableSframeSetsValueToTrue
)
{
scoped_refptr
<
