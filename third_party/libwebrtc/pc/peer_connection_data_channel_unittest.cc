...
class
PeerConnectionWrapperForDataChannelTest
:
public
...
{
return
sctp_transport_factory_
;
}
void
set_sctp_transport_factory
(
FakeSctpTransportFactory
*
sctp_transport_factory
...
;
class
PeerConnectionDataChannelBaseTest
:
public
:
:
...
>
WrapperPtr
CreatePeerConnectionWithDataChannel
(
Args
&
&
...
(
PeerConnectionDataChannelTest
InternalSctpTransportDeletedOnTeardown
)
{
auto
caller
...
(
PeerConnectionDataChannelTest
CreateDataChannelWithSctpDisabledFails
)
{
PeerConnectionFactoryInterface
:
