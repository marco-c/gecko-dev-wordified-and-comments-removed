...
pwd
:
someRemotePasswordGeneratedString
a
=
fingerprint
:
...
bool
GenerateOfferAndCollectCandidates
(
)
{
std
...
WrapperPtr
CreatePeerConnectionWithImmediateReport
(
)
{
RTCConfiguration
...
WrapperPtr
CreatePeerConnectionWithPrivateIpv6LocalAddresses
(
)
{
auto
...
(
PeerConnectionUsageHistogramTest
UsageFingerprintHistogramFromTimeout
)
{
auto
pc
...
(
PeerConnectionUsageHistogramTest
FingerprintStunTurnInReconfiguration
)
{
RTCConfiguration
configuration
...
(
PeerConnectionUsageHistogramTest
FingerprintWithPrivateIPCaller
)
{
auto
caller
...
(
PeerConnectionUsageHistogramTest
FingerprintWithPrivateIpv6Callee
)
{
auto
caller
...
const
kAllCandidateIPAddressTypeTestConfigs
[
]
=
{
