...
:
string
RTCCertificateIDFromFingerprint
(
const
std
:
...
:
string
RTCCodecStatsIDFromTransportAndCodecParameters
(
const
char
direction
...
:
string
RTCIceCandidatePairStatsIDFromConnectionInfo
(
const
ConnectionInfo
&
...
char
*
DataStateToRTCDataChannelState
(
...
char
*
IceCandidatePairStateToRTCStatsIceCandidatePairState
(
...
char
*
DtlsTransportStateToRTCDtlsTransportState
(
DtlsTransportState
state
)
...
:
string_view
NetworkTypeToStatsNetworkAdapterType
(
AdapterType
type
)
...
:
string
GetCodecIdAndMaybeCreateCodecStats
(
Timestamp
timestamp
const
