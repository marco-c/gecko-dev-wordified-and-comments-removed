...
(
PeerConnectionCryptoTest
CorrectCryptoInOfferWhenDtlsEnabled
)
{
RTCConfiguration
config
...
;
auto
owned_fake_certificate_generator
=
std
:
:
...
(
PeerConnectionCryptoTest
CreateAnswerWithDifferentSslRoles
)
{
auto
caller
...
(
PeerConnectionCryptoTest
SessionErrorIfFingerprintInvalid
)
{
auto
callee_certificate
