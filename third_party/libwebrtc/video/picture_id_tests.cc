...
#
define
MAYBE_TemporalLayers
DISABLED_TemporalLayers
#
else
#
define
...
(
PictureIdTest
ContinuousAfterStreamCountChangeVp8
)
{
test
:
...
(
PictureIdTest
ContinuousAfterReconfigureSimulcastEncoderAdapter
)
{
