...
params
bool
use_scalability_mode_identifier
)
;
void
...
;
bool
had_time_to_exceed_cap_in_relayed_phase
=
relayed_phase_
&
&
...
#
define
MAYBE_EncoderSetupPropagatesH264Config
\
...
vp9_header
;
last_temporal_idx_by_spatial_idx_
[
vp9_header
.
spatial_idx
...
(
VideoSendStreamTest
EncoderConfigMaxFramerateReportedToSource
)
{
static
const
...
(
VideoSendStreamTest
AlrNotConfiguredWhenSendSideOff
)
{
test
:
...
constexpr
int
kMinFramesToObservePerStream
=
8
;
class
TemporalLayerObserver
:
public
test
:
...
;
configured_num_temporal_layers_
[
send_config
-
>
...
if
(
HighestTemporalLayerSentPerStream
(
)
)
observation_complete_
...
(
VideoSendStreamTest
TestTemporalLayersVp8Simulcast
)
{
InternalEncoderFactory
internal_encoder_factory
...
(
VideoSendStreamTest
TestTemporalLayersVp8SimulcastWithDifferentNumTls
)
{
InternalEncoderFactory
internal_encoder_factory
...
(
VideoSendStreamTest
TestTemporalLayersVp8SimulcastWithoutSimAdapter
)
{
test
:
...
(
VideoSendStreamTest
TestScalabilityModeVp8Simulcast
)
{
InternalEncoderFactory
internal_encoder_factory
...
(
VideoSendStreamTest
TestScalabilityModeVp8SimulcastWithDifferentMode
)
{
InternalEncoderFactory
internal_encoder_factory
