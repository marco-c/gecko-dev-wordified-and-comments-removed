...
(
ReceiveStatisticsProxyTest
OnDecodedFrameIncreasesDecodedFrameCounts
)
{
EXPECT_EQ
(
...
const
double
kExpectedTotalSquaredInterFrameDelaySecs
=
10
*
(
...
(
ReceiveStatisticsProxyTest
GetStatsReportsOnCorruptionScore
)
{
EXPECT_EQ
(
...
const
double
kExpectedCorruptionScoreSquaredSum
=
0
.
5
...
(
ReceiveStatisticsProxyTest
CumulativeDecodeGetStatsAccumulate
)
{
const
TimeDelta
...
(
ReceiveStatisticsProxyTest
ReportsNoTimingFrameInfoWhenInvalid
)
{
TimingFrameInfo
info
...
(
ReceiveStatisticsProxyTest
UpdatesFirstFrameReceivedToDecodedTime
)
{
const
TimeDelta
...
Video
.
DelayedFramesToRenderer_AvgDelayInMs
"
)
)
;
