...
const
int64_t
kFreqOffsetProcessIntervalInMs
=
40000
;
const
...
(
ReceiveStatisticsProxyTest
ReportsMaxTotalInterFrameDelay
)
{
webrtc
:
...
;
double
expected_total_inter_frame_delay
=
0
;
double
...
const
double
kExpectedSumSquaredFrameDurationsSecs
=
10
*
(
...
class
DecodeTimeHistogramsKillswitch
{
public
:
explicit
