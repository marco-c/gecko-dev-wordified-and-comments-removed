...
(
SimulcastTest
GetTotalMaxBitrateForSingleStream
)
{
std
:
...
(
SimulcastTest
GetTotalMaxBitrateForMultipleStreams
)
{
std
:
...
(
SimulcastTest
BandwidthAboveTotalMaxBitrateGivenToHighestStream
)
{
std
:
