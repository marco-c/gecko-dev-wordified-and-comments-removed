...
test
/
video_encoder_nullable_proxy_factory
.
h
"
#
...
void
SetApplyAlignmentToAllSimulcastLayers
(
bool
b
)
...
;
return
last_bitrate_allocation_
;
}
int
number_of_bitrate_allocations
(
)
const
{
...
void
ResetLastFrameInstrumentationData
(
)
{
MutexLock
...
(
VideoStreamEncoderTest
SimulcastIndexNotOverriddenBySpatialIndexZero
)
{
NiceMock
<
...
(
VideoStreamEncoderTest
NativeFrameWithoutI420SupportGetsDelivered
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
NonI420FramesShouldNotBeConvertedToI420
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
NativeFrameGetsDelivered_NoFrameTypePreference
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
NativeFrameGetsDelivered_MappingIsNotFeasible
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
NativeFrameGetsDelivered_BackedByNV12
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
DropsFramesWhenCongestionWindowPushbackSet
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
BitrateLimitsChangeReconfigureRateAllocator
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
EncoderRecommendedMaxBitrateCapsTargetBitrate
)
{
video_stream_encoder_
-
...
const
uint32_t
kDefaultTargetBitrateFor720pKbps
=
bitrate_allocator_factory_
.
codec_config
...
(
VideoStreamEncoderTest
SinkWantsDefaultUnlimitedBeforeFirstFrame
)
{
ASSERT_TRUE
(
...
(
VideoStreamEncoderTest
FrameRateLimitIgnoredOnInactiveStreams
)
{
ASSERT_THAT
(
...
(
VideoStreamEncoderTest
TestCpuDowngrades_BalancedMode
)
{
const
int
...
(
VideoStreamEncoderTest
AdaptUpIfBwEstimateIsHigherThanMinBitrate
)
{
fake_encoder_
.
...
(
VideoStreamEncoderTest
DropFirstFramesIfBwEstimateIsTooLow
)
{
fake_encoder_
.
...
(
BalancedDegradationTest
AdaptDownTwiceIfMinFpsDiffLtThreshold
)
{
SetupTestWithFieldTrial
(
...
(
BalancedDegradationTest
NoAdaptUpIfBwEstimateIsLessThanMinBitrate
)
{
SetupTestWithFieldTrial
(
...
(
VideoStreamEncoderTest
ReportsVideoLayersAllocationForVP8Simulcast
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
ReportsVideoLayersAllocationForH264
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
TemporalLayersNotDisabledIfSupported
)
{
const
int
...
(
VideoStreamEncoderTest
TemporalLayersDisabledIfNotSupported
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
VerifyBitrateAllocationForTwoStreams
)
{
auto
field_trials
...
(
VideoStreamEncoderTest
InitialFrameDropActivatesWhenBweDrops
)
{
auto
field_trials
...
(
VideoStreamEncoderTest
InitialFrameDropAccountsForResolutionScaling
)
{
VideoEncoderConfig
video_encoder_config
...
(
VideoStreamEncoderTest
InitialFrameDropActivatesWhenLayersChange
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
InitialFrameDropActivatesWhenSVCLayersChange
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
SinglecastBitrateLimitsNotUsedForOneStream
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
DropsFramesWhenEncoderOvershoots
)
{
const
int
...
(
VideoStreamEncoderTest
AccumulatesUpdateRectOnDroppedFrames
)
{
VideoFrame
:
...
(
VideoStreamEncoderTest
MergesKeyFrameRequestsForMultipleLayers
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
DoesNotRewriteH264BitstreamWithOptimalSps
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
CopiesVideoFrameMetadataAfterDownscale
)
{
const
int
...
(
VideoStreamEncoderTest
EncoderRatesPropagatedOnReconfigure
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
EncoderSelectorCurrentEncoderIsSignaled
)
{
constexpr
int
...
(
VideoStreamEncoderTest
EncoderSelectorResolutionSwitch
)
{
NiceMock
<
...
(
VideoStreamEncoderTest
EncoderSelectorBrokenEncoderSwitch
)
{
constexpr
int
...
(
VideoStreamEncoderTest
SwitchEncoderOnInitFailureWithEncoderSelector
)
{
NiceMock
<
...
(
VideoStreamEncoderTest
ConfiguresVp9SvcAtOddResolutions
)
{
const
int
...
(
VideoStreamEncoderTest
EncoderResetAccordingToParameterChange
)
{
const
float
...
(
VideoStreamEncoderTest
EncoderResetAccordingToCodecChange
)
{
const
float
...
(
VideoStreamEncoderTest
EncoderResolutionsExposedInSinglecast
)
{
const
int
...
(
VideoStreamEncoderTest
EncoderResolutionsExposedInSimulcast
)
{
const
size_t
...
(
VideoStreamEncoderTest
QpAbsentParsingDisabled_QpAbsent
)
{
auto
field_trials
...
(
VideoStreamEncoderTest
QualityScalingNotAllowed_IsQpTrustedSetTrue
)
{
VideoEncoderConfig
video_encoder_config
...
(
VideoStreamEncoderTest
EncoderProvideLimitsWhenQPIsNotTrusted
)
{
fake_encoder_
.
...
(
VideoStreamEncoderTest
EncoderDoesnotProvideLimitsWhenQPIsNotTrusted
)
{
fake_encoder_
.
...
(
VideoStreamEncoderTest
NormalComplexityVP9WithMoreThanTwoCores
)
{
ResetEncoder
(
...
(
VideoStreamEncoderTest
DynamicSpeedCanOverrideVp9LowComplexity
)
{
FieldTrials
trials
...
(
VideoStreamEncoderTest
ConfiguresCameraEncoderComplexityViaFieldTrial
)
{
auto
field_trials
...
(
VideoStreamEncoderTest
QualityScalingAllowed_QualityScalingEnabled
)
{
VideoEncoderConfig
video_encoder_config
...
(
VideoStreamEncoderTest
QualityScalingAllowed_IsQpTrustedSetTrue
)
{
VideoEncoderConfig
video_encoder_config
...
(
VideoStreamEncoderTest
QualityScalingAllowed_IsQpTrustedSetFalse
)
{
VideoEncoderConfig
video_encoder_config
...
(
VideoStreamEncoderTest
RecreatesEncoderWhenEnableVp9SpatialLayer
)
{
fake_encoder_
.
...
class
ReconfigureSimulcastEncoderTest
:
public
VideoStreamEncoderTest
{
...
(
ReconfigureSimulcastEncoderTest
ReconfiguredIfMaxFramerateChanges
)
{
VideoStream
config_before_high
...
(
ReconfigureEncoderTest
NotReconfiguredIfMaxFramerateChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
NotReconfiguredIfMinBitrateChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
NotReconfiguredIfMaxBitrateChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
NotReconfiguredIfBitratePriorityChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
ReconfiguredIfResolutionChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
ReconfiguredIfNumTemporalLayerChanges
)
{
VideoStream
config1
...
(
ReconfigureEncoderTest
ReconfiguredIfScalabilityModeChanges
)
{
VideoStream
config1
