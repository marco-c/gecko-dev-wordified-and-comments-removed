...
const
int
kResolutionMinBitrateBps
=
435000
;
const
int
kTooLowMinResolutionBitrateBps
=
434000
;
OnBitrateUpdated
...
(
VideoStreamEncoderTest
AdjustsTimestampInternalSource
)
{
encoder_factory_
.
