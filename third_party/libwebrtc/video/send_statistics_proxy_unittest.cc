...
(
SendStatisticsProxyTest
TotalEncodeTimeIncreasesPerFrameMeasured
)
{
const
int
...
(
SendStatisticsProxyTest
TotalEncodedBytesTargetFirstFrame
)
{
const
uint32_t
...
;
uint64_t
first_total_encoded_bytes_target
=
statistics_proxy_
-
>
...
(
SendStatisticsProxyTest
EncodeFrameRateInSubStreamsVp8Simulcast
)
{
const
int
...
(
SendStatisticsProxyTest
GetStatsReportsCpuAdaptChanges
)
{
statistics_proxy_
-
...
(
SendStatisticsProxyTest
GetStatsReportsQualityAdaptChanges
)
{
VideoAdaptationCounters
cpu_counts
...
(
SendStatisticsProxyTest
TestAdaptationStatisticsMasking
)
{
VideoAdaptationCounters
cpu_counts
...
(
SendStatisticsProxyTest
ExcludesInitialQualityAdaptDownChanges
)
{
UpdateDataCounters
(
...
(
SendStatisticsProxyTest
InitialQualityAdaptChangesNotExcludedOnError
)
{
UpdateDataCounters
(
...
(
SendStatisticsProxyTest
AdaptChangesStatsExcludesDisabledTime
)
{
UpdateDataCounters
(
...
(
SendStatisticsProxyTest
QualityAdaptChangesStatsExcludesSuspendedTime
)
{
UpdateDataCounters
(
...
(
SendStatisticsProxyTest
AdaptChangesStatsRestartsOnFirstSentPacket
)
{
VideoAdaptationCounters
cpu_counts
...
(
SendStatisticsProxyTest
AdaptChangesStatsStartedAfterFirstSentPacket
)
{
VideoAdaptationCounters
cpu_counts
...
(
SendStatisticsProxyTest
AdaptChangesReportedAfterContentSwitch
)
{
UpdateDataCounters
(
...
(
SendStatisticsProxyTest
QualityLimitationReasonIsNoneWhenNotLimited
)
{
VideoAdaptationCounters
cpu_counts
...
(
SendStatisticsProxyTest
QualityLimitationResolutionChangesDefaultZero
)
{
EXPECT_EQ
(
...
(
ForcedFallbackEnabled
StatsNotUpdatedIfMinRunTimeHasNotPassed
)
{
InsertEncodedFrames
(
...
(
ForcedFallbackEnabled
StatsNotUpdatedForTemporalLayers
)
{
codec_info_
.
...
(
ForcedFallbackDisabled
EnteredLowResolutionSetIfAtMaxPixels
)
{
InsertEncodedFrames
(
...
(
ForcedFallbackEnabled
EnteredLowResolutionNotSetIfNotLibvpx
)
{
InsertEncodedFrames
(
...
(
ForcedFallbackEnabled
EnteredLowResolutionSetIfLibvpx
)
{
codec_name_
=
...
(
ForcedFallbackDisabled
EnteredLowResolutionNotSetIfAboveMaxPixels
)
{
encoded_image_
.
...
(
ForcedFallbackDisabled
EnteredLowResolutionNotSetIfLibvpx
)
{
codec_name_
=
...
(
SendStatisticsProxyTest
PsnrHistogramsRealtimeVideoSingleStream
)
{
VideoSendStream
:
...
(
SendStatisticsProxyTest
PsnrHistogramsRealtimeVideoSimulcast
)
{
const
int
