...
(
VideoReceiveStream2Test
MinPlayoutDelayIsLimitedByMaxPlayoutDelay
)
{
const
VideoPlayoutDelay
...
(
VideoReceiveStream2Test
RenderParametersSetToDefaultValues
)
{
const
VideoFrame
...
(
VideoReceiveStream2Test
UseLowLatencyRenderingSetFromPlayoutDelay
)
{
std
:
...
(
VideoReceiveStream2Test
MaxCompositionDelaySetFromMaxPlayoutDelay
)
{
video_receive_stream_
-
...
const
int
kExpectedMaxCompositionDelayInFrames
=
3
;
std
...
(
VideoReceiveStream2Test
LazyDecoderCreationCodecSwitch
)
{
constexpr
uint8_t
...
(
VideoReceiveStream2Test
BetterFrameInsertedWhileWaitingToDecodeFrame
)
{
video_receive_stream_
-
...
(
VideoReceiveStream2Test
PoorConnectionWithFpsChangeDuringLostFrame
)
{
video_receive_stream_
-
...
(
VideoReceiveStream2Test
StreamShouldNotTimeoutWhileWaitingForFrame
)
{
config_
.
