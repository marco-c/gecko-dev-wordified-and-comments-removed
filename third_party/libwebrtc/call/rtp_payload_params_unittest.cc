...
TEST
(
RtpPayloadParamsTest
InfoMappedToRtpVideoHeader_Vp8
)
{
RtpPayloadState
state2
...
(
RtpPayloadParamsTest
InfoMappedToRtpVideoHeader_Vp9
)
{
RtpPayloadState
state
...
(
RtpPayloadParamsTest
CreatesGenericDescriptorForVp8
)
{
constexpr
auto
...
(
RtpPayloadParamsTest
GenerateFrameIdWhenExternalFrameIdsAreNotProvided
)
{
RtpPayloadState
state
...
(
RtpPayloadParamsTest
GenericDescriptorForGenericCodec
)
{
RtpPayloadState
state
...
(
RtpPayloadParamsTest
SetsGenericFromGenericFrameInfo
)
{
RtpPayloadState
state
