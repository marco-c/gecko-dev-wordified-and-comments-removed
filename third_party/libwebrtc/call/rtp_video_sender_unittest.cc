...
(
RtpVideoSenderTest
OnEncodedImageReturnOkWhenSendingTrue
)
{
constexpr
uint8_t
...
(
RtpVideoSenderTest
OnEncodedImageReturnErrorCodeWhenSendingFalse
)
{
constexpr
uint8_t
...
const
int64_t
kState1SharedFrameId
=
123
;
const
int64_t
kState2SharedFrameId
=
234
;
RtpPayloadState
...
uint16_t
>
retransmitted_rtp_sequence_numbers
;
EXPECT_CALL
(
test
...
(
RtpVideoSenderTest
RetransmitsOnTransportWideLossInfo
)
{
int
rtx_packets
...
(
RtpVideoSenderTest
MixedCodecSimulcastPayloadType
)
{
RtpVideoSenderTestFixture
test
...
(
RtpVideoSenderTest
SupportsDependencyDescriptorForVp9
)
{
RtpVideoSenderTestFixture
test
...
(
RtpVideoSenderTest
GenerateDependecyDescriptorForGenericCodecs
)
{
absl
:
...
(
RtpVideoSenderTest
SupportsStoppingUsingDependencyDescriptor
)
{
RtpVideoSenderTestFixture
test
...
(
RtpVideoSenderTest
SimulcastSenderRegistersFrameTransformers
)
{
scoped_refptr
<
...
(
RtpVideoSenderTest
OverheadIsSubtractedFromTargetBitrate
)
{
absl
:
...
(
RtpVideoSenderTest
ClearsPendingPacketsOnInactivation
)
{
RtpVideoSenderTestFixture
test
...
(
RtpVideoSenderTest
PostTaskRaceDoesNotLeadToDanglingPointer
)
{
NiceMock
<
