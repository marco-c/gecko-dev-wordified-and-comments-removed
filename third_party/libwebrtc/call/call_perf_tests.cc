...
(
CallPerfTest
Synchronization_PlaysOutAudioAndVideoWithoutClockDrift
)
{
TestAudioVideoSync
(
...
(
CallPerfTest
Synchronization_PlaysOutAudioAndVideoWithVideoNtpDrift
)
{
TestAudioVideoSync
(
...
rtp_start_timestamp_set_
(
false
)
rtp_start_timestamp_
(
0
)
{
...
(
CallPerfTest
Real_Estimated_CaptureNtpTimeWithNetworkDelay
)
{
BuiltInNetworkBehaviorConfig
net_config
...
(
CallPerfTest
Real_Estimated_CaptureNtpTimeWithNetworkJitter
)
{
BuiltInNetworkBehaviorConfig
net_config
...
(
CallPerfTest
Bitrate_Kbps_PadsToMinTransmitBitrate
)
{
TestMinTransmitBitrate
(
...
(
CallPerfTest
Bitrate_Kbps_NoPadWithoutMinTransmitBitrate
)
{
TestMinTransmitBitrate
(
...
auto
&
encode_frame_rate_list
:
encode_frame_rate_lists_
)
{
const
SamplesStatsCounter
