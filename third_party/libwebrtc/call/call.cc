...
;
void
PauseSendAndPacerBitrateCounters
(
)
;
void
AddTargetBitrateSample
(
uint32_t
target_bitrate_bps
)
...
RTC_NO_UNIQUE_ADDRESS
SequenceChecker
send_transport_sequence_checker_
;
const
int
num_cpu_cores_
...
>
>
adaptation_resource_forwarders_
RTC_GUARDED_BY
(
worker_thread_
)
...
;
RepeatingTaskHandle
receive_side_cc_periodic_task_
;
RepeatingTaskHandle
elastic_bandwidth_allocation_task_
;
const
std
:
...
WebRTC
.
TimeFromNetworkToDeliverRtpPacketUs
"
nw_to_deliver_delay
.
us
