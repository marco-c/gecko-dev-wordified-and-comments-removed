...
HighPriorityTaskTriggersYieldRequest
)
{
test
:
...
(
ThreadCooperativeTest
HighPriorityTasksExecuteInSequence
)
{
test
:
...
(
ThreadCooperativeTest
YieldRequestedClearedAfterHighPriorityTask
)
{
std
:
...
TEST
(
ThreadCooperativeDeathTest
YieldInSynchronousBlockingCallTriggersDeath
)
{
std
:
