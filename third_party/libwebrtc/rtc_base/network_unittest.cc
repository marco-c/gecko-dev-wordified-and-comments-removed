...
(
NetworkTest
TestConvertIfAddrsMultiAddressesOnOneInterface
)
{
char
if_name
...
(
NetworkTest
TestConvertIfAddrsGetsNullAddr
)
{
ifaddrs
list
...
(
NetworkTest
TestGetAdapterTypeFromNetworkMonitor
)
{
char
if_name
...
(
NetworkTest
TestGetAdapterTypeFromNameMatching
)
{
std
:
...
(
NetworkTest
TestNetworkMonitorIsAdapterAvailable
)
{
char
if_name1
...
(
NetworkTest
TestGetBestIPWithPreferGlobalIPv6ToLinkLocalEnabled
)
{
InterfaceAddress
ip
...
(
NetworkTest
WebRTC_AllowMACBasedIPv6Address
)
{
std
:
...
(
NetworkTest
NetworkCostVpn_VpnMoreExpensive
)
{
FieldTrials
field_trials
...
(
NetworkTest
NetworkCostSlice_IgnoredWhenInapplicable
)
{
FieldTrials
field_trials
...
(
NetworkTest
GuessAdapterFromNetworkCost_Default
)
{
FieldTrials
field_trials
...
(
NetworkTest
GuessAdapterFromNetworkCost_Vpn
)
{
FieldTrials
field_trials
...
(
CompareNetworks
TransitivityOfIncomparabilityTest
)
{
auto
network_a
...
network
.
UnsubscribeNetworkSliceChanged
(
&
network
)
