...
(
CopyOnWriteBufferTest
MutableDataClonesDataWhenShared
)
{
CopyOnWriteBuffer
buf1
...
(
CopyOnWriteBufferTest
WritingToBufferDoesntAffectsSlice
)
{
CopyOnWriteBuffer
buf
