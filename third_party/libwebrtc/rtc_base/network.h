...
void
SubscribeNetworkPreferenceChanged
(
void
*
tag
...
{
network_preference_changed_callbacks_
.
AddReceiver
(
tag
...
void
UnsubscribeNetworkPreferenceChanged
(
void
*
tag
...
void
NotifyNetworkPreferenceChanged
(
Network
*
network
...
{
network_slice_changed_callbacks_
.
AddReceiver
(
tag
