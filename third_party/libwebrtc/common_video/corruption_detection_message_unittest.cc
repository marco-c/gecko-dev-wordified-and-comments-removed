...
TEST
(
CorruptionDetectionMessageTest
FailsToCreateWhenSequenceIndexIsTooLarge
)
{
EXPECT_EQ
(
...
(
CorruptionDetectionMessageTest
FailsToCreateWhenSequenceIndexIsTooSmall
)
{
EXPECT_EQ
(
...
(
CorruptionDetectionMessageTest
FailsToCreateWhenStddevIsTooLarge
)
{
EXPECT_EQ
(
...
(
CorruptionDetectionMessageTest
FailsToCreateWhenStddevIsTooSmall
)
{
EXPECT_EQ
(
...
(
CorruptionDetectionMessageTest
FailsToCreateWhenSampleValueIsTooLarge
)
{
const
std
...
(
CorruptionDetectionMessageTest
FailsToCreateWhenSampleValueIsTooSmall
)
{
const
std
...
(
CorruptionDetectionMessageTest
CreatesWhenValidParametersAreSpecified
)
{
const
std
