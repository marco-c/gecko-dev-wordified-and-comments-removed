...
:
string
kScreenshareSimulcastExperiment
=
"
WebRTC
-
...
{
"
foreman_cif_30kbps_net_delay_0_0_plr_0
"
0
.
0
...
{
"
foreman_cif_delay_50_0_plr_5_ulpfec
"
0
.
0
...
(
FullStackTest
ForemanCifWithoutPacketlossH264
)
{
VideoQualityTest
:
...
(
FullStackTest
ForemanCifPlr5H264SpsPpsIdrIsKeyframe
)
{
test
:
...
(
FullStackTest
DISABLED_ForemanCifPlr5H264Ulpfec
)
{
VideoQualityTest
:
...
(
FullStackTest
ConferenceMotionHd1TLModerateLimits
)
{
VideoQualityTest
:
...
{
"
conference_motion_hd_1tl_moderate_limits
"
0
.
0
...
{
"
conference_motion_hd_2tl_moderate_limits
"
0
.
0
...
(
FullStackTest
ConferenceMotionHd3TLModerateLimitsAltTLPattern
)
{
test
:
...
(
FullStackTest
ScreenshareSlidesVP8_3TL_Simulcast
)
{
test
:
...
(
FullStackTest
ScreenshareSlidesVP8_2TL_ModeratelyRestricted_ALR
)
{
test
:
...
{
"
screenshare_slides_moderately_restricted_ALR
"
0
.
0
...
(
FullStackTest
ScreenshareSlidesVP8_3TL_Simulcast_ALR
)
{
test
:
...
{
"
screenshare_slides_simulcast_alr
"
0
.
0
...
#
define
MAYBE_SimulcastFullHdOveruse
DISABLED_SimulcastFullHdOveruse
#
else
#
define
MAYBE_SimulcastFullHdOveruse
SimulcastFullHdOveruse
#
endif
TEST_F
(
...
#
define
MAYBE_LargeRoomVP8_50thumb
DISABLED_LargeRoomVP8_50thumb
#
define
MAYBE_LargeRoomVP8_15thumb
DISABLED_LargeRoomVP8_15thumb
#
else
#
define
MAYBE_LargeRoomVP8_50thumb
LargeRoomVP8_50thumb
#
define
MAYBE_LargeRoomVP8_15thumb
LargeRoomVP8_15thumb
#
endif
TEST_F
(
