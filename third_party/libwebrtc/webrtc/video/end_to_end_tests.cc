...
;
void
VerifyNewVideoReceiveStreamsRespectNetworkState
(
MediaType
network_to_bring_up
Transport
...
(
EndToEndTestH264
SendsAndReceivesH264VideoRotation90
)
{
CodecObserver
test
...
(
EndToEndTestH264
SendsAndReceivesH264PacketizationMode0
)
{
cricket
:
...
(
EndToEndTestH264
SendsAndReceivesH264PacketizationMode1
)
{
cricket
:
...
expect_flexfec_rtcp_
(
expect_flexfec_rtcp
)
received_flexfec_rtcp_
(
false
)
random_
...
const
int
kNumCompoundRtcpPacketsToObserve
=
10
;
class
...
rtx_padding_observed_
(
false
)
retransmit_observed_
(
false
)
started_
...
(
EndToEndTest
StopsSendingMediaWithoutFeedback
)
{
test
:
...
Video
.
UniqueNackRequestsReceivedInPercent
"
)
)
;
...
Call
.
TimeReceivingVideoRtpPacketsInSeconds
"
)
)
;
...
#
define
MAYBE_ContentTypeSwitches
DISABLED_ContentTypeSwitches
#
else
#
define
...
(
!
observed_redundant_retransmission_
[
header
.
ssrc
...
(
EndToEndTest
TestFlexfecRtpStatePreservation
)
{
#
endif
