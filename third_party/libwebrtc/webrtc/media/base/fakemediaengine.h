...
fail_set_send_codecs_
(
false
)
fail_set_recv_codecs_
(
false
)
send_ssrc_
...
RtcpParameters
&
send_rtcp_parameters
(
)
{
return
send_rtcp_parameters_
;
}
const
RtcpParameters
&
recv_rtcp_parameters
(
)
{
return
recv_rtcp_parameters_
;
}
bool
ready_to_send
