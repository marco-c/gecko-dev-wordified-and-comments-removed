...
;
size_t
incoming_rtp_written
=
0
;
size_t
outgoing_rtp_written
=
0
;
size_t
incoming_rtcp_written
=
0
;
size_t
outgoing_rtcp_written
=
0
;
size_t
...
;
size_t
recv_configs_written
=
0
;
size_t
send_configs_written
=
0
;
for
...
(
RtcEventLogSession
LogSessionAndReadBackWithAllExtensions
)
{
RtpHeaderExtensionMap
extensions
...
(
RtcEventLogTest
CircularBufferKeepsMostRecentEvents
)
{
constexpr
size_t
