...
int64_t
>
base_receive_acked_packet_time_ms
;
if
(
proto
.
has_receive_acked_packet_time_ms
(
)
)
{
...
>
>
receive_acked_packet_time_ms_values
=
DecodeDeltas
(
proto
.
receive_acked_packet_time_ms_deltas
(
)
unsigned_receive_acked_packet_time_ms_base
number_of_deltas
