...
ConvertIceCandidatePairConfigType
(
IceCandidatePairConfigType
type
)
...
:
Protocol
ConvertIceCandidatePairProtocol
(
...
:
NetworkType
ConvertIceCandidateNetworkType
(
...
ConvertIceCandidatePairEventType
(
IceCandidatePairEventType
type
)
...
encoded_rtc_event
.
mutable_ice_candidate_pair_config
(
)
;
encoded_ice_event
