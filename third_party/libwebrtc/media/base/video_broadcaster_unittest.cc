...
(
VideoBroadcasterTest
AppliesMinOfSinkWantsMaxAndTargetPixelCount
)
{
VideoBroadcaster
broadcaster
...
(
VideoBroadcasterTest
AppliesMinOfSinkWantsMaxFramerate
)
{
VideoBroadcaster
broadcaster
...
(
VideoBroadcasterTest
ConstraintsChangedNotCalledOnSinkAddition
)
{
MockSink
sink
...
(
VideoBroadcasterTest
UpdatesOnlyNewSinksWithConstraints
)
{
MockSink
sink1
