...
constexpr
int64_t
kUnsignalledReceiveStreamCooldownMs
=
500
;
constexpr
...
(
WebRtcVideoEngineTest
SupportCorruptionDetectionHeaderExtension
)
{
ExpectRtpCapabilitySupport
(
...
(
WebRtcVideoEngineTest
GetStatsWithoutCodecsSetDoesNotCrash
)
{
AddSupportedVideoCodecType
(
...
(
WebRtcVideoEngineTest
ReceiveBufferSizeViaFieldTrial
)
{
ChangeFieldTrials
(
...
(
WebRtcVideoEngineTest
TooHighReceiveBufferSizeViaFieldTrial
)
{
ChangeFieldTrials
(
...
(
WebRtcVideoEngineTest
TooLowReceiveBufferSizeViaFieldTrial
)
{
ChangeFieldTrials
(
...
(
WebRtcVideoEngineTest
UpdatesUnsignaledRtxSsrcAndRecoversPayload
)
{
AddSupportedVideoCodecType
(
...
(
WebRtcVideoEngineTest
Flexfec03SendCodecEnablesWithoutFieldTrial
)
{
encoder_factory_
-
...
(
WebRtcVideoChannelBaseTest
GetStatsDoesNotResetAfterCodecChange
)
{
const
int
...
(
WebRtcVideoChannelBaseTest
RequestEncoderSwitchWithNullopt
)
{
VideoSenderParameters
parameters
...
(
WebRtcVideoChannelBaseTest
RequestEncoderSwitchWithNoCodecs
)
{
VideoSenderParameters
parameters
...
(
WebRtcVideoChannelBaseTest
RequestEncoderSwitchDefaultFallback
)
{
VideoSenderParameters
parameters
...
(
WebRtcVideoChannelBaseTest
SendCodecIsMovedToFrontInRtpParameters
)
{
VideoSenderParameters
parameters
...
(
WebRtcVideoChannelTest
ToggleReceiveNonSenderRttAfterStreamStart
)
{
FakeVideoReceiveStream
*
...
(
WebRtcVideoChannelTest
SendCorruptionDetectionHeaderExtensions
)
{
TestSetSendRtpHeaderExtensions
(
...
(
WebRtcVideoChannelTest
RecvCorruptionDetectionHeaderExtensions
)
{
TestSetRecvRtpHeaderExtensions
(
...
(
WebRtcVideoChannelTest
DisableFrameInstrumentationByDefault
)
{
EXPECT_TRUE
(
...
(
Vp9SettingsTest
MaxBitrateDeterminedBySvcResolutions
)
{
VideoSenderParameters
parameters
...
(
Vp9SettingsTest
Vp9SvcTargetBitrateCappedByMax
)
{
VideoSenderParameters
parameters
...
(
WebRtcVideoChannelTest
GetStatsReportsPowerEfficientEncoder
)
{
FakeVideoSendStream
*
...
(
WebRtcVideoChannelTest
OutboundRtpIsActiveComesFromAnyEncodingInSvc
)
{
VideoSenderParameters
send_parameters
...
(
WebRtcVideoChannelTest
MultiplePendingDemuxerCriteriaUpdates
)
{
EXPECT_TRUE
(
...
(
WebRtcVideoChannelTest
RtxAfterMediaPacketUpdatesUnsignalledRtxSsrc
)
{
AssignDefaultAptRtxTypes
(
...
(
WebRtcVideoChannelTest
UnsignaledStreamCreatedAfterMediaPacket
)
{
AssignDefaultAptRtxTypes
(
...
(
WebRtcVideoChannelTest
Simulcast_QualityScalingNotAllowed
)
{
FakeVideoSendStream
*
...
(
WebRtcVideoChannelTest
Singlecast_QualityScalingAllowed
)
{
FakeVideoSendStream
*
