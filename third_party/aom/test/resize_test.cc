...
(
ResizeCrashTest
TestCompoundMaskPredictionCrash
)
{
:
:
...
(
ResizeRealtimeTest
TestInternalResizeSetScaleMode1
)
{
:
:
...
(
ResizeRealtimeTest
TestInternalResizeSetScaleMode1QVGA
)
{
:
:
...
(
ResizeRealtimeTest
TestInternalResizeSetScaleMode2
)
{
:
:
...
(
ResizeRealtimeTest
TestInternalResizeSetScaleMode3
)
{
:
:
...
(
ResizeRealtimeTest
TestExternalResizeWorksUsePSNR
)
{
ResizingVideoSource
video
...
(
ResizeRealtimeTest
TestInternalResizeDownUpChangeBitRateScreen
)
{
:
:
