...
BuildParams
(
av1_build_compound_diffwtd_mask_neon
)
)
;
#
...
using
BuildCompDiffWtdMaskHighbdFunc
=
void
(
*
...
class
BuildCompDiffwtdMaskHighbdTest
:
public
:
:
...
BuildParamsHighbd
(
av1_build_compound_diffwtd_mask_highbd_neon
)
)
;
#
