...
#
define
PARALLEL_DEBLOCKING_11_TAP
0
#
define
PARALLEL_DEBLOCKING_9_TAP
0
#
if
...
static
void
highbd_mb_lpf_horizontal_edge_w
(
uint16_t
*
s
...
void
aom_highbd_lpf_horizontal_edge_8_c
(
uint16_t
*
s
