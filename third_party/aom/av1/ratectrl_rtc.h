...
=
32
kAomAV1MaxTemporalLayers
=
8
kAomAV1MaxSpatialLayers
=
4
}
;
...
constexpr
FrameDropDecision
kFrameDropDecisionOk
=
kAomFrameDropDecisionOk
;
constexpr
FrameDropDecision
kFrameDropDecisionDrop
=
kAomFrameDropDecisionDrop
;
class
...
;
AomAV1LoopfilterLevel
av1_ratecontrol_rtc_get_loop_filter_level
(
const
AomAV1RateControlRTC
*
...
;
bool
av1_ratecontrol_rtc_get_segmentation
(
const
AomAV1RateControlRTC
*
...
;
AomAV1CdefInfo
av1_ratecontrol_rtc_get_cdef_info
(
const
AomAV1RateControlRTC
*
...
;
void
av1_ratecontrol_rtc_init_ratecontrol_config
(
AomAV1RateControlRtcConfig
*
config
