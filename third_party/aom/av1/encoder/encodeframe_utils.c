...
CONFIG_SALIENCY_MAP
void
av1_set_saliency_map_vmaf_rdmult
(
const
AV1_COMP
*
...
;
uint64_t
avg_source_sse_threshold_verylow
=
10000
;
uint64_t
avg_source_sse_threshold_low
[
2
]
=
