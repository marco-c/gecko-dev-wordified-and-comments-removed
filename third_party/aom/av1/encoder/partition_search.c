...
#
ifndef
COLLECT_MOTION_SEARCH_FEATURE_SB
#
define
COLLECT_MOTION_SEARCH_FEATURE_SB
...
static
int
get_force_zeromv_skip_flag_for_blk
(
const
AV1_COMP
*
...
static
void
init_partition_block_timing_stats
(
...
inline
void
accumulate_partition_timing_stats
(
FramePartitionTimingStats
*
fr_part_timing_stats
const
PartitionTimingStats
*
part_timing_stats
...
inline
void
copy_partition_mode_from_mode_context
(
const
MB_MODE_INFO
*
...
inline
void
copy_partition_mode_from_pc_tree
(
const
MB_MODE_INFO
*
...
inline
bool
is_neighbor_blk_larger_than_cur_blk
(
const
MACROBLOCKD
*
...
static
void
prepare_sb_features_before_search
(
AV1_COMP
*
const
...
static
void
build_pc_tree_from_part_decision
(
const
...
static
bool
ml_partition_search_whole_tree
(
AV1_COMP
*
const
...
#
ifdef
_COLLECT_GROUND_TRUTH_
static
int
store_partition_data
(
AV1_COMP
*
cpi
