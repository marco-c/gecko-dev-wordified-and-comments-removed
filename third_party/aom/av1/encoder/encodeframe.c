...
#
define
FORCE_ZMV_SKIP_128X128_BLK_DIFF
10000
#
define
FORCE_ZMV_SKIP_MAX_PER_PIXEL_DIFF
4
static
void
populate_thresh_to_force_zeromv_skip
(
AV1_COMP
*
cpi
...
static
int
aom_get_variance_boost_delta_q_res
(
int
qindex
)
...
static
void
check_to_disable_ref_frame_mvs
(
AV1_COMP
*
cpi
