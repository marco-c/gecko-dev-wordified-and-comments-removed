...
const
uint8_t
av1_derived_filter_intra_mode_used_flag
[
INTRA_MODES
]
=
...
const
uint16_t
av1_derived_chroma_intra_mode_used_flag
[
INTRA_MODES
]
=
...
inline
int
get_model_rd_index_for_pruning
(
const
MACROBLOCK
*
