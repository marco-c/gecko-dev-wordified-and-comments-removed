...
const
int
use_screen_content_tools_orig_decision
const
int
...
const
BLOCK_SIZE
fixed_partition_block_size_orig
=
cpi
-
>
...
void
av1_set_mb_ssim_rdmult_scaling
(
AV1_COMP
*
cpi
...
1
void
av1_dump_filtered_recon_frames
(
AV1_COMP
*
cpi
