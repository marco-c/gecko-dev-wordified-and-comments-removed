...
void
define_customized_gf_group_structure
(
AV1_COMP
*
cpi
...
;
int
accumulative_subgroup_interval
=
0
;
if
...
#
define
REDUCE_GF_LENGTH_THRESH
4
#
define
REDUCE_GF_LENGTH_TO_KEY_THRESH
9
#
define
REDUCE_GF_LENGTH_BY
