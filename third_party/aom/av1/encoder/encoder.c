...
static
void
estimate_screen_content_antialiasing_aware
(
AV1_COMP
*
cpi
...
const
int
kComplexInitialColorThresh
=
40
;
const
int
kComplexFinalColorThresh
=
6
;
const
...
static
void
calculate_frame_avg_haar_energy
(
AV1_COMP
*
cpi
...
static
void
increment_scaled_ref_counts_fpmt
(
BufferPool
*
buffer_pool
...
static
void
rtc_set_updates_ref_frame_config
(
...
static
int
rtc_set_references_external_ref_frame_config
(
AV1_COMP
*
cpi
