...
inline
bool
prune_tx_split_eval_using_no_split_rd
(
const
MACROBLOCK
*
...
inline
void
get_2x2_normalized_sses_and_sads
(
const
AV1_COMP
*
...
=
&
av1_intra_tx_split_nnconfig_8x8
;
const
float
*
const
intra_tx_prune_thresh
=
