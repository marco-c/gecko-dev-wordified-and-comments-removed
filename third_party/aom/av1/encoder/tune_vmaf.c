...
static
double
residual_frame_average_variance
(
AV1_COMP
*
cpi
...
static
double
find_best_frame_unsharp_amount_loop
(
const
AV1_COMP
*
...
static
double
find_best_frame_unsharp_amount
(
const
AV1_COMP
*
...
static
double
find_best_frame_unsharp_amount_loop_neg
(
AV1_COMP
*
const
