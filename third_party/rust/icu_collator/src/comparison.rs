...
:
:
HARDCODED_COMPRESSIBLE_BYTES_FALLBACK
)
;
CollationSpecialPrimariesValidated
{
...
:
:
SINGLETON_COLLATION_SPECIAL_PRIMARIES_V1
.
last_primaries
.
as_slice
...
fn
sort_key_to_slice_identical_too_long
(
)
{
let
...
fn
sort_key_utf16_slice_too_small
(
)
{
let
