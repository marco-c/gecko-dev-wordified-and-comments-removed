...
:
{
get_src_stride_of_indirect_args
...
let
(
metadata_resource_index
metadata_buffer_offset
)
=
resources
.
get_metadata_subrange
(
data
.
len
...
:
:
get_dst_stride_of_indirect_args
(
device
.
backend
