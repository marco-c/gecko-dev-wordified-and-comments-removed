...
fn
create_voiceprocessing_audiounit
(
)
-
>
...
:
:
should_force_vpio_for_input_device
(
ds
.
device
...
fn
debug_assert_is_on_stream_queue
(
&
self
)
...
fn
should_block_vpio_for_device_pair
(
&
self
in_device
...
;
let
should_use_voice_processing_unit
=
self
.
has_input
