...
device
.
new_binary_archive_with_descriptor
(
&
binary_archive_descriptor
)
...
sample_buffer_attachment_descriptor
.
set_end_of_vertex_sample_index
(
1
as
NSUInteger
...
sample_buffer_attachment_descriptor
.
set_start_of_fragment_sample_index
(
2
as
NSUInteger
...
sample_buffer_attachment_descriptor
.
set_end_of_fragment_sample_index
(
3
as
NSUInteger
...
binary_archive
.
add_render_pipeline_functions_with_descriptor
(
&
pipeline_state_descriptor
)
