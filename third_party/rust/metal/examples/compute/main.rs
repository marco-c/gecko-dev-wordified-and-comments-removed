...
=
create_input_and_output_buffers
(
&
device
num_elements
...
{
let
sample_buffer_attachment_descriptor
=
compute_pass_descriptor
.
...
sample_buffer_attachment_descriptor
.
set_start_of_encoder_sample_index
(
0
)
;
sample_buffer_attachment_descriptor
.
set_end_of_encoder_sample_index
(
1
)
;
...
device
.
new_counter_sample_buffer_with_descriptor
(
&
counter_sample_buffer_desc
)
