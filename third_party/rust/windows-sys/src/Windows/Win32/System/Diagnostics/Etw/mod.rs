...
from_u128
(
0x45d8cccd_539f_4b72_a8b7_5c683142609a
)
;
#
[
...
from_u128
(
0x7b40792d_05ff_44c4_9058_f440c71f17d4
)
;
#
[
...
from_u128
(
0x0811c1af_7a07_4a06_82ed_869455cdf713
)
;
pub
const
...
from_u128
(
0x3d6fa8d4_fe05_11d0_9dda_00c04fd7ba7c
)
;
pub
type
...
pub
const
EVENT_TRACE_TYPE_CONFIG_PHYSICALDISK_EX
:
u32
=
19u32
...
from_u128
(
0x01853a65_418f_4f36_aefc_dc0f1d2fd235
)
;
pub
const
...
from_u128
(
0x68fdd900_4a3e_11d1_84f4_0000f80464e3
)
;
pub
const
...
from_u128
(
0x90cbdc39_4a3e_11d1_84f4_0000f80464e3
)
;
pub
const
...
from_u128
(
0x2cb15d1d_5fc1_11d2_abe1_00a0c911f518
)
;
pub
const
...
from_u128
(
0x3d6fa8d3_fe05_11d0_9dda_00c04fd7ba7c
)
;
pub
const
...
from_u128
(
0xce1dbfb4_137e_4da6_87b0_3f59aa102cbc
)
;
pub
const
...
from_u128
(
0x3595ab5c_042a_4c8e_b942_2d059bfeb1b1
)
;
pub
const
...
from_u128
(
0x3d6fa8d0_fe05_11d0_9dda_00c04fd7ba7c
)
;
pub
const
...
from_u128
(
0xae53722e_c863_11d2_8659_00c04fa321a1
)
;
pub
const
...
from_u128
(
0xd837ca92_12b9_44a5_ad6a_3a65b3578aa8
)
;
pub
const
...
from_u128
(
0xfcb9baaf_e529_4980_92e9_ced1a6aadfdf
)
;
pub
const
...
from_u128
(
0xfef3a8b6_318d_4b67_a96a_3b0f6b8f18fe
)
;
pub
const
...
from_u128
(
0xc6c5265f_eae8_4650_aae4_9d48603d8510
)
;
pub
const
...
from_u128
(
0xbafa072a_918a_4bed_b622_bc152097098f
)
;
pub
const
...
from_u128
(
0xd4bbee17_b545_4888_858b_744169015b25
)
;
pub
const
...
from_u128
(
0xfbd09363_9e22_4661_b8bf_e7a34b535b8c
)
;
pub
const
...
from_u128
(
0x3d5c43e3_0f1c_4202_b817_174c0070dc79
)
;
pub
const
...
from_u128
(
0x721ddfd3_dacc_4e1e_b26a_a2cb31d4705a
)
;
pub
const
...
from_u128
(
0x82958ca9_b6cd_47f8_a3a8_03ae85a4bc24
)
;
pub
const
...
from_u128
(
0xfebd7460_3d1d_47eb_af49_c9eeb1e146f2
)
;
pub
const
...
from_u128
(
0xc134884a_32d5_4488_80e5_14ed7abb8269
)
;
pub
const
...
from_u128
(
0x151f55dc_467d_471f_83b5_5f889d46ff66
)
;
pub
const
...
from_u128
(
0xbfeb0324_1cee_496f_a409_2ac2b48a6322
)
;
pub
const
...
from_u128
(
0x16156bd9_fab4_4cfa_a232_89d1099058e3
)
;
pub
const
...
from_u128
(
0x599a2a76_4d91_4910_9ac7_7d33f2e97a6c
)
;
pub
const
...
from_u128
(
0x434286f7_6f1b_45bb_b37e_95f623046c7c
)
;
pub
const
...
from_u128
(
0x4f061568_e215_499f_ab2e_eda0ae890a5b
)
;
pub
const
...
from_u128
(
0x9a280ac0_c8e0_11d1_84e2_00c04fb998a2
)
;
pub
const
...
from_u128
(
0x3d6fa8d1_fe05_11d0_9dda_00c04fd7ba7c
)
;
pub
const
...
from_u128
(
0xbf3a50c5_a9c9_4988_a005_2df0b7c80f80
)
;
pub
type
