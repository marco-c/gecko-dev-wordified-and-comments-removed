...
pub
const
HcnNotificationGuestNetworkServiceCreate
:
HCN_NOTIFICATIONS
=
7i32
...
pub
const
HcnNotificationGuestNetworkServiceDelete
:
HCN_NOTIFICATIONS
=
8i32
...
pub
const
HcnNotificationGuestNetworkServiceInterfaceStateChanged
:
HCN_NOTIFICATIONS
=
18i32
...
pub
const
HcnNotificationGuestNetworkServiceStateChanged
:
HCN_NOTIFICATIONS
=
17i32
...
pub
const
HcnNotificationNamespaceCreate
:
HCN_NOTIFICATIONS
=
5i32
...
pub
const
HcnNotificationNamespaceDelete
:
HCN_NOTIFICATIONS
=
6i32
...
pub
const
HcnNotificationNetworkEndpointAttached
:
HCN_NOTIFICATIONS
=
9i32
...
pub
const
HcnNotificationNetworkPreDelete
:
HCN_NOTIFICATIONS
=
3i32
