...
from_u128
(
0x3050f3d6_98b5_11cf_bb82_00aa00bdce0b
)
;
pub
const
...
from_u128
(
0xe8fb8621_588f_11d2_9d61_00c04f79c5fe
)
;
pub
const
...
from_u128
(
0xa9e69610_b80d_11d0_b9b9_00a0c922e750
)
;
pub
const
...
from_u128
(
0x920c25d0_25d9_11d0_a55f_00a0c90c2091
)
;
pub
const
...
from_u128
(
0x46e19ba0_25dd_11d0_a55f_00a0c90c2091
)
;
pub
const
...
from_u128
(
0xd97a6da0_a868_11cf_83ae_11b0c90c2bd8
)
;
pub
const
...
from_u128
(
0xa506d160_25e0_11d0_a55f_00a0c90c2091
)
;
pub
const
...
from_u128
(
0x509f8f20_25de_11d0_a55f_00a0c90c2091
)
;
pub
const
...
from_u128
(
0x61738644_f196_11d0_9953_00c04fd919c1
)
;
#
[
...
from_u128
(
0x70bdc667_33b2_45f0_ac52_c3ca46f7a656
)
;
pub
const
...
from_u128
(
0xaff081fe_0247_4275_9c4e_021f3dc1da35
)
;
pub
const
...
from_u128
(
0x06b94d9a_b15e_456e_a4ef_37c984a2cb4b
)
;
pub
const
...
from_u128
(
0xa1c2040e_8840_4c31_ba11_9871031a19ea
)
;
pub
const
...
from_u128
(
0xd55d3bc9_cba9_44df_827e_132d3a4596c2
)
;
pub
const
...
from_u128
(
0x3a2a4e84_4c21_4981_ae10_3fda0d9b0f83
)
;
pub
const
...
from_u128
(
0xde4649c9_15e8_4fea_9d85_1cdda520c334
)
;
pub
type
...
from_u128
(
0xd97a6da0_a85c_11cf_83ae_00a0c90c2bd8
)
;
pub
const
...
from_u128
(
0xe8fb8614_588f_11d2_9d61_00c04f79c5fe
)
;
pub
const
...
from_u128
(
0x29822aa8_f302_11d0_9953_00c04fd919c1
)
;
#
[
...
pub
const
MD_APPPOOL_EMULATION_ON_WINARM64
:
u32
=
9043u32
...
Anonymous
:
METADATA_GETALL_INTERNAL_RECORD_0
pub
dwMDDataTag
:
u32
...
:
PCWSTR
pszprotocolmanagerdllinitfunction
:
windows_sys
:
:
