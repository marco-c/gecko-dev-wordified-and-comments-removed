...
:
BOOL
fsetautodiscoverfordefaultsettings
:
windows_sys
:
:
...
pub
const
WINHTTP_AUTOLOGON_SECURITY_LEVEL_PROXY_ONLY
:
u32
=
3u32
...
pub
const
WINHTTP_AUTOPROXY_USE_INTERFACE_CONFIG
:
u32
=
2048u32
...
Anonymous1
:
WINHTTP_EXTENDED_HEADER_0
pub
Anonymous2
:
WINHTTP_EXTENDED_HEADER_1
}
impl
Default
for
...
pub
const
WINHTTP_FEATURE_ADD_REQUEST_HEADERS_EX
:
u32
=
46u32
...
pub
const
WINHTTP_FEATURE_BACKGROUND_CONNECTIONS
:
u32
=
34u32
...
pub
const
WINHTTP_FEATURE_CONNECTION_GUID
:
u32
=
38u32
...
pub
const
WINHTTP_FEATURE_CONNECTION_STATS_V0
:
u32
=
3u32
...
pub
const
WINHTTP_FEATURE_CONNECTION_STATS_V1
:
u32
=
12u32
...
pub
const
WINHTTP_FEATURE_DISABLE_CERT_CHAIN_BUILDING
:
u32
=
33u32
...
pub
const
WINHTTP_FEATURE_DISABLE_PROXY_AUTH_SCHEMES
:
u32
=
74u32
...
pub
const
WINHTTP_FEATURE_DISABLE_SECURE_PROTOCOL_FALLBACK
:
u32
=
6u32
...
pub
const
WINHTTP_FEATURE_DISABLE_STREAM_QUEUE
:
u32
=
1u32
...
pub
const
WINHTTP_FEATURE_ENABLE_HTTP2_PLUS_CLIENT_CERT
:
u32
=
23u32
...
pub
const
WINHTTP_FEATURE_EXPIRE_CONNECTION
:
u32
=
5u32
...
pub
const
WINHTTP_FEATURE_EXTENDED_HEADER_FLAG_UNICODE
:
u32
=
54u32
...
pub
const
WINHTTP_FEATURE_FAILED_CONNECTION_RETRIES
:
u32
=
24u32
...
pub
const
WINHTTP_FEATURE_FIRST_AVAILABLE_CONNECTION
:
u32
=
35u32
...
pub
const
WINHTTP_FEATURE_FLAG_AUTOMATIC_CHUNKING
:
u32
=
59u32
...
pub
const
WINHTTP_FEATURE_FLAG_SECURE_DEFAULTS
:
u32
=
53u32
...
pub
const
WINHTTP_FEATURE_FREE_QUERY_CONNECTION_GROUP_RESULT
:
u32
=
51u32
...
pub
const
WINHTTP_FEATURE_HTTP2_KEEPALIVE
:
u32
=
26u32
...
pub
const
WINHTTP_FEATURE_HTTP2_PLUS_TRANSFER_ENCODING
:
u32
=
31u32
...
pub
const
WINHTTP_FEATURE_HTTP2_RECEIVE_WINDOW
:
u32
=
43u32
...
pub
const
WINHTTP_FEATURE_HTTP3_HANDSHAKE_TIMEOUT
:
u32
=
70u32
...
pub
const
WINHTTP_FEATURE_HTTP3_INITIAL_RTT
:
u32
=
71u32
...
pub
const
WINHTTP_FEATURE_HTTP3_KEEPALIVE
:
u32
=
69u32
...
pub
const
WINHTTP_FEATURE_HTTP3_STREAM_ERROR_CODE
:
u32
=
72u32
...
pub
const
WINHTTP_FEATURE_HTTP_PROTOCOL_REQUIRED
:
u32
=
7u32
...
pub
const
WINHTTP_FEATURE_IGNORE_CERT_REVOCATION_OFFLINE
:
u32
=
17u32
...
pub
const
WINHTTP_FEATURE_IPV6_FAST_FALLBACK
:
u32
=
2u32
...
pub
const
WINHTTP_FEATURE_IS_FEATURE_SUPPORTED
:
u32
=
44u32
...
pub
const
WINHTTP_FEATURE_MATCH_CONNECTION_GUID
:
u32
=
39u32
...
pub
const
WINHTTP_FEATURE_MATCH_CONNECTION_GUID_FLAG_REQUIRE_MARKED_CONNECTION
:
u32
=
61u32
...
pub
const
WINHTTP_FEATURE_QUERY_CONNECTION_GROUP
:
u32
=
50u32
...
pub
const
WINHTTP_FEATURE_QUERY_CONNECTION_GROUP_FLAG_INSECURE
:
u32
=
60u32
...
pub
const
WINHTTP_FEATURE_QUERY_EX_ALL_HEADERS
:
u32
=
62u32
...
pub
const
WINHTTP_FEATURE_QUERY_FLAG_TRAILERS
:
u32
=
55u32
...
pub
const
WINHTTP_FEATURE_QUERY_FLAG_WIRE_ENCODING
:
u32
=
56u32
...
pub
const
WINHTTP_FEATURE_QUERY_HEADERS_EX
:
u32
=
49u32
...
pub
const
WINHTTP_FEATURE_READ_DATA_EX_FLAG_FILL_BUFFER
:
u32
=
63u32
...
pub
const
WINHTTP_FEATURE_REFERER_TOKEN_BINDING_HOSTNAME
:
u32
=
30u32
...
pub
const
WINHTTP_FEATURE_REQUEST_ANNOTATION
:
u32
=
73u32
...
pub
const
WINHTTP_FEATURE_REQUIRE_STREAM_END
:
u32
=
22u32
...
pub
const
WINHTTP_FEATURE_RESOLUTION_HOSTNAME
:
u32
=
27u32
...
pub
const
WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG
:
u32
=
32u32
...
pub
const
WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_BYPASS_CACHE
:
u32
=
58u32
...
pub
const
WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_CONN_USE_TTL
:
u32
=
65u32
...
pub
const
WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_SOFT_LIMIT
:
u32
=
57u32
...
pub
const
WINHTTP_FEATURE_RESOLVER_CACHE_CONFIG_FLAG_USE_DNS_TTL
:
u32
=
64u32
...
pub
const
WINHTTP_FEATURE_REVERT_IMPERSONATION_SERVER_CERT
:
u32
=
75u32
...
pub
const
WINHTTP_FEATURE_SECURITY_FLAG_IGNORE_ALL_CERT_ERRORS
:
u32
=
52u32
...
pub
const
WINHTTP_FEATURE_SERVER_CERT_CHAIN_CONTEXT
:
u32
=
9u32
...
pub
const
WINHTTP_FEATURE_SET_PROXY_SETINGS_PER_USER
:
u32
=
47u32
...
pub
const
WINHTTP_FEATURE_SET_TOKEN_BINDING
:
u32
=
28u32
...
pub
const
WINHTTP_FEATURE_STREAM_ERROR_CODE
:
u32
=
21u32
...
pub
const
WINHTTP_FEATURE_TCP_PRIORITY_STATUS
:
u32
=
37u32
...
pub
const
WINHTTP_FEATURE_TLS_FALSE_START
:
u32
=
16u32
...
pub
const
WINHTTP_FEATURE_TLS_PROTOCOL_INSECURE_FALLBACK
:
u32
=
20u32
...
pub
const
WINHTTP_FEATURE_TOKEN_BINDING_PUBLIC_KEY
:
u32
=
29u32
...
pub
const
WINHTTP_HANDLE_TYPE_PROXY_RESOLVER
:
u32
=
4u32
...
pub
const
WINHTTP_OPTION_NETWORK_INTERFACE_AFFINITY
:
u32
=
105u32
...
pub
const
WINHTTP_OPTION_REQUEST_ANNOTATION_MAX_LENGTH
:
u32
=
64000u32
...
pub
const
WINHTTP_PROXY_DISABLE_AUTH_LOCAL_SERVICE
:
u32
=
256u32
...
pub
const
WINHTTP_PROXY_DISABLE_SCHEME_BASIC
:
u32
=
1u32
...
pub
const
WINHTTP_PROXY_DISABLE_SCHEME_DIGEST
:
u32
=
2u32
...
pub
const
WINHTTP_PROXY_DISABLE_SCHEME_KERBEROS
:
u32
=
8u32
...
pub
const
WINHTTP_PROXY_DISABLE_SCHEME_NEGOTIATE
:
u32
=
16u32
...
pub
const
WINHTTP_PROXY_DISABLE_SCHEME_NTLM
:
u32
=
4u32
...
from_u128
(
0x2087c2f4_2cef_4953_a8ab_66779b670495
)
;
pub
type
...
pub
const
WinHttpSecureDnsSettingDefault
:
WINHTTP_SECURE_DNS_SETTING
=
0i32
...
pub
const
WinHttpSecureDnsSettingForcePlaintext
:
WINHTTP_SECURE_DNS_SETTING
=
1i32
...
pub
const
WinHttpSecureDnsSettingRequireEncryption
:
WINHTTP_SECURE_DNS_SETTING
=
2i32
...
pub
const
WinHttpSecureDnsSettingTryEncryptionWithFallback
:
WINHTTP_SECURE_DNS_SETTING
=
3i32
