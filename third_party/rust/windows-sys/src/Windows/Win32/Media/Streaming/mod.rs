...
from_u128
(
0x88ad39db_0d0c_4a38_8435_4043826b5c91
)
pid
:
16
...
pub
const
DEVPKEY_Device_PacketWakeSupported
:
super
:
:
...
pub
const
DEVPKEY_Device_SendPacketWakeSupported
:
super
:
:
...
pub
const
DEVPKEY_Device_SinkProtocolInfo
:
super
:
:
...
pub
const
DEVPKEY_Device_SupportsSetNextAVT
:
super
:
:
...
from_u128
(
0x25b4e268_2a05_496e_803b_266837fbda4b
)
;
pub
const
...
from_u128
(
0xd0875fb4_2196_4c7a_a63d_e416addd60a1
)
;
pub
const
...
from_u128
(
0xc96037ae_a558_4470_b432_115a31b85553
)
;
#
[
