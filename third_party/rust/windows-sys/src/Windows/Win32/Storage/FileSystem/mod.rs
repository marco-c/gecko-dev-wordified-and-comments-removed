...
MaximumSize
:
CLFS_MGMT_POLICY_0_0
pub
MinimumSize
:
CLFS_MGMT_POLICY_0_1
pub
NewContainerSize
:
CLFS_MGMT_POLICY_0_2
pub
GrowthRate
:
CLFS_MGMT_POLICY_0_3
pub
LogTail
:
...
AutoShrink
:
CLFS_MGMT_POLICY_0_5
pub
AutoGrow
:
CLFS_MGMT_POLICY_0_6
pub
NewContainerPrefix
:
CLFS_MGMT_POLICY_0_7
pub
NewContainerSuffix
:
CLFS_MGMT_POLICY_0_8
pub
NewContainerExtension
:
CLFS_MGMT_POLICY_0_9
}
impl
Default
for
...
from_u128
(
0x7988b571_ec89_11cf_9c00_00aa00a14f56
)
;
#
[
...
ChunkStarted
:
COPYFILE2_MESSAGE_0_0
pub
ChunkFinished
:
COPYFILE2_MESSAGE_0_1
pub
StreamStarted
:
COPYFILE2_MESSAGE_0_2
pub
StreamFinished
:
COPYFILE2_MESSAGE_0_3
pub
PollContinue
:
COPYFILE2_MESSAGE_0_4
pub
Error
:
COPYFILE2_MESSAGE_0_5
}
impl
Default
for
...
Anonymous
:
FILE_NOTIFY_EXTENDED_INFORMATION_0
pub
FileId
:
i64
...
GenericReserved
:
FILE_REMOTE_PROTOCOL_INFO_0
pub
ProtocolSpecific
:
FILE_REMOTE_PROTOCOL_INFO_1
}
impl
Default
for
...
Server
:
FILE_REMOTE_PROTOCOL_INFO_1_0_0
pub
Share
:
FILE_REMOTE_PROTOCOL_INFO_1_0_1
}
#
[
repr
...
from_u128
(
0xebd0a0a2_b9e5_4433_87c0_68b6b72699c7
)
;
pub
const
...
from_u128
(
0x57434f53_4df9_45b9_8e9e_2370f006457c
)
;
pub
const
...
from_u128
(
0xdb97dba9_0840_4bae_97f0_ffb9a327c7e1
)
;
pub
const
...
from_u128
(
0x57434f53_94cb_43f0_a533_d73c10cfa57d
)
;
pub
const
...
from_u128
(
0xaf9b60a0_1431_4f62_bc68_3311714a69ad
)
;
pub
const
...
from_u128
(
0x5808c8aa_7e8f_42e0_85d2_e1e90434cfb3
)
;
pub
const
...
from_u128
(
0x424ca0e2_7cb2_4fb9_8143_c52a99398bc6
)
;
pub
const
...
from_u128
(
0x424c3e6c_d79f_49cb_935d_36d71467a288
)
;
pub
const
...
from_u128
(
0x57434f53_8f45_405e_8a23_186d8a4330d3
)
;
pub
const
...
from_u128
(
0xde94bba4_06d1_4d40_a16a_bfd50179d6ac
)
;
pub
const
...
from_u128
(
0xe3c9e316_0b5c_4db8_817d_f92df00215ae
)
;
pub
const
...
from_u128
(
0xcaddebf1_4400_4de8_b103_12117dcf3ccf
)
;
pub
const
...
from_u128
(
0x57434f53_23f2_44d5_a830_67bbdaa609f9
)
;
pub
const
...
from_u128
(
0x8967a686_96aa_6aa8_9589_a84256541090
)
;
pub
const
...
from_u128
(
0x57434f53_7fe0_4196_9b42_427b51643484
)
;
pub
const
PARTITION_SBL_CACHE_HDD_GUID
:
windows_sys
:
:
...
from_u128
(
0x03aaa829_ebfc_4e7e_aac9_c4d76c63b24b
)
;
pub
const
PARTITION_SBL_CACHE_SSD_GUID
:
windows_sys
:
:
...
from_u128
(
0xeeff8352_dd2a_44db_ae83_bee1cf7481dc
)
;
pub
const
PARTITION_SBL_CACHE_SSD_RESERVED_GUID
:
windows_sys
:
:
...
from_u128
(
0xdcc0c7c1_55ad_4f17_9d43_4bc776e0117e
)
;
pub
const
...
from_u128
(
0x57434f53_432e_4014_ae4c_8deaa9c0006a
)
;
pub
const
...
from_u128
(
0x57434f53_c691_4a05_bb4e_703dafd229ce
)
;
pub
const
...
from_u128
(
0x57434f53_4b81_460b_a319_ffb6fe136d14
)
;
pub
const
...
from_u128
(
0x57434f53_e84d_4e84_aaf3_ecbbbd04b9df
)
;
pub
const
...
from_u128
(
0xe7addcb4_dc34_4539_9a76_ebbd07be6f7e
)
;
pub
const
...
from_u128
(
0xe75caf8f_f680_4cee_afa3_b001e56efc2d
)
;
pub
const
...
from_u128
(
0xc12a7328_f81f_11d2_ba4b_00a0c93ec93b
)
;
pub
const
...
from_u128
(
0x57434f53_e3e3_4631_a5c5_26d2243873aa
)
;
pub
type
