...
from_u128
(
0x5e9adaef_f879_473f_b807_4e5ea77d1b1c
)
;
pub
const
...
from_u128
(
0x3abf6f2d_71c4_462a_8a92_1e6861e6af27
)
;
pub
const
...
from_u128
(
0xf18a0e88_c30c_11d0_8815_00a0c906bed8
)
;
pub
const
...
from_u128
(
0xd8dd60df_4589_4cc7_9cd2_659d9e648a9f
)
;
pub
const
...
from_u128
(
0xd5de77a6_6ae9_425c_b1e2_f5615fd348a9
)
;
pub
const
...
from_u128
(
0x681eb8aa_403d_452c_9f8a_f0616fac9540
)
;
pub
const
...
from_u128
(
0x66c1aa3c_499f_49a0_a9a5_61e2359f6407
)
;
pub
const
...
from_u128
(
0x9c179357_dc7a_4f41_b66b_323b9ddcb5b1
)
;
pub
const
...
from_u128
(
0x4e623b20_cb14_11d1_b331_00a0c959bbd2
)
;
pub
const
...
from_u128
(
0x9bbbf831_a2f2_43b4_96d1_86944b5914b3
)
;
pub
const
...
from_u128
(
0x3a61881b_b4e6_4bf9_ae0f_3cd8f394e52f
)
;
pub
const
...
Anonymous
:
USB_DEVICE_CAPABILITY_BILLBOARD_DESCRIPTOR_0_0
}
impl
Default
for
...
from_u128
(
0xda812bff_12c3_46a2_8e2b_dbd3b7834c43
)
;
#
[
