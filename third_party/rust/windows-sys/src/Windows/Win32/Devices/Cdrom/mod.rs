...
Anonymous
:
CDROM_TOC_CD_TEXT_DATA_BLOCK_0
pub
CRC
:
[
...
pub
const
MediaBlankTypeEraseLastSession
:
MEDIA_BLANK_TYPE
=
6i32
...
pub
const
MediaBlankTypeUncloseLastSession
:
MEDIA_BLANK_TYPE
=
5i32
...
pub
const
MediaBlankTypeUnreserveLastTrack
:
MEDIA_BLANK_TYPE
=
3i32
