...
pub
const
BCRYPT_COPY_AFTER_PADDING_CHECK_FAILURE_FLAG
:
u32
=
256u32
...
CreateMultiHash
:
BCryptCreateMultiHashFn
pub
ProcessMultiOperations
:
BCryptProcessMultiOperationsFn
}
pub
type
BCRYPT_HASH_HANDLE
...
pub
const
CARD_AUTHENTICATE_CURRENT_VERSION
:
u32
=
7u32
...
pub
const
CARD_AUTHENTICATE_RESPONSE_CURRENT_VERSION
:
u32
=
7u32
...
pub
const
CARD_CACHE_FILE_CURRENT_VERSION
:
u32
=
1u32
...
:
PFN_CARD_DELETE_CONTAINER
pub
pfnCardCreateContainer
:
PFN_CARD_CREATE_CONTAINER
pub
...
:
PFN_CARD_AUTHENTICATE_PIN
pub
pfnCardGetChallenge
:
PFN_CARD_GET_CHALLENGE
pub
pfnCardAuthenticateChallenge
:
PFN_CARD_AUTHENTICATE_CHALLENGE
pub
pfnCardUnblockPin
:
PFN_CARD_UNBLOCK_PIN
pub
...
:
PFN_CARD_DEAUTHENTICATE
pub
pfnCardCreateDirectory
:
PFN_CARD_CREATE_DIRECTORY
pub
pfnCardDeleteDirectory
:
PFN_CARD_DELETE_DIRECTORY
pub
pvUnused3
:
*
...
:
PFN_CARD_CONSTRUCT_DH_AGREEMENT
pub
pfnCardDeriveKey
:
PFN_CARD_DERIVE_KEY
...
:
PFN_CARD_DESTROY_DH_AGREEMENT
pub
pfnCspGetDHAgreement
:
PFN_CSP_GET_DH_AGREEMENT
pub
pfnCardGetChallengeEx
:
PFN_CARD_GET_CHALLENGE_EX
pub
...
pfnCardGetProperty
:
PFN_CARD_GET_PROPERTY
pub
pfnCardSetProperty
:
PFN_CARD_SET_PROPERTY
pub
pfnCspUnpadData
:
PFN_CSP_UNPAD_DATA
...
:
PFN_CARD_GET_KEY_PROPERTY
pub
pfnCardSetKeyProperty
:
PFN_CARD_SET_KEY_PROPERTY
pub
pfnCardDestroyKey
:
PFN_CARD_DESTROY_KEY
pub
...
pub
const
CARD_DERIVE_KEY_CURRENT_VERSION
:
u32
=
2u32
...
pub
const
CARD_DH_AGREEMENT_INFO_VERSION
:
u32
=
2u32
...
pub
const
CARD_FILE_INFO_CURRENT_VERSION
:
u32
=
1u32
...
pub
const
CARD_IMPORT_KEYPAIR_CURRENT_VERSION
:
u32
=
7u32
...
pub
const
CARD_IMPORT_KEYPAIR_VERSION_SEVEN
:
u32
=
7u32
...
pub
const
CARD_KEY_IMPORT_SHARED_SYMMETRIC
:
u32
=
8u32
...
pub
const
CARD_KEY_SIZES_CURRENT_VERSION
:
u32
=
1u32
...
pub
const
CARD_RSA_KEY_DECRYPT_INFO_CURRENT_VERSION
:
u32
=
2u32
...
pub
const
CARD_RSA_KEY_DECRYPT_INFO_VERSION_ONE
:
u32
=
1u32
...
pub
const
CARD_SIGNING_INFO_BASIC_VERSION
:
u32
=
1u32
...
pub
const
CARD_SIGNING_INFO_CURRENT_VERSION
:
u32
=
2u32
...
pub
const
CLMD_FILE_TAG_FIRST_RETIRED_KEY_MGMT_KEY
:
u32
=
6275341u32
...
pub
const
CLMD_FILE_TAG_LAST_RETIRED_KEY_MGMT_KEY
:
u32
=
6275360u32
...
pub
const
CLMD_FILE_TAG_PRINTED_INFORMATION
:
u32
=
6275337u32
...
pub
const
CLMD_PIV_CERT_DATA_CURRENT_VERSION
:
u32
=
0u32
...
pub
const
CLMD_PIV_GENERATE_ASYMMETRIC_KEY_CURRENT_VERSION
:
u32
=
0u32
...
pub
const
CLMD_PIV_PUBLIC_KEY_DATA_CURRENT_VERSION
:
u32
=
0u32
...
pub
const
CONTAINER_INFO_CURRENT_VERSION
:
u32
=
1u32
...
pub
const
CP_PIV_CARD_CAPABILITY_CONTAINER
:
windows_sys
:
:
...
pub
const
CRYPT_EXTERNAL_SIGNATURE_LENGTH
:
u32
=
136u32
...
pub
type
GetAsymmetricEncryptionInterfaceFn
=
Option
<
unsafe
...
pub
const
MSCRYPT_ECC_MAX_CURVE_NAME_LENGTH
:
u32
=
255u32
...
SetProviderProperty
:
NCryptSetProviderPropertyFn
pub
SetKeyProperty
:
NCryptSetKeyPropertyFn
pub
FinalizeKey
:
NCryptFinalizeKeyFn
...
IsAlgSupported
:
NCryptIsAlgSupportedFn
pub
EnumAlgorithms
:
NCryptEnumAlgorithmsFn
pub
EnumKeys
:
NCryptEnumKeysFn
...
pub
const
NCRYPT_SSL_CIPHER_LENGTHS_BLOCK_PADDING
:
u32
=
1u32
...
pub
const
NCRYPT_SSL_EAP_TTLSV0_CHLNG_ID
:
u32
=
2u32
...
ExtractHandshakeKey
:
SslExtractHandshakeKeyFn
pub
ExtractMasterKey
:
SslExtractMasterKeyFn
pub
ExpandTrafficKeys
:
...
EnumCipherSuitesEx
:
SslEnumCipherSuitesExFn
pub
ExpandResumptionMasterKey
:
SslExpandResumptionMasterKeyFn
pub
DuplicateTranscriptHash
:
SslDuplicateTranscriptHashFn
pub
ExpandBinderKey
:
SslExpandBinderKeyFn
pub
ExpandPreSharedKey
:
...
pub
const
NCRYPT_SSL_RESUMPTION_PSK_FLAG
:
u32
=
2u32
...
pub
const
NCRYPT_SSL_SIGN_INCLUDE_HASHOID
:
u32
=
1u32
...
pub
const
szUSER_KEYEXCHANGE_CERT_PREFIX
:
windows_sys
:
:
...
pub
const
szUSER_KEYEXCHANGE_PRIVATE_KEY_PREFIX
:
windows_sys
:
:
...
pub
const
szUSER_KEYEXCHANGE_PUBLIC_KEY_PREFIX
:
windows_sys
:
:
...
pub
const
szUSER_SIGNATURE_PRIVATE_KEY_PREFIX
:
windows_sys
:
:
...
pub
const
szUSER_SIGNATURE_PUBLIC_KEY_PREFIX
:
windows_sys
:
:
