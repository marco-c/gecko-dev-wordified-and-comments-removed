...
pub
const
CO_SEND_FLAG_SET_DISCARD_ELIBILITY
:
u32
=
1u32
...
pub
const
IPSEC_OFFLOAD_V2_MAX_EXTENSION_HEADERS
:
u32
=
2u32
...
pub
const
NDIS_ATTRIBUTE_MINIPORT_PADS_SHORT_PACKETS
:
u32
=
2048u32
...
pub
const
NDIS_BIND_FAILED_NOTIFICATION_REVISION_1
:
u32
=
1u32
...
ParameterData
:
NDIS_CONFIGURATION_PARAMETER_0
}
impl
Default
for
...
pub
const
NDIS_CO_CALL_MANAGER_OPTIONAL_HANDLERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_CO_CLIENT_OPTIONAL_HANDLERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_FILTER_DRIVER_SUPPORTS_CURRENT_MAC_ADDRESS_CHANGE
:
u32
=
2u32
...
pub
const
NDIS_FILTER_INTERFACE_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_FILTER_INTERFACE_REVISION_2
:
u32
=
2u32
...
pub
const
NDIS_FILTER_MINIMUM_MAJOR_VERSION
:
u32
=
6u32
...
pub
const
NDIS_FILTER_MINIMUM_MINOR_VERSION
:
u32
=
0u32
...
pub
const
NDIS_FILTER_PAUSE_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_GFT_OFFLOAD_INFO_COPY_PACKET
:
u32
=
4u32
...
pub
const
NDIS_GFT_OFFLOAD_INFO_DIRECTION_INGRESS
:
u32
=
1u32
...
pub
const
NDIS_GFT_OFFLOAD_INFO_EXCEPTION_PACKET
:
u32
=
2u32
...
pub
const
NDIS_GFT_OFFLOAD_INFO_SAMPLE_PACKET
:
u32
=
8u32
...
pub
const
NDIS_IPSEC_OFFLOAD_V2_ADD_SA_EX_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_IPSEC_OFFLOAD_V2_ADD_SA_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_IPSEC_OFFLOAD_V2_DELETE_SA_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_IPSEC_OFFLOAD_V2_UPDATE_SA_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_KDNET_ENUMERATE_PFS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_KDNET_PF_ENUM_ELEMENT_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_KDNET_QUERY_PF_INFORMATION_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_KDNET_REMOVE_PF_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_LARGE_SEND_OFFLOAD_MAX_HEADER_LENGTH
:
u32
=
128u32
...
pub
const
NDIS_MAX_LOOKAHEAD_SIZE_ACCESSED_UNDEFINED
:
i32
=
-
...
pub
const
NDIS_MEDIA_SPECIFIC_INFO_EAPOL
:
u32
=
2147549185u32
...
pub
const
NDIS_MEDIA_SPECIFIC_INFO_TIMESYNC
:
u32
=
2147549187u32
...
pub
const
NDIS_MEDIA_SPECIFIC_INFO_TUNDL
:
u32
=
65537u32
...
pub
const
NDIS_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES_REVISION_4
:
u32
=
4u32
...
pub
const
NDIS_MINIPORT_ADAPTER_NDK_ATTRIBUTES_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_MINIPORT_ADAPTER_PACKET_DIRECT_ATTRIBUTES_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_MINIPORT_CO_CHARACTERISTICS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_MINIPORT_MINIMUM_MAJOR_VERSION
:
u32
=
5u32
...
pub
const
NDIS_MINIPORT_RESTART_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_MONITOR_CONFIG_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_OBJECT_TYPE_DRIVER_WRAPPER_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_OID_REQUEST_NDIS_RESERVED_SIZE
:
u32
=
16u32
...
pub
const
NDIS_OID_REQUEST_TIMEOUT_INFINITE
:
u32
=
0u32
...
pub
const
NDIS_OPEN_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_ACQUIRE_QUEUES_FLAG_DRAIN_NOTIFICATION
:
u32
=
1u32
...
pub
const
NDIS_PD_ACQUIRE_QUEUES_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_CLOSE_PROVIDER_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_COUNTER_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_FILTER_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_OPEN_PROVIDER_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_PROVIDER_DISPATCH_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_QUEUE_DISPATCH_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PD_QUEUE_FLAG_DRAIN_NOTIFICATION
:
u32
=
1u32
...
pub
const
NDIS_PD_QUEUE_PARAMETERS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_POLL_CHARACTERISTICS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_POLL_NOTIFICATION_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PROTOCOL_CO_CHARACTERISTICS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_PROTOCOL_DRIVER_SUPPORTS_CURRENT_MAC_ADDRESS_CHANGE
:
u32
=
2u32
...
pub
const
NDIS_PROTOCOL_MINIMUM_MAJOR_VERSION
:
u32
=
4u32
...
pub
const
NDIS_PROTOCOL_MINIMUM_MINOR_VERSION
:
u32
=
0u32
...
pub
const
NDIS_RECEIVE_FILTER_QUEUE_STATE_CHANGE_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_RECEIVE_QUEUE_STATE_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_RESTART_GENERAL_ATTRIBUTES_MAX_LOOKAHEAD_ACCESSED_DEFINED
:
u32
=
1u32
...
pub
const
NDIS_SG_DMA_DESCRIPTION_REVISION_2
:
u32
=
2u32
...
pub
const
NDIS_SHARED_MEMORY_PROVIDER_CHARACTERISTICS_REVISION_1
:
u32
=
1u32
...
pub
const
NDIS_SHARED_MEMORY_PROVIDER_CHAR_SUPPORTS_PF_VPORTS
:
u32
=
1u32
...
pub
const
NDIS_SHARED_MEM_PARAMETERS_CONTIGUOUS
:
u32
=
1u32
...
pub
const
NDIS_STATUS_INDICATION_FLAGS_MEDIA_CONNECT_TO_CONNECT
:
u32
=
4096u32
...
pub
const
NDIS_STATUS_INDICATION_FLAGS_NDIS_RESERVED
:
u32
=
4095u32
...
pub
const
NDIS_SWITCH_COPY_NBL_INFO_FLAGS_PRESERVE_SWITCH_INFO_ONLY
:
u32
=
2u32
...
pub
const
NDIS_SWITCH_OPTIONAL_HANDLERS_PD_RESERVED_SIZE
:
u32
=
14u32
...
pub
const
NDIS_SWITCH_OPTIONAL_HANDLERS_REVISION_2
:
u32
=
2u32
...
Anonymous
:
NDIS_TCP_IP_CHECKSUM_PACKET_INFO_0
}
impl
Default
for
...
Transmit
:
NDIS_TCP_IP_CHECKSUM_PACKET_INFO_0_0
pub
Receive
:
NDIS_TCP_IP_CHECKSUM_PACKET_INFO_0_1
pub
Value
:
u32
...
pub
const
NDIS_UDP_SEGMENTATION_OFFLOAD_IPV4
:
u32
=
0u32
...
pub
const
NDIS_UDP_SEGMENTATION_OFFLOAD_IPV6
:
u32
=
1u32
...
pub
const
NET_BUFFER_LIST_POOL_FLAG_VERIFY
:
u32
=
1u32
...
pub
const
NET_BUFFER_LIST_POOL_PARAMETERS_REVISION_2
:
u32
=
2u32
...
pub
const
NET_BUFFER_POOL_PARAMETERS_REVISION_2
:
u32
=
2u32
...
pub
const
NET_DEVICE_PNP_EVENT_REVISION_1
:
u32
=
1u32
...
pub
const
NET_EVENT_FLAGS_VPORT_ID_VALID
:
u32
=
2u32
...
pub
const
NET_EVENT_HALT_MINIPORT_ON_LOW_POWER
:
u32
=
1u32
...
pub
const
PD_BUFFER_ATTR_BUILT_IN_DATA_BUFFER
:
u32
=
1u32
...
pub
const
PD_BUFFER_FLAG_PARTIAL_PACKET_HEAD
:
u32
=
1u32
...
pub
const
PD_BUFFER_MIN_RX_DATA_START_ALIGNMENT
:
u32
=
2u32
...
pub
const
PD_BUFFER_MIN_RX_DATA_START_VALUE
:
u32
=
32u32
...
pub
const
PD_BUFFER_MIN_TX_DATA_START_ALIGNMENT
:
u32
=
2u32
