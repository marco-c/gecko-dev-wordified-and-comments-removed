...
from_u128
(
0x8650c9fe_0cec_8bf6_bd1e_835956541090
)
;
pub
const
...
from_u128
(
0x940e5d56_1646_4d3c_87b6_577ec36a1466
)
;
pub
const
...
from_u128
(
0x323eb6a8_affd_4d95_8230_863bce09d37a
)
;
#
[
...
GenericReserved
:
FILE_REMOTE_PROTOCOL_INFORMATION_0
pub
ProtocolSpecific
:
FILE_REMOTE_PROTOCOL_INFORMATION_1
}
impl
Default
for
...
Smb2
:
FILE_REMOTE_PROTOCOL_INFORMATION_1_0
pub
Reserved
:
[
...
Server
:
FILE_REMOTE_PROTOCOL_INFORMATION_1_0_0
pub
Share
:
FILE_REMOTE_PROTOCOL_INFORMATION_1_0_1
}
#
[
repr
...
pub
const
FSCTL_PIPE_QUERY_CLIENT_PROCESS_V2
:
u32
=
1114196u32
...
Anonymous1
:
FSRTL_UNC_PROVIDER_REGISTRATION_0
pub
Anonymous2
:
FSRTL_UNC_PROVIDER_REGISTRATION_1
}
impl
Default
for
...
Anonymous
:
FSRTL_UNC_PROVIDER_REGISTRATION_0_0
}
impl
Default
for
...
Anonymous
:
FSRTL_UNC_PROVIDER_REGISTRATION_1_0
}
impl
Default
for
...
:
FS_FILTER_PARAMETERS_0
pub
ReleaseForModifiedPageWriter
:
FS_FILTER_PARAMETERS_1
pub
AcquireForSectionSynchronization
:
FS_FILTER_PARAMETERS_2
pub
QueryOpen
:
FS_FILTER_PARAMETERS_3
pub
Others
:
FS_FILTER_PARAMETERS_4
}
#
[
cfg
...
from_u128
(
0x4720bd83_52ac_4104_a130_d1ec6a8cc8e5
)
;
pub
const
...
from_u128
(
0x2932ff52_8378_4fc1_8edb_6bdc8f602709
)
;
pub
const
...
from_u128
(
0x188d6bd6_a126_4fa8_bdf2_1ccdf896f3e0
)
;
pub
const
...
from_u128
(
0x4248be44_647f_488f_8be5_a08aaf70f028
)
;
pub
const
...
from_u128
(
0x44aec90b_de65_4d46_8fbf_763f9d970b1d
)
;
pub
const
...
from_u128
(
0x7a3a4aa1_aa74_4bc6_b070_ab56a38c1fed
)
;
pub
const
...
from_u128
(
0x7a9fdd94_7b58_42bb_9740_3cb86983a615
)
;
pub
const
...
from_u128
(
0x41621a14_b08b_4df1_b676_a05ffdf01bea
)
;
pub
const
...
from_u128
(
0xf315b732_ac6b_4d4d_be0c_b3126490e1a3
)
;
pub
const
...
from_u128
(
0x6aa6bc45_a7ef_4af7_9008_fa462e144d74
)
;
pub
const
...
from_u128
(
0xb7d082b9_563b_4f07_a07b_524a8116a010
)
;
pub
const
...
from_u128
(
0xc584edbf_00df_4d28_b884_35baca8911e8
)
;
pub
const
...
from_u128
(
0xf326d30c_e5f8_4fe7_ab74_f5a3196d92db
)
;
pub
const
...
from_u128
(
0xcd0a93c3_3bb7_463d_accb_969d3435a5a5
)
;
pub
const
...
from_u128
(
0x48850596_3050_4be7_9863_fec350ce8d7f
)
;
pub
const
...
from_u128
(
0xe1777b21_847e_4837_aa45_64161d280655
)
;
pub
const
...
from_u128
(
0x1aca62e9_abb4_4ff2_bb5c_1c79025e417f
)
;
pub
const
...
from_u128
(
0x02378cc6_f73c_489c_8282_564d1a99131b
)
;
pub
const
...
from_u128
(
0xbebfaebc_aabf_489d_9d2c_e9e361102853
)
;
pub
const
...
Out
:
IO_STOP_ON_SYMLINK_FILTER_ECP_v0_0
}
#
[
repr
...
in
:
NETWORK_OPEN_ECP_CONTEXT_0_0
pub
out
:
NETWORK_OPEN_ECP_CONTEXT_0_1
}
#
[
repr
...
in
:
NETWORK_OPEN_ECP_CONTEXT_V0_0_0
pub
out
:
NETWORK_OPEN_ECP_CONTEXT_V0_0_1
}
#
[
repr
...
pub
const
REFS_COMPRESSION_FORMAT_UNCOMPRESSED
:
REFS_COMPRESSION_FORMATS
=
0i32
...
pub
struct
REFS_QUERY_VOLUME_DEDUP_INFO_OUTPUT_BUFFER
{
pub
Enabled
:
...
pub
const
REFS_SET_VOLUME_COMPRESSION_INFO_FLAG_COMPRESS_SYNC
:
REFS_SET_VOLUME_COMPRESSION_INFO_FLAGS
=
1i32
...
pub
const
REFS_SET_VOLUME_COMPRESSION_INFO_FLAG_MAX
:
REFS_SET_VOLUME_COMPRESSION_INFO_FLAGS
=
1i32
...
pub
struct
REFS_SET_VOLUME_DEDUP_INFO_INPUT_BUFFER
{
pub
Enable
:
...
:
REPARSE_DATA_BUFFER_0_0
pub
MountPointReparseBuffer
:
REPARSE_DATA_BUFFER_0_1
pub
GenericReparseBuffer
:
REPARSE_DATA_BUFFER_0_2
}
impl
Default
for
...
Anonymous
:
RTL_SEGMENT_HEAP_MEMORY_SOURCE_0
pub
Reserved
:
[
