...
pub
type
PSYSTEM_QUERY_TIME_ADJUST_INFORMATION_PRECISE
=
*
mut
SYSTEM_QUERY_TIME_ADJUST_INFORMATION_PRECISE
...
pub
type
PSYSTEM_SET_TIME_ADJUST_INFORMATION_PRECISE
=
*
mut
SYSTEM_SET_TIME_ADJUST_INFORMATION_PRECISE
...
pub
type
PEVENT_TRACE_VERSION_INFORMATION
=
*
mut
EVENT_TRACE_VERSION_INFORMATION
...
pub
type
PEVENT_TRACE_GROUPMASK_INFORMATION
=
*
mut
EVENT_TRACE_GROUPMASK_INFORMATION
...
pub
type
PEVENT_TRACE_PERFORMANCE_INFORMATION
=
*
mut
EVENT_TRACE_PERFORMANCE_INFORMATION
...
pub
type
PEVENT_TRACE_TIME_PROFILE_INFORMATION
=
*
mut
EVENT_TRACE_TIME_PROFILE_INFORMATION
...
pub
type
PEVENT_TRACE_SPINLOCK_INFORMATION
=
*
mut
EVENT_TRACE_SPINLOCK_INFORMATION
...
pub
type
PEVENT_TRACE_SYSTEM_EVENT_INFORMATION
=
*
mut
EVENT_TRACE_SYSTEM_EVENT_INFORMATION
...
:
ULONG
ContentionSamplingRate
:
ULONG
NumberOfExcessiveTimeouts
:
ULONG
}
}
pub
type
PEVENT_TRACE_EXECUTIVE_RESOURCE_INFORMATION
=
*
mut
EVENT_TRACE_EXECUTIVE_RESOURCE_INFORMATION
...
pub
type
PEVENT_TRACE_HEAP_TRACING_INFORMATION
=
*
mut
EVENT_TRACE_HEAP_TRACING_INFORMATION
...
pub
type
PEVENT_TRACE_TAG_FILTER_INFORMATION
=
*
mut
EVENT_TRACE_TAG_FILTER_INFORMATION
...
pub
type
PEVENT_TRACE_PROFILE_COUNTER_INFORMATION
=
*
mut
EVENT_TRACE_PROFILE_COUNTER_INFORMATION
...
pub
type
PEVENT_TRACE_PROFILE_LIST_INFORMATION
=
*
mut
EVENT_TRACE_PROFILE_LIST_INFORMATION
...
pub
type
PEVENT_TRACE_STACK_CACHING_INFORMATION
=
*
mut
EVENT_TRACE_STACK_CACHING_INFORMATION
...
pub
type
PEVENT_TRACE_SOFT_RESTART_INFORMATION
=
*
mut
EVENT_TRACE_SOFT_RESTART_INFORMATION
...
pub
type
PEVENT_TRACE_PROFILE_ADD_INFORMATION
=
*
mut
EVENT_TRACE_PROFILE_ADD_INFORMATION
...
pub
type
PEVENT_TRACE_PROFILE_REMOVE_INFORMATION
=
*
mut
EVENT_TRACE_PROFILE_REMOVE_INFORMATION
...
:
EVENT_TRACE_INFORMATION_CLASS
CoverageSamplerInformationClass
:
BOOLEAN
MajorVersion
:
...
pub
type
PEVENT_TRACE_COVERAGE_SAMPLER_INFORMATION
=
*
mut
EVENT_TRACE_COVERAGE_SAMPLER_INFORMATION
...
:
UCHAR
ThermalLimitFrequency
:
UCHAR
ConstantThrottleFrequency
:
UCHAR
DegradedThrottleFrequency
:
UCHAR
LastBusyFrequency
:
...
:
SIZE_T
NumberOfBytesAvailableContiguous
:
SIZE_T
}
}
...
:
UNICODE_STRING
IrpCancelTimeoutMsec
:
ULONG
VerifierExtensionEnabled
:
ULONG
Reserved
:
...
pub
type
PSYSTEM_VERIFIER_INFORMATION_EX
=
*
mut
SYSTEM_VERIFIER_INFORMATION_EX
...
pub
type
PSYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT_WIN8
=
*
mut
SYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT_WIN8
...
{
LowPriReadOperations
:
ULONG
LowPriWriteOperations
:
ULONG
KernelBumpedToNormalOperations
:
ULONG
LowPriPagingReadOperations
:
ULONG
KernelPagingReadsBumpedToNormal
:
ULONG
LowPriPagingWriteOperations
:
ULONG
KernelPagingWritesBumpedToNormal
:
ULONG
BoostedIrpCount
:
...
:
SIZE_T
PeakMappedLockedBytes
:
SIZE_T
MappedIoSpaceBytes
:
SIZE_T
PeakMappedIoSpaceBytes
:
SIZE_T
PagesForMdlBytes
:
SIZE_T
PeakPagesForMdlBytes
:
SIZE_T
ContiguousMemoryBytes
:
SIZE_T
PeakContiguousMemoryBytes
:
SIZE_T
ExecutePoolTypes
:
ULONG
ExecutePageProtections
:
ULONG
ExecutePageMappings
:
ULONG
ExecuteWriteSections
:
ULONG
SectionAlignmentFailures
:
ULONG
UnsupportedRelocs
:
...
pub
type
PSYSTEM_BOOT_GRAPHICS_INFORMATION
=
*
mut
SYSTEM_BOOT_GRAPHICS_INFORMATION
...
pub
type
PSYSTEM_PROCESSOR_PROFILE_CONTROL_AREA
=
*
mut
SYSTEM_PROCESSOR_PROFILE_CONTROL_AREA
...
pub
const
MEMORY_COMBINE_FLAGS_COMMON_PAGES_ONLY
:
ULONG
=
0x4
...
pub
type
PMEMORY_COMBINE_INFORMATION_EX
=
*
mut
MEMORY_COMBINE_INFORMATION_EX
...
pub
type
PMEMORY_COMBINE_INFORMATION_EX2
=
*
mut
MEMORY_COMBINE_INFORMATION_EX2
...
pub
type
PSYSTEM_PLATFORM_BINARY_INFORMATION
=
*
mut
SYSTEM_PLATFORM_BINARY_INFORMATION
...
pub
type
PSYSTEM_HYPERVISOR_PROCESSOR_COUNT_INFORMATION
=
*
mut
SYSTEM_HYPERVISOR_PROCESSOR_COUNT_INFORMATION
...
pub
type
PSYSTEM_DEVICE_DATA_INFORMATION
=
*
mut
SYSTEM_DEVICE_DATA_INFORMATION
...
pub
type
PSYSTEM_MEMORY_TOPOLOGY_INFORMATION
=
*
mut
SYSTEM_MEMORY_TOPOLOGY_INFORMATION
...
pub
type
PSYSTEM_MEMORY_CHANNEL_INFORMATION
=
*
mut
SYSTEM_MEMORY_CHANNEL_INFORMATION
...
pub
type
PSYSTEM_SECUREBOOT_POLICY_INFORMATION
=
*
mut
SYSTEM_SECUREBOOT_POLICY_INFORMATION
...
pub
type
PSYSTEM_SECUREBOOT_INFORMATION
=
*
mut
SYSTEM_SECUREBOOT_INFORMATION
...
:
ENERGY_STATE_DURATION
DesktopVisibleDuration
:
ENERGY_STATE_DURATION
PSMForegroundDuration
:
ENERGY_STATE_DURATION
CompositionRendered
:
...
{
struct
PROCESS_ENERGY_VALUES_EXTENSION_Timelines
{
CpuTimeline
:
TIMELINE_BITMAP
...
:
TIMELINE_BITMAP
CompositionRenderedTimeline
:
TIMELINE_BITMAP
CompositionDirtyGeneratedTimeline
:
TIMELINE_BITMAP
CompositionDirtyPropagatedTimeline
:
TIMELINE_BITMAP
InputTimeline
:
...
{
struct
PROCESS_ENERGY_VALUES_EXTENSION_Durations
{
InputDuration
:
ENERGY_STATE_DURATION
...
:
ENERGY_STATE_DURATION
DisplayRequiredDuration
:
ENERGY_STATE_DURATION
PSMBackgroundDuration
:
ENERGY_STATE_DURATION
}
}
...
pub
type
PPROCESS_EXTENDED_ENERGY_VALUES
=
*
mut
PROCESS_EXTENDED_ENERGY_VALUES
...
set_BackgroundActivityModerated
[
5
.
.
...
{
DmaProtectionsAvailable
:
BOOLEAN
DmaProtectionsInUse
:
BOOLEAN
HardwareMbecAvailable
:
BOOLEAN
}
}
pub
type
PSYSTEM_VSM_PROTECTION_INFORMATION
=
*
mut
SYSTEM_VSM_PROTECTION_INFORMATION
...
pub
type
PSYSTEM_INTERRUPT_CPU_SET_INFORMATION
=
*
mut
SYSTEM_INTERRUPT_CPU_SET_INFORMATION
...
pub
type
PSYSTEM_SECUREBOOT_POLICY_FULL_INFORMATION
=
*
mut
SYSTEM_SECUREBOOT_POLICY_FULL_INFORMATION
...
pub
type
PSYSTEM_SECUREBOOT_PLATFORM_MANIFEST_INFORMATION
=
*
mut
SYSTEM_SECUREBOOT_PLATFORM_MANIFEST_INFORMATION
...
:
ULONGLONG
ResidentAvailableBytes
:
LONGLONG
CommittedBytes
:
ULONGLONG
SharedCommittedBytes
:
ULONGLONG
CommitLimitBytes
:
...
pub
type
PSYSTEM_PHYSICAL_MEMORY_INFORMATION
=
*
mut
SYSTEM_PHYSICAL_MEMORY_INFORMATION
...
:
ULONG
ProcessorCacheFlushSize
:
ULONG
SystemFlushCapabilities
:
ULONGLONG
Reserved
:
...
KvaShadowRequiredAvailable
set_KvaShadowRequiredAvailable
[
5
.
.
...
L1DataCacheFlushSupported
set_L1DataCacheFlushSupported
[
12
.
.
...
L1TerminalFaultMitigationPresent
...
pub
type
PSYSTEM_CODEINTEGRITYVERIFICATION_INFORMATION
=
*
mut
SYSTEM_CODEINTEGRITYVERIFICATION_INFORMATION
...
pub
type
PSYSTEM_HYPERVISOR_SHARED_PAGE_INFORMATION
=
*
mut
SYSTEM_HYPERVISOR_SHARED_PAGE_INFORMATION
...
set_BpbDisabledNoHardwareSupport
[
2
.
.
...
SpeculativeStoreBypassDisableAvailable
...
SpeculativeStoreBypassDisableSupported
set_SpeculativeStoreBypassDisableSupported
[
9
.
.
...
SpeculativeStoreBypassDisabledSystemWide
...
SpeculativeStoreBypassDisabledKernel
set_SpeculativeStoreBypassDisabledKernel
[
11
.
.
...
set_SpeculativeStoreBypassDisableRequired
[
12
.
.
...
BpbDisabledKernelToUser
set_BpbDisabledKernelToUser
[
13
.
.
...
SpecCtrlRetpolineEnabled
set_SpecCtrlRetpolineEnabled
[
14
.
.
...
SpecCtrlImportOptimizationEnabled
set_SpecCtrlImportOptimizationEnabled
[
15
.
.
...
pub
type
PSYSTEM_DMA_GUARD_POLICY_INFORMATION
=
*
mut
SYSTEM_DMA_GUARD_POLICY_INFORMATION
...
pub
type
PSYSTEM_ENCLAVE_LAUNCH_CONTROL_INFORMATION
=
*
mut
SYSTEM_ENCLAVE_LAUNCH_CONTROL_INFORMATION
...
pub
type
PSYSTEM_WORKLOAD_ALLOWED_CPU_SET_INFORMATION
=
*
mut
SYSTEM_WORKLOAD_ALLOWED_CPU_SET_INFORMATION
...
pub
type
PSYSDBG_LIVEDUMP_CONTROL_FLAGS
=
*
mut
SYSDBG_LIVEDUMP_CONTROL_FLAGS
...
pub
type
PSYSDBG_LIVEDUMP_CONTROL_ADDPAGES
=
*
mut
SYSDBG_LIVEDUMP_CONTROL_ADDPAGES
...
pub
const
SYSDBG_LIVEDUMP_CONTROL_VERSION
:
ULONG
=
1
...
set_CurDirDevicesSkippedForDlls
[
4
.
.
