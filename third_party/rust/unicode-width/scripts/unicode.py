...
SOLIDUS_OVERLAY_ALEF
=
0b0011_1000_1111_1111
...
BUGINESE_VOWEL_SIGN_I_ZWJ_LETTER_YA
=
0b0011_1100_0000_0010
...
ZWJ_TIFINAGH_CONSONANT
=
0b0011_1100_0000_0011
...
LISU_TONE_LETTER_MYA_NA_JEU
=
0b0011_1100_0000_0101
...
OLD_TURKIC_LETTER_ORKHON_I
=
0b0011_1000_0000_0110
...
ZWJ_OLD_TURKIC_LETTER_ORKHON_I
=
0b0011_1100_0000_0110
...
def
load_non_transparent_zero_widths
(
...
def
load_solidus_transparent
(
    
ligature_transparents
:
list
[
tuple
...
def
load_emoji_presentation_sequences
(
)
-
>
...
text_presentation_seq_codepoints
=
set
(
)
...
ret
def
make_presentation_sequence_table
(
...
emoji_presentation_idx
emoji_presentation_leaves
=
emoji_presentation_table
        
text_presentation_idx
...
/
#
def_emoji_presentation_sequence
)
/
/
/
...
/
#
def_text_presentation_sequence
)
/
/
/
