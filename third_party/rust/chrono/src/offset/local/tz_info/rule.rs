...
{
let
previous_year_dst_end_unix_time
=
self
.
dst_end
...
{
let
previous_year_dst_start_unix_time
=
self
.
dst_start
...
;
let
first_week_day_occurrence_in_month
=
1
+
(
