...
fn
assert_last_block_stack_len_exact
(
&
self
len
...
const
DEFAULT_VALIDATING_PARSER_CONFIG
:
ValidatingParserConfig
=
ValidatingParserConfig
...
fn
check_init_expression_operator
(
&
self
operator
