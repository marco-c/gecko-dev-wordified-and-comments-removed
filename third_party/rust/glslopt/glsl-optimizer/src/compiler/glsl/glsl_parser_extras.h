...
{
return
ARB_separate_shader_objects_enable
|
|
is_version
(
...
{
return
EXT_shader_image_load_formatted_enable
;
}
bool
...
;
bool
ARB_ES3_1_compatibility_warn
;
bool
ARB_ES3_2_compatibility_enable
;
bool
ARB_ES3_2_compatibility_warn
;
bool
ARB_arrays_of_arrays_enable
;
bool
ARB_arrays_of_arrays_warn
;
bool
ARB_bindless_texture_enable
;
bool
ARB_bindless_texture_warn
;
bool
ARB_compatibility_enable
;
bool
ARB_compatibility_warn
;
bool
ARB_compute_shader_enable
;
...
;
bool
ARB_compute_variable_group_size_warn
;
bool
...
;
bool
ARB_cull_distance_warn
;
bool
ARB_derivative_control_enable
;
bool
ARB_derivative_control_warn
;
bool
...
;
bool
ARB_draw_instanced_warn
;
bool
ARB_enhanced_layouts_enable
;
bool
ARB_enhanced_layouts_warn
;
bool
ARB_explicit_attrib_location_enable
;
...
;
bool
ARB_explicit_uniform_location_warn
;
bool
...
;
bool
ARB_fragment_layer_viewport_warn
;
bool
...
;
bool
ARB_gpu_shader_fp64_warn
;
bool
ARB_gpu_shader_int64_enable
;
bool
ARB_gpu_shader_int64_warn
;
bool
...
;
bool
ARB_sample_shading_warn
;
bool
ARB_separate_shader_objects_enable
;
bool
ARB_separate_shader_objects_warn
;
bool
ARB_shader_atomic_counter_ops_enable
;
bool
ARB_shader_atomic_counter_ops_warn
;
bool
ARB_shader_atomic_counters_enable
;
bool
ARB_shader_atomic_counters_warn
;
bool
ARB_shader_ballot_enable
;
bool
ARB_shader_ballot_warn
;
bool
ARB_shader_bit_encoding_enable
;
bool
ARB_shader_bit_encoding_warn
;
bool
ARB_shader_clock_enable
;
bool
ARB_shader_clock_warn
;
bool
ARB_shader_draw_parameters_enable
;
bool
ARB_shader_draw_parameters_warn
;
bool
ARB_shader_group_vote_enable
;
bool
ARB_shader_group_vote_warn
;
bool
ARB_shader_image_load_store_enable
;
bool
ARB_shader_image_load_store_warn
;
bool
ARB_shader_image_size_enable
;
bool
ARB_shader_image_size_warn
;
bool
ARB_shader_precision_enable
;
bool
ARB_shader_precision_warn
;
bool
...
;
bool
ARB_shader_texture_image_samples_warn
;
bool
...
;
bool
ARB_shading_language_420pack_warn
;
bool
ARB_shading_language_include_enable
;
bool
ARB_shading_language_include_warn
;
bool
ARB_shading_language_packing_enable
;
bool
ARB_shading_language_packing_warn
;
bool
ARB_tessellation_shader_enable
;
bool
ARB_tessellation_shader_warn
;
bool
ARB_texture_cube_map_array_enable
;
...
;
bool
ARB_vertex_attrib_64bit_warn
;
bool
ARB_viewport_array_enable
;
bool
ARB_viewport_array_warn
;
bool
KHR_blend_equation_advanced_enable
;
bool
KHR_blend_equation_advanced_warn
;
bool
...
;
bool
OES_EGL_image_external_essl3_warn
;
bool
OES_geometry_point_size_enable
;
bool
OES_geometry_point_size_warn
;
bool
OES_geometry_shader_enable
;
bool
OES_geometry_shader_warn
;
bool
OES_gpu_shader5_enable
;
bool
OES_gpu_shader5_warn
;
bool
OES_primitive_bounding_box_enable
;
bool
OES_primitive_bounding_box_warn
;
bool
OES_sample_variables_enable
;
bool
OES_sample_variables_warn
;
bool
...
;
bool
OES_shader_io_blocks_warn
;
bool
OES_shader_multisample_interpolation_enable
;
bool
OES_shader_multisample_interpolation_warn
;
bool
OES_standard_derivatives_enable
;
bool
OES_standard_derivatives_warn
;
bool
OES_tessellation_point_size_enable
;
bool
OES_tessellation_point_size_warn
;
bool
OES_tessellation_shader_enable
;
bool
OES_tessellation_shader_warn
;
bool
...
;
bool
OES_texture_buffer_warn
;
bool
OES_texture_cube_map_array_enable
;
bool
OES_texture_cube_map_array_warn
;
bool
OES_texture_storage_multisample_2d_array_enable
;
bool
OES_texture_storage_multisample_2d_array_warn
;
bool
OES_viewport_array_enable
;
bool
OES_viewport_array_warn
;
bool
...
;
bool
AMD_shader_trinary_minmax_warn
;
bool
AMD_texture_texture4_enable
;
bool
AMD_texture_texture4_warn
;
bool
AMD_vertex_shader_layer_enable
;
bool
AMD_vertex_shader_layer_warn
;
bool
...
;
bool
ANDROID_extension_pack_es31a_enable
;
bool
ANDROID_extension_pack_es31a_warn
;
bool
EXT_blend_func_extended_enable
;
bool
EXT_blend_func_extended_warn
;
bool
EXT_clip_cull_distance_enable
;
bool
EXT_clip_cull_distance_warn
;
bool
EXT_demote_to_helper_invocation_enable
;
bool
EXT_demote_to_helper_invocation_warn
;
bool
EXT_draw_buffers_enable
;
bool
EXT_draw_buffers_warn
;
bool
EXT_draw_instanced_enable
;
bool
EXT_draw_instanced_warn
;
bool
...
;
bool
EXT_geometry_point_size_warn
;
bool
EXT_geometry_shader_enable
;
bool
EXT_geometry_shader_warn
;
bool
EXT_gpu_shader4_enable
;
bool
EXT_gpu_shader4_warn
;
bool
EXT_gpu_shader5_enable
;
bool
EXT_gpu_shader5_warn
;
bool
EXT_primitive_bounding_box_enable
;
bool
EXT_primitive_bounding_box_warn
;
bool
EXT_separate_shader_objects_enable
;
bool
EXT_separate_shader_objects_warn
;
bool
EXT_shader_framebuffer_fetch_enable
;
bool
EXT_shader_framebuffer_fetch_warn
;
bool
EXT_shader_framebuffer_fetch_non_coherent_enable
;
bool
EXT_shader_framebuffer_fetch_non_coherent_warn
;
bool
EXT_shader_image_load_formatted_enable
;
...
;
bool
EXT_shader_image_load_store_warn
;
bool
EXT_shader_implicit_conversions_enable
;
...
;
bool
EXT_shader_integer_mix_warn
;
bool
EXT_shader_io_blocks_enable
;
bool
EXT_shader_io_blocks_warn
;
bool
EXT_shader_samples_identical_enable
;
bool
EXT_shader_samples_identical_warn
;
bool
EXT_tessellation_point_size_enable
;
bool
EXT_tessellation_point_size_warn
;
bool
EXT_tessellation_shader_enable
;
bool
EXT_tessellation_shader_warn
;
bool
...
;
bool
EXT_texture_buffer_warn
;
bool
EXT_texture_cube_map_array_enable
;
bool
EXT_texture_cube_map_array_warn
;
bool
...
;
bool
EXT_texture_shadow_lod_warn
;
bool
INTEL_conservative_rasterization_enable
;
bool
INTEL_conservative_rasterization_warn
;
bool
...
;
bool
INTEL_shader_integer_functions2_warn
;
bool
MESA_shader_integer_functions_enable
;
bool
MESA_shader_integer_functions_warn
;
bool
...
;
bool
NV_fragment_shader_interlock_warn
;
bool
NV_image_formats_enable
;
bool
NV_image_formats_warn
;
bool
NV_shader_atomic_float_enable
;
bool
NV_shader_atomic_float_warn
;
bool
