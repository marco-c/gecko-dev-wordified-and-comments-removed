...
fn
update_same_limit_returns_none
(
)
{
let
...
fn
set_max_active_equal_does_not_set_frame_pending
(
)
{
let
...
fn
retire_no_op_when_not_increasing
(
)
{
let
...
fn
add_retired_zero_does_not_trigger_update
(
)
{
let
...
fn
auto_tune_never_decreases_large_manually_set_max_active
(
)
-
>
