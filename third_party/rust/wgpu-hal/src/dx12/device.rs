...
let
mut
total_dynamic_storage_buffers
=
0
;
let
mut
total_non_dynamic_entries
=
0_usize
;
let
mut
sampler_in_any_bind_group
=
false
;
for
...
let
mut
visibility_view_dynamic_uniform
=
wgt
:
:
...
let
mut
visibility_view_dynamic_storage
=
wgt
:
:
...
let
mut
sampler_index_within_bind_group
=
0
;
for
