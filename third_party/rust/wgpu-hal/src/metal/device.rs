...
{
enum
MetalGenericRenderPipelineDescriptor
{
Standard
(
metal
...
fn
set_depth_attachment_pixel_format
(
&
self
pixel_format
...
fn
set_max_vertex_amplification_count
(
&
self
count
...
device
.
new_mesh_render_pipeline_state
(
&
d
)
