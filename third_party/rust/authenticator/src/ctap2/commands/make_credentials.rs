...
(
req_serialized
MAKE_CREDENTIALS_SAMPLE_REQUEST_CTAP2
)
;
let
make_cred_result
...
device
&
MAKE_CREDENTIALS_SAMPLE_RESPONSE_CTAP2
)
.
expect
(
...
fn
test_serialize_make_credentials_ctap2_all
(
)
{
let
