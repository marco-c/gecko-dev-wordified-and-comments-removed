...
async
fn
test_commit_builder_add_with_ext
(
)
{
let
...
async
fn
test_commit_builder_group_context_ext
(
)
{
let
...
async
fn
test_commit_builder_custom_proposal
(
)
{
let
...
async
fn
test_commit_builder_empty_commit
(
)
{
let
...
async
fn
test_commit_builder_authenticated_data
(
)
{
let
...
async
fn
test_commit_builder_multiple_welcome_messages
(
)
{
let
...
async
fn
commit_includes_tree_if_no_ratchet_tree_ext
(
)
{
let
...
async
fn
commit_does_not_include_tree_if_ratchet_tree_ext
(
)
{
let
...
async
fn
commit_includes_external_commit_group_info_if_requested
(
)
{
let
...
async
fn
commit_includes_external_commit_and_tree_if_requested
(
)
{
let
...
async
fn
commit_does_not_include_external_commit_group_info_if_not_requested
(
)
{
let
...
async
fn
member_identity_is_validated_against_new_extensions
(
)
{
let
...
async
fn
server_identity_is_validated_against_new_extensions
(
)
{
let
...
struct
IdentityProviderWithExtensionError
{
}
impl
IntoAnyError
