...
self
.
apply_proposals_from_new_member
(
proposals
commit_time
)
...
?
;
ensure_exactly_one_external_init
(
&
proposals
)
...
?
;
ensure_proposals_in_external_commit_are_allowed
(
&
proposals
)
