...
ProposalBundle
=
filter_out_update_for_committer
(
strategy
commit_sender
proposals
...
proposals
=
filter_out_removal_of_committer
(
strategy
commit_sender
proposals
...
proposals
=
filter_out_invalid_group_extensions
(
strategy
proposals
self
...
proposals
=
filter_out_extra_group_context_extensions
(
strategy
proposals
)
...
proposals
=
filter_out_reinit_if_other_proposals
(
strategy
.
is_ignore
