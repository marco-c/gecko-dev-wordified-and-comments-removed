...
fn
get_client_info_must_report_all_the_available_data
(
)
{
let
...
fn
test_metrics_must_report_experimentation_id
(
)
{
let
...
fn
collect_must_report_none_when_no_data_is_stored
(
)
{
let
...
fn
no_pings_submitted_if_upload_disabled
(
)
{
let
...
fn
metadata_is_correctly_added_when_necessary
(
)
{
let
...
fn
attribution_and_distribution_appear_in_client_info
(
)
{
let
