...
:
:
pipeline_cache_to_binary_archive
(
cache
)
{
...
inner
.
add_compute_pipeline_functions_with_descriptor
(
&
pipeline
)
...
:
:
resource_options_from_storage_and_cache
(
storage
cache
)
