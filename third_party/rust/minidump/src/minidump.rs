...
pub
struct
MinidumpHandleObjectInformation
{
pub
raw
:
...
:
:
from_windows_error_with_facility
(
error_code
)
{
...
fn
test_simple_synth_dump_bigendian
(
)
{
const
...
(
"
AABBCCDDEEFF001122334455667788990
"
)
.
unwrap
...
fn
test_crashpad_info_annotations
(
)
{
let
