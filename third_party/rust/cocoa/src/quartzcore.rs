...
pub
fn
set_contents_gravity
(
&
self
new_contents_gravity
:
ContentsGravity
)
{
...
pub
fn
set_needs_display_on_bounds_change
(
&
self
flag
...
pub
fn
resize_sublayers_with_old_size
(
&
self
size
...
pub
fn
resize_with_old_superlayer_size
(
&
self
size
