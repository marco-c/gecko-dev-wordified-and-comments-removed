...
pLogotypeDirectInfo
pLogotypeDirectInfo_mut
:
PCERT_LOGOTYPE_DATA
pLogotypeIndirectInfo
pLogotypeIndirectInfo__mut
:
PCERT_LOGOTYPE_REFERENCE
}
}
...
ByNameResponderId
ByNameResponderId_mut
:
CERT_NAME_BLOB
ByKeyResponderId
ByKeyResponderId_mut
:
CRYPT_HASH_BLOB
}
}
...
hKeyEncryptionKey
hKeyEncryptionKey_mut
:
HCRYPTKEY
pvKeyEncryptionKey
pvKeyEncryptionKey_mut
:
*
mut
c_void
...
OriginatorCertId
OriginatorCertId_mut
:
CERT_ID
OriginatorPublicKeyInfo
OriginatorPublicKeyInfo_mut
:
CERT_PUBLIC_KEY_INFO
}
}
...
hContentEncryptKey
hContentEncryptKey_mut
:
HCRYPTKEY
hCNGContentEncryptKey
hCNGContentEncryptKey_mut
:
BCRYPT_KEY_HANDLE
}
}
...
pub
const
CERT_CHAIN_MAX_URL_RETRIEVAL_BYTE_COUNT_DEFAULT
:
DWORD
=
100
...
pub
const
CERT_CHAIN_OCSP_VALIDITY_SECONDS_DEFAULT
:
DWORD
=
12
...
pub
const
CERT_CHAIN_AUTO_FLUSH_FIRST_DELTA_SECONDS_DEFAULT
:
DWORD
=
5
...
pub
const
CERT_CHAIN_AUTO_FLUSH_NEXT_DELTA_SECONDS_DEFAULT
:
DWORD
=
30
...
pub
const
CERT_SRV_OCSP_RESP_MAX_SYNC_CERT_FILE_SECONDS_DEFAULT
:
DWORD
=
1
...
pub
const
CRYPTNET_CRL_PRE_FETCH_TIMEOUT_SECONDS_DEFAULT
:
DWORD
=
5
...
pub
const
CRYPTNET_CRL_PRE_FETCH_MAX_AGE_SECONDS_DEFAULT
:
DWORD
=
2
...
pub
const
CRYPTNET_CRL_PRE_FETCH_MAX_AGE_SECONDS_MIN
:
DWORD
=
5
