...
#
ifdef
SPIRV_CROSS_WRAPPER_NO_EXCEPTIONS
#
define
INTERNAL_RESULT
(
...
{
ScInternalResult
sc_internal_get_latest_exception_message
(
const
char
*
...
#
ifdef
SPIRV_CROSS_WRAPPER_HLSL
ScInternalResult
sc_internal_compiler_hlsl_new
(
ScInternalCompilerHlsl
*
*
compiler
const
...
ScInternalResult
sc_internal_compiler_msl_compile
(
const
...
ScInternalResult
sc_internal_compiler_msl_set_options
(
const
ScInternalCompilerMsl
*
...
ScInternalResult
sc_internal_compiler_msl_get_is_rasterization_disabled
(
const
ScInternalCompilerMsl
*
...
#
ifdef
SPIRV_CROSS_WRAPPER_GLSL
ScInternalResult
sc_internal_compiler_glsl_new
(
ScInternalCompilerGlsl
*
*
compiler
const
...
ScInternalResult
sc_internal_compiler_glsl_set_options
(
const
ScInternalCompilerGlsl
*
...
-
>
vertex_support_nonzero_base_instance
;
glsl_options
.
fragment
...
-
>
fragment_default_float_precision
)
;
glsl_options
.
...
-
>
fragment_default_int_precision
)
;
compiler_glsl
-
...
ScInternalResult
sc_internal_compiler_glsl_build_combined_image_samplers
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_glsl_add_header_line
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_glsl_flatten_buffer_block
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_decoration
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_unset_decoration
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_entry_points
(
const
ScInternalCompilerBase
*
...
const
&
sc_entry_point_names_and_stages
=
comp
.
...
ScInternalResult
sc_internal_compiler_get_active_buffer_ranges
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_cleansed_entry_point_name
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_shader_resources
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_specialization_constants
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_set_scalar_constant
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_member_name
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_member_decoration
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_set_member_decoration
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_declared_struct_size
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_get_declared_struct_member_size
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_rename_interface_variable
(
const
ScInternalCompilerBase
*
...
ScInternalResult
sc_internal_compiler_set_entry_point
(
const
ScInternalCompilerBase
*
