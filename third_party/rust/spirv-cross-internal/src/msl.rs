...
:
:
MSLShaderInputFormat_MSL_SHADER_INPUT_FORMAT_OTHER
Uint8
=
>
br
...
:
:
MSLShaderInputFormat_MSL_SHADER_INPUT_FORMAT_UINT8
Uint16
=
>
br
...
:
:
MSLShaderInputFormat_MSL_SHADER_INPUT_FORMAT_UINT16
}
}
}
#
...
u32
pub
patch_output_buffer_index
:
u32
pub
tessellation_factor_buffer_index
:
u32
pub
