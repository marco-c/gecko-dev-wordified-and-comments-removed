...
<
2
ACCESS_CHAIN_SKIP_REGISTER_EXPRESSION_READ_BIT
=
1
<
<
...
<
4
ACCESS_CHAIN_FLATTEN_ALL_MEMBERS_BIT
=
1
<
<
...
;
bool
support_case_fallthrough
=
true
;
bool
use_array_constructor
=
false
;
bool
needs_row_major_load_workaround
=
false
;
}
...
;
void
fixup_io_block_patch_qualifiers
(
const
SPIRVariable
&
...
type
bool
support_std430_without_scalar_layout
)
;
uint32_t
...
;
void
propagate_nonuniform_qualifier
(
uint32_t
id
)
