...
backend
.
comparison_image_samples_scalar
=
true
;
backend
...
backend
.
buffer_offset_array_is_value_type
=
false
;
capture_output_to_buffer
...
{
case
MSL_SHADER_INPUT_FORMAT_UINT16
:
case
MSL_SHADER_INPUT_FORMAT_ANY16
:
type
.
basetype
...
4
>
spvChromaReconstructLinear422CositedEven
(
texture2d
<
T
...
4
>
spvChromaReconstructLinear422Midpoint
(
texture2d
<
T
...
4
>
spvChromaReconstructLinear420XCositedEvenYCositedEven
(
texture2d
<
T
...
4
>
spvChromaReconstructLinear420XCositedEvenYMidpoint
(
texture2d
<
T
...
4
>
spvChromaReconstructLinear420XMidpointYMidpoint
(
texture2d
<
T
...
;
bool
builtin_block_type_is_required
=
false
;
ir
...
:
:
fix_up_interpolant_access_chain
(
const
uint32_t
*
...
;
bool
is_atomic_compare_exchange_strong
=
op1_is_pointer
&
&
...
inline
bool
sampling_type_needs_f32_conversion
(
const
SPIRType
&
...
if
(
is_supported_argument_buffer_type
(
type
)
&
...
:
:
get_declared_input_array_stride_msl
(
const
SPIRType
&
...
:
:
get_declared_input_matrix_stride_msl
(
const
SPIRType
&
...
:
:
get_declared_input_alignment_msl
(
const
SPIRType
&
