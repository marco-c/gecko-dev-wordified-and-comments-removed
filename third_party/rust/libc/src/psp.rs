...
{
SceKernelUnknownPartition
=
0
SceKernelPrimaryKernelPartition
=
1
SceKernelPrimaryUserPartition
=
2
SceKernelOtherKernelPartition1
=
3
SceKernelOtherKernelPartition2
=
4
SceKernelVshellPARTITION
=
5
SceKernelScUserPartition
=
6
SceKernelMeUserPartition
=
7
SceKernelExtendedScKernelPartition
=
8
SceKernelExtendedSc2KernelPartition
=
9
SceKernelExtendedMeKernelPartition
=
10
SceKernelVshellKernelPartition
=
11
SceKernelExtendedKernelPartition
=
12
}
#
...
{
pub
puc_write_position_first_buf
:
*
mut
u8
pub
ui_writable_byte_first_buf
:
u32
pub
ui_min_write_byte_first_buf
:
u32
pub
...
u32
pub
puc_write_position_second_buf
:
*
mut
u8
pub
ui_writable_byte_second_buf
:
u32
pub
...
i32
pub
num_send_wait_threads
:
i32
pub
num_receive_wait_threads
:
i32
}
pub
...
{
pub
frame_buffer_height16
:
i32
pub
frame_buffer_width16
:
i32
pub
unknown
...
pub
const
UTILITY_MSGDIALOG_YES_NO_BUTTONS
:
i32
=
0x10
...
pub
const
UTILITY_HTMLVIEWER_OPEN_SCE_START_PAGE
:
i32
=
0x000001
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_STARTUP_LIMITS
:
i32
=
0x000002
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_EXIT_DIALOG
:
i32
=
0x000004
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_CURSOR
:
i32
=
0x000008
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_DOWNLOAD_COMPLETE_DIALOG
:
i32
=
0x000010
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_DOWNLOAD_START_DIALOG
:
i32
=
0x000020
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_DOWNLOAD_DESTINATION_DIALOG
:
i32
=
0x000040
...
pub
const
UTILITY_HTMLVIEWER_LOCK_DOWNLOAD_DESTINATION_DIALOG
:
i32
=
0x000080
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_TAB_DISPLAY
:
i32
=
0x000100
...
pub
const
UTILITY_HTMLVIEWER_ENABLE_ANALOG_HOLD
:
i32
=
0x000200
...
pub
const
UTILITY_HTMLVIEWER_ENABLE_FLASH
:
i32
=
0x000400
...
pub
const
UTILITY_HTMLVIEWER_DISABLE_LRTRIGGER
:
i32
=
0x000800
...
:
u32
ui_write_byte_first_buf
:
u32
ui_write_byte_second_buf
:
u32
)
-
...
:
i32
puc_second_buffer_addr
:
*
mut
u8
ui_second_buffer_byte
:
u32
)
-
