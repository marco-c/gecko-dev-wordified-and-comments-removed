...
fn
test_get_device_stream_format_by_unknown_device
(
)
{
assert
...
fn
test_get_device_stream_configuration
(
)
{
if
...
fn
test_get_device_stream_configuration_by_unknown_device
(
)
{
assert
