...
int
*
prev_node_backend_ids
;
int
*
prev_leaf_backend_ids
;
struct
ggml_cgraph
graph
...
struct
ggml_backend_buffer_i
ggml_backend_cpu_buffer_from_ptr_i
=
{
NULL
ggml_backend_cpu_buffer_get_base
