...
#
ifndef
MSGPACK_PREPROCESSOR_SEQ_FOR_EACH_I_HPP
#
define
MSGPACK_PREPROCESSOR_SEQ_FOR_EACH_I_HPP
#
...
MSGPACK_PP_SEQ_FOR_EACH_I_DETAIL_CHECK
(
macro
data
seq
...
MSGPACK_PP_SEQ_FOR_EACH_I_P
MSGPACK_PP_SEQ_FOR_EACH_I_O
MSGPACK_PP_SEQ_FOR_EACH_I_M
)
#
define
...
\
MSGPACK_PP_SEQ_FOR_EACH_I_O_I_DEC
(
macro
data
seq
...
MSGPACK_PP_SEQ_FOR_EACH_I_M_IM
(
r
...
MSGPACK_PP_SEQ_FOR_EACH_I_R_DETAIL_CHECK
(
r
macro
data
