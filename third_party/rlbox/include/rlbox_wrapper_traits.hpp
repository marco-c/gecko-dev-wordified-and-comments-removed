...
>
using
rlbox_tainted_opaque_to_tainted_t
=
std
:
:
...
;
namespace
detail_is_member_of_rlbox_detail
{
template
<
typename
...
>
struct
is_member_of_rlbox_detail_helper
:
std
:
:
...
decltype
(
struct_is_member_of_rlbox_detail
(
std
:
:
...
>
struct
has_member_using_can_grant_deny_access
:
std
:
:
...
>
struct
has_member_using_needs_internal_lookup_symbol
:
std
:
:
...
constexpr
bool
has_member_using_needs_internal_lookup_symbol_v
=
detail_has_member_using_needs_internal_lookup_symbol
:
:
