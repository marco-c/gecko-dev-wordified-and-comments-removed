...
{
namespace
convert_fn_ptr_to_sandbox_equivalent_detail
{
template
<
typename
...
inline
auto
INTERNAL_invoke_with_func_name
(
const
char
*
...
{
return
INTERNAL_get_sandbox_function_ptr
<
T
>
(
...
inline
int64_t
get_total_ns_time_in_sandbox_and_transitions
(
)
{
int64_t
