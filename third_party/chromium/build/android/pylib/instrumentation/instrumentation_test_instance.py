...
self
.
_forced_queryable_additional_apks
=
[
]
...
self
.
_apk_under_test_incremental_install_json
=
None
...
self
.
_webview_variations_test_seed_path
=
(
...
self
.
_store_data_dependencies_in_temp
=
False
...
self
.
_has_external_annotation_filters
=
None
...
self
.
_use_apk_under_test_flags_file
=
False
...
self
.
_replace_system_package
=
None
    
self
.
_initializeReplaceSystemPackageAttributes
(
args
)
...
self
.
_use_voice_interaction_service
=
None
    
self
.
_initializeUseVoiceInteractionService
(
args
)
...
self
.
_use_webview_provider
=
None
    
self
.
_initializeUseWebviewProviderAttributes
(
args
)
...
self
.
_initializeTestLauncherAttributes
(
args
)
...
self
.
_approve_app_links_domain
=
None
    
self
.
_approve_app_links_package
=
None
    
self
.
_initializeApproveAppLinksAttributes
(
args
)
...
args
.
forced_queryable_additional_apks
+
                 
args
.
instant_additional_apks
)
:
