...
def
symbolize_stack_and_merge_with_log
(
)
:
...
symbolizer
.
ExtractAndResolveNativeStackTraces
(
...
self
.
_extract_test_list_from_filter
=
args
.
...
self
.
_isolated_script_test_perf_output
=
(
