...
\
GMOCK_INTERNAL_GET_CALLTYPE_SPEC
(
_Spec
)
\
...
GMOCK_PP_FOR_EACH
(
GMOCK_INTERNAL_CALLTYPE_SPEC_IF_CALLTYPE
~
_Tuple
)
#
...
#
ifdef
GMOCK_INTERNAL_STRICT_SPEC_ASSERT
#
define
GMOCK_INTERNAL_ASSERT_VALID_SPEC_ELEMENT
(
...
GMOCK_PP_CAT
(
GMOCK_INTERNAL_DETECT_CALLTYPE_I_
_elem
)
#
define
GMOCK_INTERNAL_DETECT_CALLTYPE_I_Calltype
#
define
GMOCK_INTERNAL_UNPACK_Calltype
(
.
.
.
