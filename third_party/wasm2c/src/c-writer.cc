...
char
*
s_atomicops_source_declarations
;
namespace
wabt
{
...
size_t
>
default_name_to_output_file_index
(
std
:
:
...
:
string
DefineImportedModuleInstanceName
(
std
:
:
...
;
void
WriteCallIndirectFuncDeclaration
(
const
FuncDeclaration
&
...
#
if
WASM_RT_USE_SEGUE_FOR_THIS_MODULE
"
Newline
(
)
