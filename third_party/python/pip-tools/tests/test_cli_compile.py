...
def
test_command_line_setuptools_output_file
(
...
def
test_upgrade_packages_option_irrelevant
(
pip_conf
runner
)
...
def
test_upgrade_packages_option_no_existing_file
(
pip_conf
runner
)
...
output
def
test_stdin_without_output_file
(
runner
)
:
...
def
test_multiple_input_files_without_output_file
(
runner
)
:
...
def
test_empty_input_file_no_header
(
runner
empty_input_pkg
prior_output_pkg
...
def
test_options_in_requirements_file
(
runner
options
)
...
def
test_upgrade_packages_option_subdependency
(
...
input_opts
def
test_sub_dependencies_with_constraints
(
pip_conf
runner
)
