...
def
_ConfigWindowsTargetPlatformVersion
(
config_data
version
)
...
def
_GetMSBuildProjectConfigurations
(
configurations
)
:
...
msbuild_attributes
def
_GetMSBuildConfigurationGlobalProperties
(
spec
configurations
build_file
...
def
_GetMSBuildToolSettingsSections
(
spec
configurations
)
...
(
'
msvs_use_library_dependency_inputs
'
0
)
:
