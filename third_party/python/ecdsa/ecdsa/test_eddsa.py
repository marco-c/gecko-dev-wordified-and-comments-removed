...
curve_256
def
test_ed25519_and_ed448_compare
(
)
:
...
curve_ed25519
def
test_ed25519_and_custom_curve_compare
(
)
:
...
a
def
test_ed25519_and_almost_exact_curve_compare
(
)
:
...
a
def
test_ed25519_and_same_curve_params
(
)
:
...
def
test_ed25519_contains_point_bad
(
)
:
...
INFINITY
def
test_ed25519_double_badly_encoded_infinity
(
)
:
...
INFINITY
def
test_ed25519_eq_with_different_z
(
)
:
...
def
test_ed25519_eq_against_infinity
(
)
:
...
INFINITY
def
test_ed25519_eq_encoded_infinity_against_infinity
(
)
:
...
INFINITY
def
test_ed25519_eq_bad_encode_of_infinity_against_infinity
(
)
:
...
INFINITY
def
test_ed25519_eq_against_non_Edwards_point
(
)
:
...
generator_256
def
test_ed25519_eq_against_negated_point
(
)
:
...
a
def
test_ed25519_test_normalisation_and_scaling
(
)
:
...
INFINITY
def
test_ed25519_add_and_mul_equivalence
(
)
:
...
3
def
test_ed25519_add_literal_infinity
(
)
:
...
p
def
test_ed25519_mul_to_order_min_1
(
)
:
...
INFINITY
def
test_ed25519_mul_to_infinity_plus_1
(
)
:
...
g
def
test_ed448_eq_against_different_curve
(
)
:
...
INFINITY
def
test_ed448_mul_to_infinity_plus_1
(
)
:
...
g
def
test_ed448_add_and_mul_equivalence
(
)
:
...
def
test_unequal_privatekey_to_string
(
self
)
:
...
def
test_unequal_privatekey_curves
(
self
)
:
...
def
test_wrong_length_of_private_key
(
self
)
:
...
def
test_wrong_length_of_public_key
(
self
)
:
...
def
test_changing_public_key_to_different_point
(
self
)
:
...
def
test_ed25519_mul_precompute_vs_naf
(
multiple
)
:
