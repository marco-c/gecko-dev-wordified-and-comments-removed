...
(
"
9d0219792467d7d37b4d43298a7d0c05
"
16
)
...
def
test_privkey_strings_brainpool
(
self
)
:
...
def
test_vk_to_der_with_invalid_point_encoding
(
self
)
:
...
def
test_sk_to_der_with_invalid_point_encoding
(
self
)
:
...
def
test_vk_from_der_garbage_after_curve_oid
(
self
)
:
...
def
test_vk_from_der_invalid_key_type
(
self
)
:
...
def
test_vk_from_der_garbage_after_point_string
(
self
)
:
...
def
test_vk_from_der_invalid_bitstring
(
self
)
:
...
def
test_vk_from_der_with_invalid_length_of_encoding
(
self
)
:
...
def
test_vk_from_der_with_raw_encoding
(
self
)
:
...
def
test_sigencode_string_canonize_no_change
(
self
)
:
...
def
test_sigencode_string_canonize
(
self
)
:
...
def
test_sigencode_strings_canonize_no_change
(
self
)
:
...
def
test_sigencode_strings_canonize
(
self
)
:
...
def
test_sigencode_der_canonize_no_change
(
self
)
:
...
def
test_sigencode_der_canonize_with_close_to_half_order
(
self
)
:
...
def
test_sig_decode_strings_with_invalid_count
(
self
)
:
...
def
test_sig_decode_strings_with_wrong_r_len
(
self
)
:
...
def
test_sig_decode_strings_with_wrong_s_len
(
self
)
:
...
def
test_verify_with_too_long_input
(
self
)
:
...
def
test_sk_from_string_with_wrong_len_string
(
self
)
:
...
def
test_sk_from_der_with_junk_after_sequence
(
self
)
:
...
def
test_sk_from_der_with_wrong_version
(
self
)
:
...
def
test_sk_from_der_invalid_const_tag
(
self
)
:
...
def
test_sk_from_der_garbage_after_privkey_oid
(
self
)
:
...
def
test_sk_from_der_with_short_privkey
(
self
)
:
...
def
test_sk_from_p8_der_with_wrong_version
(
self
)
:
...
def
test_sk_from_p8_der_with_wrong_algorithm
(
self
)
:
...
def
test_sk_from_p8_der_with_trailing_junk_after_algorithm
(
self
)
:
...
def
test_sk_from_p8_der_with_trailing_junk_after_key
(
self
)
:
...
def
test_public_key_recovery_with_custom_hash
(
self
)
:
...
def
test_uncompressed_decoding_as_only_alowed
(
self
)
:
...
def
test_raw_decoding_with_blocked_format
(
self
)
:
...
def
test_decoding_with_unknown_format
(
self
)
:
...
def
test_hybrid_decoding_with_blocked_format
(
self
)
:
...
def
test_hybrid_decoding_with_inconsistent_encoding_and_no_validation
(
...
def
test_compressed_decoding_with_blocked_format
(
self
)
:
...
def
test_decoding_with_malformed_uncompressed
(
self
)
:
...
def
test_decoding_with_malformed_compressed
(
self
)
:
...
def
test_decoding_with_inconsistent_hybrid
(
self
)
:
...
def
test_decoding_with_inconsistent_hybrid_odd_point
(
self
)
:
...
def
test_decoding_with_point_not_on_curve
(
self
)
:
...
def
test_decoding_with_point_at_infinity
(
self
)
:
...
def
test_from_string_with_invalid_curve_too_short_ver_key_len
(
self
)
:
...
def
test_from_string_with_invalid_curve_too_long_ver_key_len
(
self
)
:
...
def
test_VerifyingKey_decode_with_small_values
(
val
even
)
...
def
test_VerifyingKey_encode_decode
(
curve
encoding
)
...
def
test_from_openssl_nist256p_sha384
(
self
)
:
...
def
test_from_openssl_nist256p_sha512
(
self
)
:
...
def
test_from_openssl_brainpoolp192r1
(
self
)
:
...
def
test_from_openssl_brainpoolp224r1
(
self
)
:
...
def
test_from_openssl_brainpoolp320r1
(
self
)
:
...
def
test_from_openssl_brainpoolp512r1
(
self
)
:
...
def
test_from_openssl_brainpoolp160t1
(
self
)
:
...
def
test_from_openssl_brainpoolp192t1
(
self
)
:
...
def
test_from_openssl_brainpoolp256t1
(
self
)
:
...
def
test_from_openssl_brainpoolp320t1
(
self
)
:
...
def
test_from_openssl_brainpoolp384t1
(
self
)
:
...
def
test_from_openssl_brainpoolp512t1
(
self
)
:
...
def
test_to_openssl_nist192p_sha256
(
self
)
:
...
def
test_to_openssl_brainpoolp160r1
(
self
)
:
...
def
test_to_openssl_brainpoolp192r1
(
self
)
:
...
def
test_to_openssl_brainpoolp224r1
(
self
)
:
...
def
test_to_openssl_brainpoolp256r1
(
self
)
:
...
def
test_to_openssl_brainpoolp320r1
(
self
)
:
...
def
test_to_openssl_brainpoolp384r1
(
self
)
:
...
def
test_to_openssl_brainpoolp192t1
(
self
)
:
...
def
test_to_openssl_brainpoolp224t1
(
self
)
:
...
def
test_to_openssl_brainpoolp256t1
(
self
)
:
...
def
test_to_openssl_brainpoolp320t1
(
self
)
:
...
def
test_to_openssl_brainpoolp384t1
(
self
)
:
...
def
test_to_openssl_brainpoolp512t1
(
self
)
:
...
def
test_sign_too_small_curve_dont_allow_truncate_raises
(
self
)
:
...
def
test_verify_too_small_curve_dont_allow_truncate_raises
(
self
)
:
...
(
"
09A4D6792295A7F730FC3F2B49CBC0F62E862272F
"
16
)
...
"
7C4B7A2C8A4BAD1FBB7D79CC0955DB7C6A4660CA64CC4778159B495E
"
16
...
"
B104A67A6F6E85E14EC1825E1539E8ECDBBF584922367DD88C6BDCF2
"
16
...
"
46D782E7FDB5F60CD8404301AC5949C58EDB26BC68BA07695B750A94
"
16
...
"
63976D4AAE6CD0F6DD18DEFEF55D96569D0507C03E74D6486FFA28FB
"
16
...
"
2A97089A9296147B71B21A4B574E1278245B536F14D8C2B9D07A874E
"
16
...
"
9B900D7C77A709A797276B8CA1BA61BB95B546FC29F862E44D59D25B
"
16
...
"
312DFD98783F9FB77B9704945A73BEB6DCCBE3B65D0F967DCAB574EB
"
16
...
"
6F800811D64114B1C48C621AB3357CF93F496E4238696A2A012B3C98
"
16
