...
def
test_verification_with_regular_point
(
self
)
:
...
def
test_inequality_different_curves
(
self
)
:
...
x2
=
0x722BA0FB6B8FC8898A4C6AB49E66
        
y2
=
0x2B7344BB57A7ABC8CA0F1A398C7D
...
def
test_inequality_public_key_not_implemented
(
self
)
:
...
def
test_public_key_with_generator_without_order
(
self
)
:
...
def
test_public_point_on_curve_not_scalar_multiple_of_base_point
(
self
)
:
...
y
=
0xBE6AA4938EF7CFE6FE29595B6B00
...
def
test_point_is_valid_with_not_scalar_multiple_of_base_point
(
self
)
:
...
def
test_inequality_private_keys_not_implemented
(
self
)
:
