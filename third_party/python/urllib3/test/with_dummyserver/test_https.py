...
def
test_assert_fingerprint_sha256
(
self
)
:
...
def
test_good_fingerprint_and_hostname_mismatch
(
self
)
:
...
self
.
_request_without_resource_warnings
(
"
GET
"
...
def
test_set_ssl_version_to_tls_version
(
self
)
:
...
def
test_strip_square_brackets_before_validating
(
self
ipv6_addr_server
)
