...
(
"
ANGLE_METAL_FRAME_CAPTURE_FILE
"
)
;
const
...
(
"
ANGLE_METAL_FRAME_CAPTURE_SCOPE
"
)
;
static
...
bool
GetCompressedBufferSizeAndRowLengthForTextureWithFormat
(
const
TextureRef
&
...
:
Result
InitializeCompressedTextureContents
(
const
gl
:
