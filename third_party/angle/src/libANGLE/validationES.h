...
:
:
kInvalidVertexAttribSize2101010
)
;
return
false
...
:
:
kInvalidVertexAttribSize1010102
)
;
return
false
...
:
:
kElementArrayNoBufferOrPointer
)
;
return
false
