...
kEntryPointRequiresES10
)
;
}
bool
ValidateAlphaFuncCommon
(
const
PrivateState
&
...
bool
ValidateBuiltinVertexAttributeCommon
(
const
Context
*
...
bool
ValidateMaterialSingleComponent
(
const
PrivateState
&
...
bool
ValidateLightModelSingleComponent
(
const
PrivateState
&
...
(
GL_INVALID_VALUE
kNonPositiveDrawTextureDimension
)
;
return
false
...
bool
ValidateTexParameterBaseForGLfixed
(
const
Context
*
