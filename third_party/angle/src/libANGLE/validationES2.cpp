...
bool
IsValidCopyTextureSourceInternalFormatEnum
(
GLenum
internalFormat
)
...
:
case
GL_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16_ANGLE
:
case
GL_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16_ANGLE
:
case
GL_G16_B16R16_2PLANE_420_UNORM_ANGLE
:
case
...
bool
IsValidCopySubTextureSourceInternalFormat
(
GLenum
internalFormat
)
...
bool
IsValidCopyTextureDestinationInternalFormatEnum
(
GLint
internalFormat
)
...
bool
IsValidCopySubTextureDestionationInternalFormat
(
GLenum
internalFormat
)
...
bool
IsValidCopyTextureDestinationFormatType
(
const
Context
*
...
bool
IsValidCopyTextureDestinationTargetEnum
(
const
Context
*
...
bool
IsValidCopyTextureDestinationTarget
(
const
Context
*
...
bool
IsValidCopyTextureSourceTarget
(
const
Context
*
...
bool
IsValidCopyTextureDestinationLevel
(
const
Context
*
...
inline
bool
Valid2to4ComponentFloatColorBufferFormat
(
const
Context
*
...
inline
bool
Valid3to4ComponentFloatColorBufferFormat
(
const
Context
*
...
inline
bool
Valid4ComponentFloatColorBufferFormat
(
const
Context
*
...
;
case
GL_ROBUST_RESOURCE_INITIALIZATION_ANGLE
:
return
queryOnly
&
...
(
GL_INVALID_ENUM
kInvalidCompressedInternalFormat
internalformat
)
;
return
...
(
!
ValidCompressedFormatForTexture2DArray
(
internalformat
extensions
)
...
(
!
ValidCompressedFormatForTexture3D
(
internalformat
extensions
)
...
(
GL_INVALID_OPERATION
kInternalFormatRequiresTexture3D
)
;
return
false
...
(
GL_INVALID_VALUE
kInvalidMipLevelPalettePositive
)
;
return
false
...
(
GL_INVALID_VALUE
kCompressedTextureImageSizeMismatch
)
;
return
false
...
(
GL_INVALID_VALUE
kSubregionDimensionsOutOfBounds
)
;
return
false
...
bool
ValidateDebugMessageControlBase
(
const
Context
*
...
bool
ValidateGetDebugMessageLogBase
(
const
Context
*
...
(
GL_STACK_OVERFLOW
kExceedsMaxDebugGroupStackDepth
)
;
return
false
...
if
(
GetIntOrUnsignedIntDrawBufferMask
(
fbo
-
>
...
-
>
isFramebufferAttachmentComplete
(
sourceLevel
&
error
...
(
GL_INVALID_VALUE
kInvalidDestinationTextureType
)
;
return
false
...
(
GL_INVALID_OPERATION
kInvalidSourceTextureSameAsDestTexture
)
;
return
false
...
(
GL_INVALID_VALUE
kSourceTextureLevelZeroDefined
)
;
return
false
...
(
GL_INVALID_OPERATION
kSourceTextureMustBeCompressed
)
;
return
false
...
static
bool
ValidAdvancedBlendEquationMode
(
const
PrivateState
&
...
(
GL_INVALID_VALUE
kInvalidFramebufferTextureLevel
)
;
return
false
...
bool
ValidateBlobCacheCallbacksANGLE
(
const
Context
*
