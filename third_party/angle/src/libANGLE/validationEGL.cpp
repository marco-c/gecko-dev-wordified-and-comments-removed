...
bool
TextureHasNonZeroMipLevelsSpecified
(
const
gl
:
...
bool
CubeTextureHasUnspecifiedLevel0Face
(
const
gl
:
...
bool
ValidateCreateImageMipLevelCommon
(
const
ValidationContext
*
...
EGL_BAD_ATTRIBUTE
"
EXT_gl_colorspace_display_p3_linear
is
not
available
.
...
EGL_BAD_ATTRIBUTE
"
EXT_gl_colorspace_bt2020_linear
is
not
available
"
...
:
case
EGL_PLATFORM_ANGLE_VULKAN_DRIVER_UUID_ANGLE
:
case
EGL_PLATFORM_ANGLE_VULKAN_DRIVER_ID_ANGLE
:
vkDeviceUuidSpecified
=
true
...
"
"
EGL_PLATFORM_ANGLE_VULKAN_DRIVER_UUID
and
"
"
...
:
:
RenderingCompleteTime
:
case
Timestamp
:
:
CompositionLatchTime
:
case
Timestamp
:
:
FirstCompositionStartTime
:
case
Timestamp
:
:
LastCompositionStartTime
:
case
Timestamp
:
:
FirstCompositionGPUFinishedTime
:
case
Timestamp
:
...
;
case
EGL_SYNC_METAL_COMMANDS_SCHEDULED_ANGLE
:
if
(
!
...
bool
ValidateQueryDisplayAttribBase
(
const
ValidationContext
*
...
bool
ValidateCreateContextAttribute
(
const
ValidationContext
*
...
constexpr
EGLint
kRequiredMajorVersion
=
1
;
constexpr
EGLint
kRequiredMinorVersion
=
5
;
if
...
;
case
EGL_CONTEXT_VIRTUALIZATION_GROUP_ANGLE
:
if
(
!
...
;
case
EGL_CONTEXT_PASSTHROUGH_SHADERS_ANGLE
:
if
(
!
...
.
createContextPassthroughShadersANGLE
)
{
val
-
...
bool
ValidateCreateContextAttributeValue
(
const
ValidationContext
*
...
bool
ValidateCreatePbufferSurfaceAttribute
(
const
ValidationContext
*
...
bool
ValidateCreatePbufferSurfaceAttributeValue
(
const
ValidationContext
*
...
bool
ValidateCreateWindowSurfaceAttributes
(
const
ValidationContext
*
...
bool
ValidateQuerySupportedCompressionRatesEXT
(
const
ValidationContext
*
...
;
case
EGL_CONTEXT_MEMORY_USAGE_ANGLE
:
if
(
!
...
;
case
EGL_WEBGPU_DEVICE_ANGLE
:
case
EGL_WEBGPU_ADAPTER_ANGLE
:
if
(
!
...
;
case
EGL_VULKAN_VERSION_ANGLE
:
case
EGL_VULKAN_INSTANCE_ANGLE
:
case
EGL_VULKAN_INSTANCE_EXTENSIONS_ANGLE
:
case
EGL_VULKAN_PHYSICAL_DEVICE_ANGLE
:
case
EGL_VULKAN_DEVICE_ANGLE
:
case
EGL_VULKAN_DEVICE_EXTENSIONS_ANGLE
:
case
EGL_VULKAN_FEATURES_ANGLE
:
case
EGL_VULKAN_QUEUE_ANGLE
:
case
EGL_VULKAN_QUEUE_FAMILIY_INDEX_ANGLE
:
case
EGL_VULKAN_GET_INSTANCE_PROC_ADDR
:
if
(
!
...
bool
ValidateWaitUntilWorkScheduledANGLE
(
const
ValidationContext
*
...
EGL_BAD_ACCESS
"
EGL_EXT_dma_buf_import_modfier
not
supported
"
)
...
bool
ValidateUnlockVulkanQueueANGLE
(
const
ValidationContext
*
...
bool
ValidateAcquireExternalContextANGLE
(
const
ValidationContext
*
...
bool
ValidateReleaseExternalContextANGLE
(
const
ValidationContext
*
...
bool
ValidateSetValidationEnabledANGLE
(
const
ValidationContext
*
