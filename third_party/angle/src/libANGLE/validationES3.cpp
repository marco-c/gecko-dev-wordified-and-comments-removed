...
{
bool
ValidateFramebufferTextureMultiviewBase
(
const
Context
*
...
bool
ValidateFramebufferTextureMultiviewLevelAndFormat
(
const
Context
*
...
bool
ValidateColorMaskForSharedExponentColorBuffer
(
const
Context
*
...
static
bool
ValidateES3CompressedFormatForTexture2DArray
(
const
Context
*
...
(
GL_INVALID_OPERATION
kYuvTexSubImage2DOddOffsetOrDimension
)
;
return
false
...
if
(
IsComponentTypeFloatOrUnsignedInt
(
mask
drawbuffer
)
...
if
(
IsComponentTypeIntOrUnsignedInt
(
mask
drawbuffer
)
...
(
GL_INVALID_OPERATION
kTransfomFeedbackAlreadyActive
)
;
return
false
...
(
GL_INVALID_OPERATION
kTransformFeedbackProgramNotSameAtResume
)
;
return
false
...
(
GL_INVALID_OPERATION
kTransformFeedbackPipelineNotSameAtResume
)
;
return
false
...
(
GL_INVALID_VALUE
kIndexExceedsMaxActiveUniformBlock
)
;
return
false
...
(
GL_INVALID_VALUE
kFragDataBindingIndexOutOfRange
)
;
return
false
