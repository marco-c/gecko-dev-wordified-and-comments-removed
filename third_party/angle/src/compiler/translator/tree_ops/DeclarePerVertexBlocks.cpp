...
class
InspectPerVertexBuiltInsTraverser
:
public
TIntermTraverser
{
...
mClipDistanceArraySize
(
clipDistanceArraySize
)
mCullDistanceArraySize
(
cullDistanceArraySize
)
mPerVertexInVar
...
mPerVertexInVarRedeclared
(
false
)
mPerVertexOutVarRedeclared
(
false
)
mPerVertexOutInvariantFlags
(
invariantFlags
)
mPerVertexOutPreciseFlags
(
preciseFlags
)
{
