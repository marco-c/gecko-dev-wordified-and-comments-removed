...
cacheIRReader
.
argsForGuardObjectFuseProperty
(
)
;
#
...
cacheIRReader
.
argsForLoadTypedArrayElementExistsResult
(
)
;
JSObject
...
cacheIRReader
.
argsForLoadTypedArrayElementResult
(
)
;
JSObject
...
cacheIRReader
.
argsForGuardNumberToIntPtrIndex
(
)
;
BOUNDSCHECK
