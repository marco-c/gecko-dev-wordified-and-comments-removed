...
:
:
NewObjectWithGivenTaggedProtoAndAllocSite
(
JSContext
*
cx
...
:
:
experimental_weakrefs_expose_cleanupSome
(
)
&
&
...
:
:
experimental_arraybuffer_immutable
(
)
)
{
...
:
:
experimental_iterator_chunking
(
)
&
&
...
:
:
experimental_iterator_includes
(
)
&
&
...
:
:
experimental_error_capture_stack_trace
(
)
&
&
...
:
:
experimental_error_stack_trace_limit
(
)
&
&
...
-
>
hasActiveAutoSetNewObjectMetadata
(
)
)
;
