...
static
bool
AppendAndInvalidateScriptIfObservable
(
JSContext
*
cx
...
:
:
hasAnyLiveHooksThatObserveAllExecution
(
)
const
{
...
;
return
hasAnyHooksThatObserveAllExecution
(
)
;
}
...
:
:
anyOtherDebuggerObservingAllExecution
(
GlobalObject
*
global
...
-
>
unsetDebugObservesAllExecution
(
)
;
}
