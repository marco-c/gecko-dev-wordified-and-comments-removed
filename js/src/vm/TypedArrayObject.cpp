...
;
class
TypedArrayObjectAdapter
{
public
:
typedef
TypedArrayObject
TypedArrayObjectType
;
typedef
ArrayBufferObject
ArrayBufferObjectType
;
typedef
NativeType
ElementType
...
=
=
Uint8ClampedArray_lengthGetter
;
case
Scalar
:
