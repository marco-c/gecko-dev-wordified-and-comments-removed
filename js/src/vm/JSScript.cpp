...
reader
.
getMutableForDelayedConvertToCompressedSource
(
)
;
sourceData
...
const
size_t
MinimumSizeForOptimisticAllocation
=
5000
;
bool
allocateOptimistically
=
inputBytes
>
MinimumSizeForOptimisticAllocation
...
setStencilsFlag
<
STENCILS_COLLECTING_DELAZIFICATIONS_FLAG
>
(
)
;
...
setStencilsFlag
<
STENCILS_SHARING_DELAZIFICATIONS_FLAG
>
(
)
;
