...
struct
AtomicLoopBodyAnalysis
{
bool
fixed_length_eligible
=
false
;
bool
...
constexpr
int
kContinuationAlwaysSucceedsBudget
=
1000
;
bool
ContinuationAlwaysSucceeds
(
Node
*
node
...
struct
AtomicLoopContinuationAnalysis
{
bool
at_end_accept
=
