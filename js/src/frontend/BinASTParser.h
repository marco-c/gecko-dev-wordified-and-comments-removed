...
:
:
isInvalidKindPossible
;
using
Base
:
:
isInvalidVariantPossible
;
public
:
JS
...
*
>
parseSumAssignmentTargetOrForInOfBinding
(
const
size_t
start
...
*
>
parseSumExpressionOrSpreadElement
(
const
size_t
start
...
*
>
parseSumExpressionOrVariableDeclaration
(
const
size_t
start
