...
Ok
>
parseAssertedPositionalParameterName
(
AssertedScopeKind
scopeKind
MutableHandle
...
Ok
>
parseAssertedRestParameterName
(
AssertedScopeKind
scopeKind
MutableHandle
...
*
>
parseEagerArrowExpressionWithExpression
(
)
;
JS
...
*
>
parseEagerArrowExpressionWithFunctionBody
(
)
;
JS
...
*
>
parseLazyArrowExpressionWithExpression
(
)
;
JS
...
*
>
parseLazyArrowExpressionWithFunctionBody
(
)
;
JS
...
Ok
>
parseInterfaceAssertedParameterName
(
const
size_t
start
...
Ok
>
parseInterfaceAssertedRestParameterName
(
const
size_t
start
