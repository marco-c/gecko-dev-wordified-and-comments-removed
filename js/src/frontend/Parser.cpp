...
-
>
setIneligibleForArgumentsLength
(
)
;
}
...
error
(
JSMSG_USING_OUTSIDE_BLOCK_OR_MODULE
)
;
return
false
...
:
Colon
JSMSG_COLON_AFTER_ATTRIBUTE_KEY
)
)
{
return
...
:
String
JSMSG_WITH_CLAUSE_STRING_LITERAL
)
)
{
return
...
error
(
JSMSG_DECLARATION_AFTER_IMPORT_SOURCE
)
;
return
errorResult
...
error
(
JSMSG_DECORATOR_FUZZING_UNSAFE
)
;
return
false
