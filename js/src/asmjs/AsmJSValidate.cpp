...
offset
=
sourceOffsetFromBytecodePosition
(
pos
)
;
...
BINARY_ARITH_FLOAT32X4_SIMD_OP
(
OP_CHECK_CASE_LIST_
)
#
...
;
case
AsmJSSimdOperation_extractLane
:
return
CheckSimdExtractLane
(
...
;
case
AsmJSSimdOperation_replaceLane
:
return
CheckSimdReplaceLane
(
...
static
void
GenerateCheckForHeapDetachment
(
ModuleCompiler
&
m
