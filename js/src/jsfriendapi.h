...
#
define
JS_CHECK_STACK_SIZE_WITH_TOLERANCE
(
limit
sp
tolerance
...
#
define
JS_CHECK_STACK_SIZE_WITH_INTOLERANCE
(
limit
sp
intolerance
...
JS_NewSharedInt8ArrayWithBuffer
(
JSContext
*
cx
...
JS_NewSharedUint8ClampedArrayWithBuffer
(
JSContext
*
cx
...
JS_NewSharedInt16ArrayWithBuffer
(
JSContext
*
cx
...
JS_NewSharedUint16ArrayWithBuffer
(
JSContext
*
cx
...
JS_NewSharedUint32ArrayWithBuffer
(
JSContext
*
cx
...
JS_NewSharedFloat32ArrayWithBuffer
(
JSContext
*
cx
...
SharedUint8ClampedArrayClassPtr
;
extern
JS_FRIEND_DATA
(
...
GetObjectEnvironmentObjectForFunction
(
JSFunction
*
fun
