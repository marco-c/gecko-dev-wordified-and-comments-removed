...
#
ifdef
DEBUG_RECORDING_STATUS_NOT_BOOL
struct
RecordingStatus
{
int
...
LIns
*
non_double_object_value_has_type
(
nanojit
:
:
...
JS_REQUIRES_STACK
RecordingStatus
guardPrototypeHasNoIndexedProperties
(
JSObject
*
obj
...
friend
class
AdjustCallerGlobalTypesVisitor
;
friend
class
AdjustCallerStackTypesVisitor
;
friend
class
TypeCompatibilityVisitor
;
friend
class
...
JS_INLINE
void
AbortRecordingIfUnexpectedGlobalWrite
(
JSContext
*
cx
