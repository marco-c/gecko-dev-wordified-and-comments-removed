...
static
bool
IsPromiseWithDefaultProperties
(
PromiseObject
*
promise
...
void
initIncumbentGlobalRepresentative
(
const
Value
&
...
void
setEnqueueGlobalRepresentative
(
JSObject
*
obj
...
:
:
experimental_promise_safe_resolve
(
)
?
2
...
static
bool
EnqueuePromiseReactionJobCrossRealm
(
JSContext
*
cx
...
static
bool
EnqueuePromiseReactionJobSameRealm
(
JSContext
*
cx
...
5
>
optionalHostDefinedDataIsOptimizedOut
(
roots
nullptr
)
...
static
bool
Promise_static_allSettledKeyed
(
JSContext
*
cx
...
static
bool
CommonPerformIterPromiseCombinator
(
JSContext
*
cx
...
<
typename
CreateElementFunctionsCallback
>
[
[
nodiscard
...
static
bool
CommonPerformPromiseKeyedCombinator
(
JSContext
*
cx
...
static
bool
PromiseAllKeyedResolveElementFunction
(
JSContext
*
cx
...
static
bool
PromiseAllSettledKeyedResolveElementFunction
(
JSContext
*
cx
...
static
bool
PromiseAllSettledKeyedRejectElementFunction
(
JSContext
*
cx
...
(
cx
JSMSG_UNHANDLABLE_PROMISE_RESOLUTION_WARNING
)
)
{
if
...
(
"
DEFAULT_RESOLVING_FUNCTIONS_ALREADY_RESOLVED
"
)
;
break
...
(
"
REQUIRES_USER_INTERACTION_HANDLING
"
)
;
break
...
(
"
HAD_USER_INTERACTION_UPON_CREATION
"
)
;
break
...
JSObject
*
maybeIncumbentGlobalRepresentative
=
task
-
>
...
JSObject
*
unwrappedIncumbentGlobalRepresentative
=
CheckedUnwrapStatic
(
maybeIncumbentGlobalRepresentative
