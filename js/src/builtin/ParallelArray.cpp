...
js_GetErrorMessage
NULL
JSMSG_PAR_ARRAY_MAP_INVALID_ARG
buffer
)
;
return
...
js_GetErrorMessage
NULL
JSMSG_PAR_ARRAY_SCATTER_INVALID_VEC
)
;
return
false
