...
static
int
DEBUG_WrappedNativeTearOffChunkCounts
[
DEBUG_CHUNKS_TO_COUNT
+
1
...
#
ifdef
XPC_DETECT_LEADING_UPPERCASE_ACCESS_ERRORS
void
XPCWrappedNative
:
:
HandlePossibleNameCaseError
(
JSContext
*
cx
...
-
>
ClearWrappedNativeThreadsafetyReportDepth
(
)
;
}
