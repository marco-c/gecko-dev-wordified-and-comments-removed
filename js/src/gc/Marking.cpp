...
:
:
PerformIncrementalPreWriteBarrierAllChildren
(
JSObject
*
cell
...
Black
?
blackMainThreadBuffer_
.
ref
(
)
:
grayMainThreadBuffer_
.
ref
(
)
...
:
Gray
AllowGrayMarkingBeforeEndOfBlackMarking
:
:
Yes
)
...
:
:
enterConcurrentMarkingMode
(
)
{
setMarkingStateAndTracer
<
ConcurrentMarkingTracer
>
(
RegularMarking
ConcurrentMarking
