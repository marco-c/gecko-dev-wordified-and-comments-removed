...
#
define
FOR_EACH_NURSERY_PROFILE_COMMON_METADATA
(
_
)
\
...
#
define
FOR_EACH_NURSERY_PROFILE_SLICE_METADATA
(
_
)
\
...
#
define
FOR_EACH_NURSERY_PROFILE_METADATA
(
_
)
\
...
constexpr
size_t
NurserySliceMetadataFormatWidth
(
)
{
size_t
