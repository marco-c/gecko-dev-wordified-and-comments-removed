...
>
DenseElementResult
GetBoxedOrUnboxedDenseElements
(
JSObject
*
aobj
...
{
GetBoxedOrUnboxedDenseElementsFunctor
functor
(
aobj
length
...
{
ArrayReverseDenseKernelFunctor
functor
(
cx
obj
...
inline
DenseElementResult
ShiftMoveBoxedOrUnboxedDenseElements
(
JSObject
*
obj
...
;
ShiftMoveBoxedOrUnboxedDenseElementsFunctor
functor
(
obj
)
...
const
size_t
EagerPreliminaryObjectAnalysisThreshold
=
800
;
if
