...
;
bool
isRealmIndependentJitCodeShared
=
...
handler
.
needsProfilerCallSiteInstrumentation
(
)
)
{
...
;
emitGuardedCallPreBarrierAnyZone
(
address
MIRType
:
