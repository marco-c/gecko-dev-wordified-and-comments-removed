...
reader
.
argsForCallBoundScriptedFunction
(
)
;
flags
...
reader
.
argsForCallInlinedBoundFunction
(
)
;
flags
...
reader
.
argsForCallScriptedGetterResult
(
)
;
ObjOperandId
...
reader
.
argsForCallInlinedGetterResult
(
)
;
ObjOperandId
