...
writer
.
saveScriptedGetterSetterCallee
(
functionId
)
;
...
if
(
canOptimizeConstantAccessorProperty
(
holder
prop
&
...
;
emitGuardConstantAccessorProperty
(
holder
holderId
id
...
attached
=
tryAttachInlinableNativeGetter
(
holder
prop
receiverId
...
:
:
canOptimizeConstantDataProperty
(
NativeObject
*
holder
...
:
:
emitConstantDataPropertyResult
(
NativeObject
*
holder
...
writer
.
checkWeakValueResultForFixedSlot
(
holderId
offset
result
...
writer
.
checkWeakValueResultForDynamicSlot
(
holderId
offset
result
...
(
"
CanOptimizeStringProtoSymbolLookup
.
Optimized
"
)
...
writer
.
dateHoursFromSecondsIntoYearResult
(
secondsIntoYearValId
)
;
...
writer
.
dateSecondsFromSecondsIntoYearResult
(
secondsIntoYearValId
)
;
...
:
:
GetTemplateObjectForBufferView
(
cx_
tarr
)
...
:
:
tryAttachSharedArrayBufferByteLength
(
)
{
if
...
:
:
tryAttachTypedArrayConstructorFromLength
(
)
{
MOZ_ASSERT
...
(
"
TypedArrayConstructorFromLength
"
)
;
return
...
:
:
tryAttachTypedArrayConstructorFromArrayBuffer
(
)
{
MOZ_ASSERT
...
(
"
TypedArrayConstructorFromArrayBuffer
"
)
;
return
...
:
:
tryAttachTypedArrayConstructorFromArray
(
)
{
MOZ_ASSERT
...
(
"
TypedArrayConstructorFromArray
"
)
;
return
...
writer
.
newMapObjectFromIterableResult
(
templateObj
iterableId
)
...
writer
.
newSetObjectFromIterableResult
(
templateObj
iterableId
)
...
&
!
BytecodeGetOpCanHaveInlinableNative
(
op
(
)
...
static
void
EmitGuardPropertyIsNativeFunction
(
CacheIRWriter
&
writer
