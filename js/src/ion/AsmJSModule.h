...
unsigned
globalVarIndexToGlobalDataOffset
(
unsigned
i
)
...
unsigned
funcPtrIndexToGlobalDataOffset
(
unsigned
i
)
...
void
convertBoundsChecksToActualOffset
(
ion
:
:
