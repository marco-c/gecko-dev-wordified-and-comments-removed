...
-
>
visitOutOfLineParCheckInterrupt
(
this
)
;
...
(
*
NewInitObjectWithClassPrototypeFn
)
(
JSContext
*
...
const
VMFunction
NewInitObjectWithClassPrototypeInfo
=
FunctionInfo
<
NewInitObjectWithClassPrototypeFn
