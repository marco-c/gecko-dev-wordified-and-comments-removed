...
:
:
LOp_GetElementCacheV
:
return
codegen
-
>
visitOutOfLineGetElementCache
(
this
)
;
...
:
:
LOp_SetPropertyCacheT
:
case
LInstruction
:
:
LOp_SetPropertyCacheV
:
return
codegen
-
...
:
:
LOp_CallsiteCloneCache
:
return
codegen
-
>
visitOutOfLineCallsiteCloneCache
(
this
)
;
