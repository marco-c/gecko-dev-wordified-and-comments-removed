...
;
bool
writeIntoRequestBufferCBCalled
=
false
;
bool
cancelStreamCBCalled
=
false
;
Value
...
;
bool
finalizeStreamCBCalled
=
false
;
void
*
finalizedStreamUnderlyingSource
;
static
StubExternalUnderlyingSource
instance
