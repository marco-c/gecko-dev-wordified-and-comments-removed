...
fail
(
JSMSG_CANT_DEFINE_WINDOW_NAMED_PROPERTY
)
;
}
JS_PUBLIC_API
...
static
void
ReleaseAssertObjectHasNoWrappers
(
JSContext
*
cx
...
static
bool
SkipSharedArrayBufferConstructor
(
JSProtoKey
key
GlobalObject
...
static
bool
EnumerateStandardClassesInTable
(
JSContext
*
cx
...
static
bool
gProfileTimelineRecordingEnabled
=
false
;
JS_PUBLIC_API
...
;
case
JSJITCOMPILER_PORTABLE_BASELINE_WARMUP_THRESHOLD
:
if
(
value
...
static
bool
GetScriptedCallerActivationRealmFast
(
JSContext
*
cx
