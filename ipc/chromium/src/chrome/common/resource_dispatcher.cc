...
(
new
ViewHostMsg_UploadProgress_ACK
(
message
.
routing_id
...
IPC_MESSAGE_HANDLER
(
ViewMsg_Resource_ReceivedResponse
OnReceivedResponse
)
IPC_MESSAGE_HANDLER
(
ViewMsg_Resource_ReceivedRedirect
OnReceivedRedirect
)
IPC_MESSAGE_HANDLER
(
ViewMsg_Resource_DataReceived
OnReceivedData
)
IPC_MESSAGE_HANDLER
(
