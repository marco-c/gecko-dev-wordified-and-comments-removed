...
:
:
DeallocPBackgroundSDBConnectionChild
(
PBackgroundSDBConnectionChild
*
aActor
...
:
:
DeallocPBackgroundLSObjectChild
(
PBackgroundLSObjectChild
*
aActor
...
:
:
AllocPRemoteWorkerServiceChild
(
)
{
RefPtr
...
:
:
DeallocPRemoteWorkerServiceChild
(
dom
:
:
...
:
:
AllocPHttpBackgroundChannelChild
(
const
uint64_t
&
...
:
:
DeallocPHttpBackgroundChannelChild
(
PHttpBackgroundChannelChild
*
aActor
...
:
:
DeallocPServiceWorkerContainerChild
(
PServiceWorkerContainerChild
*
aActor
...
:
:
DeallocPServiceWorkerRegistrationChild
(
PServiceWorkerRegistrationChild
*
aActor
