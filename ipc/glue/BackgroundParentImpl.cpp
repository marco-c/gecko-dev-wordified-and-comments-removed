...
:
:
AllocPRemoteWorkerServiceParent
(
)
{
return
...
:
:
RecvPRemoteWorkerServiceConstructor
(
PRemoteWorkerServiceParent
*
aActor
...
:
:
RecvPSelectTLSClientAuthCertConstructor
(
PSelectTLSClientAuthCertParent
*
actor
...
:
:
AllocPWebSocketConnectionParent
(
const
uint32_t
&
...
:
:
RecvPWebSocketConnectionConstructor
(
PWebSocketConnectionParent
*
actor
