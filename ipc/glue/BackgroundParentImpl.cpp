...
aPrincipalInfo
in
PBackgroundLocalStorageCacheConstructor
"
)
;
}
...
&
aParentEndpoint
CreateWebTransportParentResolver
&
&
aResolver
)
...
:
:
RecvPTemporaryIPCBlobConstructor
(
dom
:
:
...
:
:
dom_udpsocket_max_per_background
(
)
)
)
...
:
:
RecvGetSessionStorageManagerData
(
const
uint64_t
&
...
:
:
RecvLoadSessionStorageManagerData
(
const
uint64_t
&
...
:
:
AllocPGamepadEventChannelParent
(
)
{
return
...
:
:
AllocPGamepadTestChannelParent
(
)
{
return
...
:
:
AllocPHttpBackgroundChannelParent
(
const
uint64_t
&
...
:
:
RecvCreateBoundStorageKeyParent
(
Endpoint
<
:
...
:
:
RecvPServiceWorkerManagerConstructor
(
PServiceWorkerManagerParent
*
const
...
:
:
RecvPServiceWorkerContainerConstructor
(
PServiceWorkerContainerParent
*
aActor
...
(
EnsureRDDProcessAndCreateBridgeResolver
&
&
aResolver
)
