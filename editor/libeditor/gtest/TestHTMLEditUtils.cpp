...
(
HTMLEditUtilsTest
GetPreviousLeafContent_Content
)
{
using
LeafNodeOption
...
:
:
IsBRElementFollowingLineBoundary
(
*
brElement
)
...
const
ExpectedData
mExpectedIfPaddingForEmptyBlockSignificant
;
const
ExpectedData
mExpectedIfPaddingForEmptyBlockUnnecessary
;
friend
std
:
