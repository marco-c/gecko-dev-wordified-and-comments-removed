...
nsIContentURIGrouper
>
hostnameGrouperService
=
do_GetService
(
NS_HOSTNAME_GROUPER_SERVICE_CONTRACTID
)
;
if
(
...
visitor
;
NS_GetRadioSetCheckedChangedVisitor
(
aCheckedChanged
getter_AddRefs
(
...
rv
=
NS_GetRadioGetCheckedChangedVisitor
(
&
checkedChanged
this
