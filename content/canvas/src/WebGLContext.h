...
;
struct
BackbufferClearingStatus
{
enum
{
NotClearedSinceLastPresented
ClearedToDefaultValues
HasBeenDrawnTo
}
;
}
...
void
InvalidateCachedMaxElements
(
)
{
mHasCachedMaxUbyteElement
=
false
;
mHasCachedMaxUshortElement
=
false
;
}
...
bool
IsIncompatibleWithAttachmentPoint
(
)
const
{
...
nsIMemoryReporter
>
mBufferMemoryUsageReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mBufferCacheMemoryUsageReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mBufferCountReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mRenderbufferMemoryUsageReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mRenderbufferCountReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mShaderSourcesSizeReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mShaderTranslationLogsSizeReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mShaderCountReporter
;
nsCOMPtr
<
nsIMemoryReporter
>
mContextCountReporter
;
static
WebGLMemoryReporter
*
...
static
PLDHashOperator
BufferCacheMemoryUsageFunction
(
const
PRUint32
&
...
{
PRInt64
bufferCacheMemoryUsageForThisContext
=
0
;
contexts
...
static
PLDHashOperator
RenderbufferMemoryUsageFunction
(
const
PRUint32
&
...
static
PLDHashOperator
ShaderTranslationLogSizeFunction
(
const
PRUint32
&
...
{
PRInt64
shaderSourcesSizeForThisContext
=
0
;
contexts
...
{
PRInt64
shaderTranslationLogsSizeForThisContext
=
0
;
contexts
