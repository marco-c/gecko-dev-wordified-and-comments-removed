...
#
define
TIMEOUT_WAIT_FOR_CLOSING
20000
#
define
ENSURE_TRUE_AND_FAIL_IF_FAILED
(
x
ret
)
...
#
define
CHECK_SUCCESS_AND_FAIL_IF_FAILED
(
res
)
\
...
#
define
CHECK_SUCCESS_AND_FAIL_IF_FAILED2
(
res
)
\
...
#
define
DECL_RUNNABLE_ON_MAIN_THREAD_METHOD
(
_method
)
\
...
static
void
TimerInitialServerResponseCallback
(
nsITimer
*
aTimer
...
;
Mutex
mLockOutgoingMessages
;
Mutex
mLockReceivedMessages
;
nsCOMPtr
<
nsISocketTransport
...
;
PRUint32
mBytesAlreadySentOfFirstOutString
;
PRUint32
mOutgoingBufferedAmount
;
...
#
define
NS_WEBSOCKET_IMPL_DOMEVENTLISTENER
(
_eventlistenername
_eventlistener
)
