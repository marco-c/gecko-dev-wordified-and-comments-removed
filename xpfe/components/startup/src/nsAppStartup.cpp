...
nsISupports
*
aNativeAppSupportOrSplashScreen
)
{
nsresult
rv
...
=
=
NS_ERROR_PROFILE_REQUIRES_INTERACTION
)
{
NS_WARNING
(
...
rv
=
CheckAndRemigrateDefunctProfile
(
)
;
NS_ASSERTION
