...
(
function
observePushTopicDeviceConnected
(
)
{
let
...
async
function
observePushTopicDeviceDisconnected_current_device
(
)
{
const
...
async
function
observePushTopicDeviceDisconnected_another_device
(
)
{
const
...
(
function
observePushTopicAccountDestroyed
(
)
{
const
...
(
function
observePushTopicProfileUpdated
(
)
{
let
...
(
function
observePushTopicPasswordChanged
(
)
{
let
...
;
const
promiseConsumeRemoteMessagesCalled
=
new
Promise
(
...
(
function
observeSubscriptionChangeTopic
(
)
{
let
