...
measurementHasAnyDailyCounterFields
:
function
(
measurementID
...
this
.
measurementHasAnyFieldsOfTypes
(
measurementID
[
this
...
measurementHasAnyDailyLastFields
:
function
(
measurementID
...
measurementHasAnyDailyDiscreteFields
:
function
(
measurementID
...
self
.
getMeasurementDailyCountersFromMeasurementID
(
id
)
;
...
self
.
getMeasurementDailyLastValuesFromMeasurementID
(
id
)
;
...
self
.
getMeasurementDailyDiscreteValuesFromMeasurementID
(
id
)
;
...
self
.
getMeasurementLastValuesFromMeasurementID
(
id
)
;
...
addDailyDiscreteNumericFromFieldID
:
function
(
fieldID
...
(
function
fetchDailyDiscreteValuesForField
(
)
{
let
...
(
function
fetchMeasurementDailyLastValues
(
)
{
let
