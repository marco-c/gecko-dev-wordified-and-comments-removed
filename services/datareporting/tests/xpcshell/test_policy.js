...
(
name
aCurrentPolicyVersion
=
1
aMinimumPolicyVersion
=
1
...
policy
.
dataSubmissionPolicyResponseDate
=
now
;
do_check_eq
...
policy
.
lastDataSubmissionSuccessfulDate
=
now
;
do_check_eq
...
(
"
initial_submission_notification
"
)
;
do_check_eq
...
policy
.
SUBMISSION_NOTIFY_INTERVAL_MSEC
-
1
)
)
...
(
"
notification_implicit_acceptance
"
)
;
let
...
policy
.
SUBMISSION_REQUEST_EXPIRE_INTERVAL_MSEC
+
100
)
)
...
(
"
data_submission_submit_failure_hard
"
)
;
policy
...
(
function
test_submission_far_future_scheduling
(
)
{
let
...
(
"
submission_far_future_scheduling
"
)
;
let
...
(
function
test_delete_remote_data_priority
(
)
{
let
...
(
function
test_delete_remote_data_backoff
(
)
{
let
...
(
"
delete_remote_data_in_progress_upload
"
)
;
let
...
(
function
test_polling_implicit_acceptance
(
)
{
let
...
(
"
record_health_report_upload_enabled
"
)
;
do_check_false
...
(
function
test_pref_change_initiates_deletion
(
)
{
let
...
function
*
triggerPolicyCheckAndEnsureNotified
(
notified
=
true
