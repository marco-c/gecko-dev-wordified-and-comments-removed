...
function
contentHandlerWithBadSignature
(
metadata
response
)
...
function
contentHandlerWithGoodSignature
(
metadata
response
)
...
add_test
(
test_channel_no_notificationCallbacks
)
;
add_test
(
...
add_test
(
test_channel_with_bad_signature_from_trusted_origin
)
;
add_test
(
test_channel_with_bad_signature
)
;
run_next_test
(
...
function
test_channel_with_good_signature
(
)
{
var
