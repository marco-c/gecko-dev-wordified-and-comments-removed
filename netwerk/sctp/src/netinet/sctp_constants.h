...
defined
(
SCTP_APPLE_MOBILITY_BASE
)
#
define
SCTP_DEFAULT_MOBILITY_BASE
0
#
else
#
...
defined
(
SCTP_APPLE_MOBILITY_FASTHANDOFF
)
#
define
SCTP_DEFAULT_MOBILITY_FASTHANDOFF
0
#
else
#
