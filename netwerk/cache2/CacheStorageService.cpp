...
:
:
network_cache_purge_minprogress_memory
(
)
)
;
...
-
>
StoreReportedMemoryConsumption
(
aCurrentMemoryConsumption
)
;
...
:
:
network_cache_purge_minprogress_disk
(
)
:
StaticPrefs
