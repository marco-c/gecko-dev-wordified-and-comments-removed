...
LOCK_TELEM
(
NSSETDISKSMARTSIZECALLBACK_NOTIFY
)
)
;
nsCacheService
...
LOCK_TELEM
(
NSCACHESERVICE_EVICTENTRIESFORCLIENT
)
)
;
nsresult
...
LOCK_TELEM
(
NSCACHESERVICE_ISSTORAGEENABLEDFORPOLICY
)
)
;
*
...
LOCK_TELEM
(
NSCACHESERVICE_GETCACHEIOTARGET
)
)
;
}
...
LOCK_TELEM
(
NSCACHESERVICE_ONPROFILESHUTDOWN
)
)
;
gService
...
LOCK_TELEM
(
NSCACHESERVICE_ONPROFILECHANGED
)
)
;
gService
...
LOCK_TELEM
(
NSCACHESERVICE_SETDISKCACHEENABLED
)
)
;
gService
...
LOCK_TELEM
(
NSCACHESERVICE_SETDISKCACHECAPACITY
)
)
;
if
...
LOCK_TELEM
(
NSCACHESERVICE_SETDISKCACHEMAXENTRYSIZE
)
)
;
if
...
LOCK_TELEM
(
NSCACHESERVICE_SETMEMORYCACHEMAXENTRYSIZE
)
)
;
if
...
LOCK_TELEM
(
NSCACHESERVICE_SETOFFLINECACHEENABLED
)
)
;
gService
...
LOCK_TELEM
(
NSCACHESERVICE_SETOFFLINECACHECAPACITY
)
)
;
if
...
LOCK_TELEM
(
NSCACHESERVICE_CLOSEALLSTREAMS
)
)
;
nsTArray
...
LOCK_TELEM
(
NSCACHESERVICE_SETDISKSMARTSIZE
)
)
;
if
...
LOCK_TELEM
(
NSCACHESERVICE_LEAVEPRIVATEBROWSING
)
)
;
gService
