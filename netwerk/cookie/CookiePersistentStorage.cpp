...
constexpr
auto
IDX_LAST_ACCESSED_INUSEC
=
5
;
constexpr
auto
IDX_CREATION_TIME_INUSEC
=
6
;
constexpr
...
constexpr
auto
IDX_PARTITIONED_ATTRIBUTE_SET
=
12
;
constexpr
auto
IDX_UPDATE_TIME_INUSEC
=
13
;
#
...
class
FetchPartitionKeyFromOAsSQLFunction
final
:
public
mozIStorageFunction
...
:
:
network_cookie_CHIPS_lastMigrateDatabase
(
)
<
StaticPrefs
:
:
network_cookie_CHIPS_migrateDatabaseTarget
(
)
)
{
...
constexpr
auto
fetchPartitionKeyFromOAsName
=
"
FETCH_PARTITIONKEY_FROM_OAS
"
_ns
;
nsresult
...
constexpr
auto
updateOAsWithPartitionHostName
=
"
UPDATE_OAS_WITH_PARTITION_HOST
"
_ns
;
rv
...
:
:
network_cookie_validation_lastEpoch
(
)
<
StaticPrefs
:
:
network_cookie_validation_epoch
(
)
)
{
...
:
:
network_cookie_db_journalOverheadBytes
(
)
)
;
