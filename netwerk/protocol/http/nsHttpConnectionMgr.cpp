...
:
:
network_http_http2_aggressive_coalescing
(
)
)
{
...
-
>
ForgetConnectionAttemptAndActiveConn
(
)
;
if
...
MaybeRemoveEntryFromPendingSet
(
ent
)
;
...
;
return
TryDispatchExtendedCONNECTransaction
(
ent
trans
h2Tunnel
...
:
:
network_trr_high_priority_events
(
)
)
{
...
:
:
network_trr_preserve_on_background
(
)
;
for
...
-
>
OnPendingTransactionRemovedFromTable
(
)
;
}
