...
static
void
HandleVersionExperimentEnrollment
(
const
char
*
...
:
:
general_useragent_forceVersion100
(
)
)
{
...
static
void
GetExperimentUserAgent
(
nsACString
*
aExperimentUserAgent
)
{
if
(
...
:
:
network_http_useragent_forceVersion
(
)
;
if
