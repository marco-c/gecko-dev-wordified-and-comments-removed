...
:
:
network_http_skip_alt_svc_validation_on_https_rr
(
)
)
{
...
do_CreateInstance
(
NS_WELLKNOWNOPPORTUNISTICUTILS_CONTRACTID
)
;
bool
accepted
...
:
:
AltsvcMappingChangedTargetLabel
:
:
eFalse
)
