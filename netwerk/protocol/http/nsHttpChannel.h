...
;
nsresult
ContinueHandleAsyncReplaceWithProxy
(
nsresult
)
;
...
typedef
PRUint32
CloseCacheEntryFlags
;
enum
{
CLOSE_CACHE_ENTRY_NO_FLAGS
=
0
CLOSE_CACHE_ENTRY_DOOM_ON_FAILURE
=
(
1
<
...
;
nsresult
AsyncRedirectChannelToHttps
(
)
;
nsresult
ContinueAsyncRedirectChannelToHttps
(
nsresult
rv
)
