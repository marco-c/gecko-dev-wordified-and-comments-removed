...
-
>
GetAssociatedPictureInPictureWindow
(
)
)
;
...
:
:
AssociatePictureInPictureWindowWith
(
aVideo
pipWindowInstance
)
...
-
>
SetAssociatedPictureInPictureWindow
(
mPictureInPictureWindowInstance
)
;
