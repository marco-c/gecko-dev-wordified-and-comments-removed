...
static
void
nr_ice_candidate_pair_restart_stun_role_change_cb
(
NR_SOCKET
s
int
...
static
void
nr_ice_candidate_pair_compute_codeword
(
nr_ice_cand_pair
*
pair
...
r
=
nr_ice_candidate_compute_priority
(
&
tmpcand
)
...
flags
&
NR_ICE_CTX_FLAGS_ALLOW_LOOPBACK
)
)
{
flags
...
flags
&
NR_ICE_CTX_FLAGS_ALLOW_LINK_LOCAL
)
)
{
flags
...
int
nr_ice_candidate_pair_unfreeze
(
nr_ice_peer_ctx
*
pctx
...
{
nr_ice_candidate_pair_update_rtt
(
pair
pair
-
...
r
=
nr_ice_media_stream_unfreeze_pairs_foundation
(
pair
-
>
...
static
int
nr_ice_candidate_copy_for_triggered_check
(
nr_ice_cand_pair
*
pair
...
void
nr_ice_candidate_pair_dump_state
(
nr_ice_cand_pair
*
pair
