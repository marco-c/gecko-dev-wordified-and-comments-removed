...
#
define
TURN_PERMISSION_LIFETIME_SECONDS
300
/
*
5
...
#
define
REFRESH_RESERVATION_ON_RECV
1
static
int
nr_turn_stun_ctx_create
(
nr_turn_client_ctx
*
tctx
...
static
void
nr_turn_client_refresh_timer_cb
(
NR_SOCKET
s
int
...
static
int
nr_turn_client_start_refresh_timer
(
nr_turn_client_ctx
*
ctx
...
static
int
nr_turn_client_send_stun_request
(
nr_turn_client_ctx
*
ctx
...
;
int
nr_transport_addr_listnode_create
(
const
nr_transport_addr
*
...
abort
:
nr_transport_addr_listnode_destroy
(
&
listnode
)
...
static
int
nr_turn_stun_ctx_handle_redirect
(
nr_turn_stun_ctx
*
ctx
