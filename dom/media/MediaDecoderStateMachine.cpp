...
:
:
media_seek_resume_audio_preroll_usecs
(
)
)
:
...
:
:
media_seek_resume_video_preroll_frames_hw
(
)
:
StaticPrefs
:
:
media_seek_resume_video_preroll_frames_sw
(
)
;
}
...
:
:
media_video_queue_send_to_compositor_size
(
)
)
;
...
:
:
media_video_queue_hw_accel_size
(
)
MIN_VIDEO_QUEUE_SIZE
)
...
:
:
media_video_queue_default_size
(
)
MIN_VIDEO_QUEUE_SIZE
)
