...
{
RemoveOptionFromListBoxSelection
(
*
option
)
...
(
"
SelectedContentTextMightHaveChangedAfterRemoval
"
this
&
HTMLSelectElement
...
UpdateListBoxSelectionAfterKeyEvent
(
aNewIndex
aCharCode
aIsShift
...
mListBoxSelectionChangedSinceDragStart
=
PerformListBoxSelection
(
option
...
class
SelectedContentUpdateMicrotask
final
:
public
MicroTaskRunnable
...
CloneOptionIntoSelectedContent
(
option
aSelectedContent
)
