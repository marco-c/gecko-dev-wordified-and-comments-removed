...
static
void
DoComputeMissingKeyframeOffsets
(
nsTArray
<
Keyframe
...
OffsetType
>
ValidateKeyframeOffset
(
const
dom
:
:
OwningDoubleOrCSSNumericValueOrTimelineRangeOffsetOrUTF8String
&
aOffset
ErrorResult
&
...
*
>
keyframesWithDoubleOrNullOffsets
;
bool
hasTimelineRangeOffset
=
false
;
bool
hasNullOrPercentageOffset
=
false
;
for
