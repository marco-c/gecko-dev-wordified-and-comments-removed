...
#
define
INSTANTIATE_METHOD_FOR_CONST_RANGE_BOUNDARY_REFS
(
\
aResultType
aMethodName
...
constexpr
(
ShouldHandleAssignedNodesOnSlot
<
aKind
>
(
...
static
bool
ChildNodeIsInShadowDOMHostedByParent
(
const
nsINode
*
...
>
void
WarnIfClosestCommonAncestorChildrenAreNotInChildList
(
)
const
{
WarnIfClosestCommonAncestorChildIsNotInChildList
<
aKind
>
(
...
const
auto
ChildIndexIsLessThanTheOtherChildIndex
=
[
]
(
...
aRemovingNode
.
DevToolsShouldBeNotifiedOfThisRemoval
(
)
)
)
...
:
:
dom_security_html_serialization_escape_lt_gt
(
)
)
{
...
static
void
AppendEncodedAtomAttributeValue
(
nsAtom
*
aAtom
...
:
:
dom_shadowdom_shadowRootSlotAssignment_enabled
(
)
&
&
