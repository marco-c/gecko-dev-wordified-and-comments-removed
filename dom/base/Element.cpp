...
MOZ_ALWAYS_INLINE
void
AssertNotObservedByLazyLoadObserver
(
Element
&
aElement
...
{
UpdateContainerTimingRootFromParent
(
&
aParent
)
...
MOZ_ALWAYS_INLINE
void
SetLifecycleCallbackNamespaceURI
(
LifecycleCallbackArgs
&
aArgs
...
bool
&
aIsPendingMappedAttributeEvaluation
)
{
MOZ_ASSERT
(
...
SetUseCounter
(
eUseCounter_custom_RequestedKeyboardLock
)
;
}
auto
