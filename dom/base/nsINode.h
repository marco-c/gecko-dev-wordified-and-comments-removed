...
NODE_HAS_SCHEDULED_SELECTION_CHANGE_EVENT
=
NODE_FLAG_BIT
(
13
...
<
7
RelativeSelectorAnchorNonSubject
=
1
<
<
...
ShadowRoot
*
GetContainingShadowForSelection
(
)
const
;
...
ShadowRoot
*
GetClosestShadowRootInFlattenedTree
(
)
const
;
...
ShadowRoot
*
GetClosestShadowRootInFlattenedTreeForSelection
(
)
const
;
...
void
ClearHasScheduledSelectionChangeEvent
(
)
{
UnsetFlags
...
nsIContent
*
GetFlattenedTreePreviousSibling
(
)
const
=
...
nsIContent
*
GetFlattenedTreeNextSiblingForSelection
(
)
const
=
...
nsIContent
*
GetFlattenedTreePreviousSiblingForSelection
(
)
const
=
