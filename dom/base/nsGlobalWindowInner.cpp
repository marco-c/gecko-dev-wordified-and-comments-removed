...
dom
/
WindowOrWorkerGlobalScopeBinding
.
h
"
#
...
:
:
dom_about_blank_ckeditor_hack_enabled
(
)
&
&
...
:
:
dom_about_blank_gwt_hack_enabled
(
)
&
&
...
:
:
dom_about_blank_polarion_gwt_hack_enabled
(
)
&
&
...
:
:
dom_about_blank_ze_hack_enabled
(
)
&
&
...
static
bool
NeedsAsyncLoadEventForInitialDocument
(
nsGlobalWindowInner
&
aInner
...
SetUseCounter
(
eUseCounter_custom_ComponentsShimResolved
)
;
}
...
:
:
UpdateSharedWorkersLanguageOverride
(
const
nsCString
&
...
-
>
OnPointerRawUpdateEventListenerAdded
(
this
)
;
