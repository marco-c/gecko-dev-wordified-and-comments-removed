...
mStorageGrantedOriginPopulated
(
false
)
{
...
{
SaveFirstPartyStorageAccessGrantedFor
(
aOrigin
)
;
...
for
(
StorageGrantedOrigin
&
data
:
mStorageGrantedOrigins
)
{
if
(
...
extern
void
SendFirstPartyStorageAccessGrantedForOriginToParentProcess
(
nsIPrincipal
*
aPrincipal
