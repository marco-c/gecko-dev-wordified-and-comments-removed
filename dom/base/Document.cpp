...
mSuppressNotifyingDevToolsOfNodeRemovals
(
false
)
...
mPageloadEventData
.
set_scriptFromNeckoText
(
mScriptLoader
-
>
GetLoadedFromNeckoAsText
(
)
)
;
mPageloadEventData
.
set_scriptFromNeckoSerialized
(
mScriptLoader
-
>
GetLoadedFromNeckoAsSerializedStencil
(
)
)
;
...
mPageloadEventData
.
set_scriptMemoryCacheRevived
(
mScriptLoader
-
>
GetMemoryCacheRevived
(
)
)
;
mPageloadEventData
.
set_scriptMemoryCacheEvictedDirty
(
mScriptLoader
-
>
GetMemoryCacheEvictedDirty
(
)
)
;
...
NS_IMPL_CYCLE_COLLECTION_TRAVERSE
(
mPictureInPictureElement
)
NS_IMPL_CYCLE_COLLECTION_TRAVERSE
(
mPopoverHintStackParent
)
DocumentOrShadowRoot
:
:
...
:
:
security_chrome_baseline_csp_enabled
(
)
)
{
...
static
void
MaybeInvalidateDocumentNameListForImageElementName
(
Document
&
aDoc
...
:
:
network_cookie_CHIPS_affectsTCP
(
)
&
&
...
:
:
ComputeInputForIframeThrottling
(
*
el
-
...
(
"
LazyCreateCSSAndStyleImageLoaders
"
DOM
MarkerStack
:
...
:
:
WindowInitializeReportingEndpoints
(
mScriptGlobalObject
mozilla
:
...
:
:
ProcessReportingEndpointsListFromResponse
(
httpChannel
)
)
...
:
:
DispatchExitPictureInPictureRunnable
(
nullptr
element
)
...
static
void
DispatchFullscreenUpdateKeyboardLockEvent
(
Document
*
aDoc
...
nullptr
;
SetFullscreenKeyboardLockStatus
(
...
:
:
SetLastDialogPointerdownTarget
(
HTMLDialogElement
&
aElement
...
;
bool
hintPopoverListContainsElement
=
IsInPopoverListOf
(
*
...
static
void
SetKeyboardLockStatusAndMaybeDispatchEvent
(
Document
*
aDoc
...
aRequest
.
ShouldDispatchKeyboardLockEvent
(
)
)
{
...
-
>
SetShouldDispatchKeyboardLockEvent
(
aRequest
-
>
...
:
:
dom_viewTransitions_cross_document_enabled
(
)
)
{
...
:
:
ShadowedHtmlDocumentPropertyAccessExtra
extra
=
{
}
...
;
bool
alreadyHadUserInteractionPermission
=
ContentBlockingUserInteraction
:
:
...
static
void
PropagateUserGestureActivationBetweenPiP
(
BrowsingContext
*
currentBC
...
aOptions
.
IsViewTransitionUpdateCallback
(
)
)
{
...
aOptions
.
GetAsViewTransitionUpdateCallback
(
)
;
}
...
aOptions
.
GetAsStartViewTransitionOptions
(
)
;
cb
...
nav
=
Servo_ViewTransitionRule_GetNavigationDescriptor
(
matchingRule
)
;
...
atoms
;
Servo_ViewTransitionRule_GetTypes
(
matchingRule
&
atoms
...
:
:
SetInboundViewTransitionParams
(
UniquePtr
<
...
:
:
SetMeasuringExecutionTimeEnabled
(
cx
true
)
...
:
:
HasFullscreenKeyboardLockEnabled
(
)
{
Element
