...
;
class
nsPhysicalSelectMoveScrollCommand
:
public
nsSelectionCommandsBase
{
...
NS_DECL_CLIPBOARD_COMMAND
(
nsClipboardCopyLinkCommand
)
NS_DECL_CLIPBOARD_COMMAND
(
nsClipboardImageCommands
)
NS_DECL_CLIPBOARD_COMMAND
(
nsClipboardSelectAllNoneCommands
)
nsresult
nsClipboardCopyLinkCommand
:
