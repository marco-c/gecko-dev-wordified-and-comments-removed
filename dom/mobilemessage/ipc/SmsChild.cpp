...
void
NotifyObserversWithMobileMessage
(
const
char
*
...
aReply
.
get_ReplyGetSegmentInfoForText
(
)
;
mReplyRequest
...
:
:
TReplyGetSegmentInfoForTextFail
:
mReplyRequest
-
>
...
aReply
.
get_ReplyGetSegmentInfoForTextFail
(
)
.
error
...
:
:
TReplySetSmscAddress
:
mReplyRequest
-
>
NotifySetSmscAddress
(
)
;
break
...
:
:
TReplySetSmscAddressFail
:
mReplyRequest
-
>
NotifySetSmscAddressFailed
(
aReply
.
get_ReplySetSmscAddressFail
(
)
.
error
...
:
:
TMobileMessageArrayData
:
DoNotifyResult
(
aData
.
get_MobileMessageArrayData
(
)
.
messages
