...
do_GetService
(
MOBILE_MESSAGE_DATABASE_SERVICE_CONTRACTID
)
;
if
(
...
Sequence
<
OwningLongOrSmsMessageOrMmsMessage
>
&
aParams
ErrorResult
...
entry
=
MobileMessageFilterDeliveryValues
:
:
strings
[
