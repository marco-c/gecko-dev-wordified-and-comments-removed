...
FileAvoidWrite
def
build_files_for_webidl_worker_init
(
state
)
:
...
state
def
build_files_for_webidl_worker_run
(
filename
)
:
...
oldDictionariesConvertibleToJS
=
self
.
_state
...
changedDictionaryNames
=
oldDictionariesConvertibleToJS
^
newNames
        
oldDictionariesConvertibleFromJS
=
self
.
_state
