...
:
:
CORS_MODE_CORS_WITH_FORCED_PREFLIGHT
=
=
static_cast
<
...
static
bool
IsFromAuthenticatedOriginInternal
(
nsIDocument
*
aDoc
...
Enumerate
(
CheckPendingReadyPromisesEnumerator
this
)
;
}
...
-
>
CreateSharedWorkerForServiceWorkerFromLoadInfo
(
cx
&
loadInfo
...
static
void
FireControllerChangeOnDocument
(
nsIDocument
*
aDocument
...
static
PLDHashOperator
FireControllerChangeOnMatchingDocument
(
nsISupports
*
aKey
...
PLDHashOperator
UnregisterIfMatchesHostPerPrincipal
(
const
nsACString
&
...
PLDHashOperator
GetAllRegistrationsPerPrincipalEnumerator
(
const
nsACString
&
...
static
PLDHashOperator
UpdateEachRegistrationPerPrincipal
(
const
nsACString
&
...
-
>
SendRemoveServiceWorkerRegistrations
(
)
;
}
...
-
>
SendRemoveServiceWorkerRegistrationsForDomain
(
domain
)
;
