...
#
define
DEBUGGER_RUNNABLE_INTERRUPT_AFTER_MS
250
static
mozilla
:
...
;
class
ChangeActivePeerConnectionsRunnable
final
:
public
WorkerControlRunnable
...
;
class
UpdateTimezoneOverrideRunnable
final
:
public
WorkerThreadRunnable
...
-
>
UpdateTimezoneOverrideInternal
(
aCx
mTimezone
)
...
;
class
UpdateLanguageOverrideRunnable
final
:
public
WorkerThreadRunnable
...
-
>
UpdateLanguageOverrideInternal
(
mLanguageOverride
mResolvedLanguages
)
...
-
>
DisableRemoteDebuggerOnWorkerThread
(
)
;
return
...
void
DebuggerInterruptTimerCallback
(
nsITimer
*
aTimer
...
:
:
dom_worker_remoteDebugger_enabled
(
)
&
&
...
;
auto
noRunnablesPendingAndKeepAlive
=
[
&
debuggerRunnablesPending
...
:
:
TakeFirstDebuggerIPCHandshakeRunnable
(
)
{
WorkerRunnable
...
:
:
UnregisterDebuggerShutdownTask
(
nsITargetShutdownTask
*
aTask
...
:
:
AdjustNonblockingCCBackgroundActors
[
%
p
]
...
(
"
mMainThreadDebuggerEventTarget
:
%
s
"
