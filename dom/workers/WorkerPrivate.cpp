...
;
struct
MainThreadWorkerStructuredCloneCallbacks
{
static
JSObject
*
...
-
>
UpdateJSContextOptionsInternal
(
aCx
mOptions
)
...
;
class
UpdateJSRuntimeHeapSizeRunnable
:
public
WorkerControlRunnable
{
...
-
>
UpdateJSRuntimeHeapSizeInternal
(
aCx
mJSRuntimeHeapSize
)
