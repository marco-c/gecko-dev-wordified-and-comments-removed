...
Some
(
eUseCounter_custom_NavigationOnnavigate
)
;
}
if
...
Some
(
eUseCounter_custom_NavigationOnnavigatesuccess
)
;
}
if
...
Some
(
eUseCounter_custom_NavigationOnnavigateerror
)
;
}
if
...
Some
(
eUseCounter_custom_NavigationOncurrententrychange
)
;
}
return
