...
;
StaticMutex
sBrowserChildrenMutex
;
namespace
{
class
SynthesizedEventChildCallback
final
:
public
...
u
"
MozAndroidPipModeEntered
"
_ns
:
u
"
MozAndroidPipModeExited
"
_ns
CanBubble
:
...
void
SkipViewTransitionsAfterRenderingReset
(
Document
&
aDocument
...
-
>
InitSupportsUnadjustedMovement
(
aSupportsUnadjustedMovement
)
;
...
LazyLogModule
gPointerRawUpdateEventListenersLog
(
"
