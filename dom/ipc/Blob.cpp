...
:
:
TBlobConstructorNoMultipartParams
:
{
const
BlobConstructorNoMultipartParams
...
aParams
.
get_BlobConstructorNoMultipartParams
(
)
;
switch
...
params
.
get_BlobOrFileConstructorParams
(
)
;
nsRefPtr
...
params
.
get_MemoryBlobOrFileConstructorParams
(
)
;
const
...
:
:
TMultipartBlobOrFileConstructorParams
:
{
const
...
aParams
.
get_MultipartBlobOrFileConstructorParams
(
)
;
nsRefPtr
