...
static
AllowRangeCrossShadowBoundary
GetAllowRangeCrossShadowBoundary
(
const
uint32_t
aFlags
...
:
:
dom_serializer_includeCommonAncestor_enabled
(
)
&
&
