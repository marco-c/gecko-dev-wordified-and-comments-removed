...
#
define
FIRST_SOCKET_INFO_MSG_LENGTH
4
#
define
TOTAL_SOCKET_INFO_LENGTH
20
using
namespace
mozilla
...
;
void
OnSocketCanConnectWithoutBlocking
(
int
aFd
)
