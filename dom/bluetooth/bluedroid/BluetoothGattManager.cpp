...
#
define
ENSURE_GATT_INTF_IN_ATTR_DISCOVER
(
client
)
\
...
BluetoothReplyRunnable
>
mStartAdvertisingRunnable
;
RefPtr
<
BluetoothReplyRunnable
>
mStopAdvertisingRunnable
;
RefPtr
<
BluetoothReplyRunnable
...
:
:
ServerAddIncludedServiceResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerAddDescriptorResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerRemoveDescriptorResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerStartServiceResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerStopServiceResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerSendResponseResultHandler
final
:
public
BluetoothGattResultHandler
...
:
:
ServerSendIndicationResultHandler
final
:
public
BluetoothGattResultHandler
