...
:
:
WGPUFfiOption_TextureFormat_None_TextureFormat
;
}
else
{
...
:
:
WGPUFfiOption_TextureFormat_Some_TextureFormat
;
opt
.
some
...
:
:
wgpu_client_create_render_bundle_encoder
(
GetClient
(
)
...
:
:
WGPURawBindingType_ExternalTexture
;
}
switch
(
...
:
:
WGPUBindingTypeError_NoneSpecified
;
break
;
default
...
:
:
WGPUBindingTypeError_MultipleSpecified
;
break
;
}
...
-
>
EnqueueCreateShaderModulePromise
(
...
:
:
WGPUFfiOption_VertexBufferLayout
>
vertexBuffers
;
nsTArray
...
:
:
WGPUFfiOption_ColorTargetState
>
colorStates
;
webgpu
...
:
:
WGPUFfiOption_VertexBufferLayout_None_VertexBufferLayout
;
}
else
{
...
:
:
WGPUFfiOption_VertexBufferLayout_Some_VertexBufferLayout
;
opt_vb_desc
.
some
...
:
:
WGPUFfiOption_ColorTargetState_None_ColorTargetState
;
colorStates
.
AppendElement
...
:
:
WGPUFfiOption_BlendState_Some_BlendState
;
desc
.
blend
...
:
:
WGPUFfiOption_BlendState_None_BlendState
;
}
desc
.
...
:
:
WGPUFfiOption_ColorTargetState_Some_ColorTargetState
;
opt
.
some
