...
void
wgpu_child_resolve_pop_error_scope_promise
(
WGPUWebGPUChildPtr
aChild
RawId
...
aShaderModuleId
struct
WGPUFfiSlice_FfiShaderModuleCompilationMessage
aMessages
)
{
auto
...
-
>
DequeueCreateShaderModulePromise
(
)
;
MOZ_RELEASE_ASSERT
...
void
wgpu_child_resolve_on_submitted_work_done_promise
(
WGPUWebGPUChildPtr
aChild
WGPUQueueId
...
-
>
DequeueOnSubmittedWorkDonePromise
(
aQueueId
)
;
