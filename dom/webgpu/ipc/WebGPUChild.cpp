...
(
!
SendDeviceCreateBindGroupLayout
(
aSelfId
desc
id
...
(
!
SendDeviceCreatePipelineLayout
(
aSelfId
desc
id
...
ConvertProgrammableStageDescriptor
(
const
dom
:
...
:
:
wgpu_client_make_compute_pipeline_id
(
mClient
aSelfId
)
...
(
!
SendDeviceCreateComputePipeline
(
aSelfId
desc
id
...
ConvertRasterizationDescriptor
(
const
dom
:
...
ConvertVertexAttributeDescriptor
(
const
dom
:
...
ConvertVertexBufferLayoutDescriptor
(
const
dom
:
...
:
:
wgpu_client_make_render_pipeline_id
(
mClient
aSelfId
)
...
(
!
SendDeviceCreateRenderPipeline
(
aSelfId
desc
id
