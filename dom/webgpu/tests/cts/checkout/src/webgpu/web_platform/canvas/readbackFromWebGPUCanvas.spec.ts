...
function
checkImageResultWithSameColorSpaceCanvas
(
t
:
GPUTest
...
(
'
transferToImageBitmap_unconfigured_nonzero_size
'
)
.
desc
...
(
'
transferToImageBitmap_zero_size
'
)
.
desc
...
(
'
transferToImageBitmap_huge_size
'
)
.
desc
