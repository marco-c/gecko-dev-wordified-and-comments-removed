...
function
checkNonStandardIsZeroCopyIfAvailable
(
)
:
{
...
'
importExternalTexture
video_frame_display_size_diff_with_coded_size
'
)
.
desc
...
'
importExternalTexture
video_frame_display_size_from_textureDimensions
'
)
.
desc
...
'
importExternalTexture
sampleWithVideoFrameWithVisibleRectParam
'
)
.
desc
