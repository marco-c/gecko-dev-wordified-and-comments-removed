...
function
isValidStorageTextureForStages
(
device
:
GPUDevice
...
'
visibility
VERTEX_shader_stage_buffer_type
'
)
.
desc
...
function
*
pickExtraBindingTypesForPerStage
(
entry
:
BGLEntry
