...
(
'
copy_with_invalid_or_destroyed_texture
'
)
.
desc
...
(
'
multisampled_copy_restrictions
'
)
.
desc
...
(
'
depth_stencil_copy_restrictions
'
)
.
desc
...
(
'
copy_ranges_with_compressed_texture_formats
'
)
.
desc
