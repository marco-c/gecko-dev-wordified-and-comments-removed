...
:
:
WGPULoadOp_FfiOption_f32_Load_FfiOption_f32
;
break
;
case
...
:
:
WGPULoadOp_FfiOption_f32_Clear_FfiOption_f32
;
if
(
dsa
...
:
:
WGPULoadOp_FfiOption_u32_Load_FfiOption_u32
;
break
;
case
...
:
:
WGPULoadOp_FfiOption_u32_Clear_FfiOption_u32
;
dsDesc
.
stencil
...
:
:
WGPUFfiOption_FfiRenderPassColorAttachment
...
:
:
WGPUFfiRenderPassColorAttachment
cd
=
{
}
...
:
:
wgpu_recorded_render_pass_begin_occlusion_query
(
mPass
.
get
...
:
:
wgpu_recorded_render_pass_end_occlusion_query
(
mPass
.
get
