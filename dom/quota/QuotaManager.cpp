...
OriginCollection
&
aPersistentCollection
OriginCollection
&
aTemporaryCollection
nsTArray
<
OriginInfo
*
...
nsresult
CreateDirectoryMetadataLastModifiedTime
(
nsIFile
*
aDirectory
...
nsresult
GetDirectoryMetadataLastModifiedTime
(
nsIFile
*
aDirectory
...
:
:
RemoveQuotaForTemporaryStorageCallback
(
const
nsACString
&
...
:
:
CancelPromptsForWindowInternal
(
nsPIDOMWindow
*
aWindow
...
:
:
GetInactiveTemporaryStorageOrigins
(
const
nsACString
&
