...
#
define
PERMISSION_DEFAUT_PERSISTENT_STORAGE
"
default
-
persistent
...
;
class
RestoreDirectoryMetadataHelper
final
:
public
StorageDirectoryHelper
...
;
nsresult
GetDirectoryMetadataOutputStream
(
nsIFile
*
aDirectory
...
nsresult
GetDirectoryMetadataInputStream
(
nsIFile
*
aDirectory
...
nsresult
GetDirectoryMetadataWithRestore
(
nsIFile
*
aDirectory
...
:
:
GetOriginPatternStringMaybeIgnoreBrowser
(
params
.
appId
