...
:
:
TPairedDevicePropertiesRequest
:
return
actor
-
...
:
:
TConnectedDevicePropertiesRequest
:
return
actor
-
...
aRequest
.
get_DisconnectGattClientRequest
(
)
)
;
...
aRequest
.
get_UnregisterGattClientRequest
(
)
)
;
...
:
:
TGattClientReadRemoteRssiRequest
:
return
actor
-
...
aRequest
.
get_GattClientReadRemoteRssiRequest
(
)
)
;
