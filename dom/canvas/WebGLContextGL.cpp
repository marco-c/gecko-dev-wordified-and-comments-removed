...
effectiveInternalFormat
=
EffectiveInternalFormatFromUnsizedInternalFormatAndType
(
internalformat
framebuffertype
)
...
{
case
LOCAL_GL_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT
:
if
(
IsExtensionEnabled
...
{
case
LOCAL_GL_ACTIVE_UNIFORM_BLOCKS
:
case
...
-
>
GetUniformInfoForMappedIdentifier
(
mappedName
)
;
...
fGetIntegerv
(
LOCAL_GL_IMPLEMENTATION_COLOR_READ_TYPE
reinterpret_cast
<
GLint
*
...
effectiveInternalFormat
=
EffectiveInternalFormatFromInternalFormatAndType
(
internalformat
type
)
...
;
case
LOCAL_GL_LUMINANCE_ALPHA32F_EXT
:
return
WebGLTexelFormat
:
...
;
case
LOCAL_GL_LUMINANCE_ALPHA16F_EXT
:
return
WebGLTexelFormat
:
