...
:
:
webgl_porting_strict_readpixels_formats
(
)
)
return
...
:
:
webgl_porting_strict_readpixels_formats_non_es
(
)
)
return
...
static
bool
ValidateReadPixelsFormatAndType
(
const
webgl
:
