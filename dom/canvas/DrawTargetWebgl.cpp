...
:
:
gfx_canvas_accelerated_max_snapshot_pbo_memory
(
)
;
if
...
#
define
BLUR_ACCEL_SIGMA_MIN
0
.
27f
#
define
BLUR_ACCEL_SIGMA_MAX
100
#
define
BLUR_ACCEL_RADIUS
...
:
:
gfx_font_rendering_freetype_gamma
(
)
>
=
...
:
:
gfx_font_rendering_freetype_enhanced_contrast
(
)
>
0
