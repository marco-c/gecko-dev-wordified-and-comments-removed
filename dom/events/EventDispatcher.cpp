...
const
uint32_t
kNumCachedMainThreadChains
=
4
;
using
CachedMainThreadChains
=
mozilla
:
:
...
static
bool
IsUncancelableIfOnlyPassiveListeners
(
const
WidgetEvent
*
...
static
void
AssertWindowRootInTheFocusBlurChain
(
const
nsTArray
<
