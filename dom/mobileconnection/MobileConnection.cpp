...
:
NS_DECL_ISUPPORTS
NS_FORWARD_SAFE_NSIMOBILECONNECTIONLISTENER
(
mMobileConnection
)
NS_FORWARD_SAFE_NSIICCLISTENER
(
mMobileConnection
)
explicit
...
:
:
CALL_BARRING_PROGRAM_INCOMING_SERVICE
;
}
bool
MobileConnection
