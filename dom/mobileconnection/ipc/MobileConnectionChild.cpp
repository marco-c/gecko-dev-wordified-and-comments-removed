...
;
SendPMobileConnectionRequestConstructor
(
actor
aRequest
)
...
:
:
TArrayOfnsMobileCallForwardingOptions
:
{
uint32_t
count
...
info
.
get_ArrayOfnsMobileCallForwardingOptions
(
)
.
Length
...
aReply
.
get_MobileConnectionReplySuccess
(
)
)
;
...
:
:
TMobileConnectionReplySuccessBoolean
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessBoolean
(
)
)
;
...
:
:
TMobileConnectionReplySuccessNetworks
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessNetworks
(
)
)
;
...
:
:
TMobileConnectionReplySuccessMmi
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessMmi
(
)
)
;
...
:
:
TMobileConnectionReplySuccessCallForwarding
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessCallForwarding
(
)
)
;
...
:
:
TMobileConnectionReplySuccessCallBarring
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessCallBarring
(
)
)
;
...
:
:
TMobileConnectionReplySuccessClirStatus
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessClirStatus
(
)
)
;
...
aReply
.
get_MobileConnectionReplySuccessPreferredNetworkType
(
)
)
;
...
:
:
TMobileConnectionReplySuccessRoamingPreference
:
return
DoReply
(
aReply
.
get_MobileConnectionReplySuccessRoamingPreference
(
)
)
;
...
aReply
.
get_MobileConnectionReplyError
(
)
)
;
...
:
:
TMobileConnectionReplyErrorMmi
:
return
DoReply
(
aReply
.
get_MobileConnectionReplyErrorMmi
(
)
)
;
