...
NS_FORWARD_SAFE_NSIMULTIPLEXINPUTSTREAM
(
mWeakMultiplexStream
)
NS_FORWARD_SAFE_NSISEEKABLESTREAM
(
mWeakSeekableStream
)
...
NS_FORWARD_SAFE_NSIFILEMETADATA
(
mWeakFileMetadata
)
BlobInputStreamTether
...
void
DeleteStreamMemoryFromBlobDataStream
(
BlobDataStream
&
aStream
...
void
DeleteStreamMemoryFromBlobData
(
BlobData
&
aBlobData
...
blobParams
.
get_SameProcessBlobConstructorParams
(
)
;
MOZ_ASSERT
...
blobParams
.
get_KnownBlobConstructorParams
(
)
;
RefPtr
