...
SendOnStreamResetOrStopSending
(
aStreamId
StopSendingError
(
...
:
:
RecvGetMaxDatagramSize
(
GetMaxDatagramSizeResolver
&
&
aResolver
)
...
:
:
RecvGetHttpChannelID
(
GetHttpChannelIDResolver
&
&
aResolver
)
