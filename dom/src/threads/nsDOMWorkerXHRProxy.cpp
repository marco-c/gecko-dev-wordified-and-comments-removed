...
include
"
nsDOMWorkerXHRProxiedFunctions
.
h
"
#
...
using
namespace
nsDOMWorkerProxiedXHRFunctions
;
class
nsResultReturningRunnable
:
...
friend
class
nsDOMWorkerXHREventTargetProxy
;
public
:
NS_DECL_ISUPPORTS
...
class
nsDOMWorkerXHRLastProgressOrLoadEvent
:
public
nsIRunnable
{
