...
NS_IMPL_THREADSAFE_DOM_CI_GETINTERFACES
(
nsDOMWorkerXHRUpload
)
NS_IMETHODIMP
...
#
define
XPC_MAP_WANT_POSTCREATE
#
define
XPC_MAP_WANT_TRACE
#
define
XPC_MAP_WANT_FINALIZE
#
define
XPC_MAP_FLAGS
\
