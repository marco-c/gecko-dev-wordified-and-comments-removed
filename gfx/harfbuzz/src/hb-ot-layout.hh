...
|
=
HB_BUFFER_SCRATCH_FLAG_HAS_CONTINUATIONS
;
props
|
=
...
inline
void
_hb_glyph_info_set_aat_deleted
(
hb_glyph_info_t
*
info
...
unsigned
int
_hb_glyph_info_get_lig_num_comps_in_ligation
(
const
hb_glyph_info_t
*
...
inline
void
_hb_collect_glyph_alternates_add
(
hb_codepoint_t
from
hb_codepoint_t
