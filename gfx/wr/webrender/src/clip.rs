...
self
.
complex_clips_are_promotable_impl
(
clip_chain_index
interners
spatial_tree
...
fn
test_intersect_inner_fully_inside
(
)
{
let
...
fn
test_intersect_shared_top_different_bottom
(
)
{
let
...
fn
test_intersect_encroaching_corner
(
)
{
let
...
fn
test_intersect_zero_radius_no_encroach
(
)
{
let
...
fn
device_text_runs_do_not_snap_their_clips
(
)
{
use
...
fn
test_intersect_linux_window_corners
(
)
{
let
