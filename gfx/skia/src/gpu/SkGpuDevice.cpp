...
#
define
CACHE_COMPATIBLE_DEVICE_TEXTURES
1
#
if
0
...
{
GrPixelConfig
config8888_to_grconfig_and_flags
(
SkCanvas
:
:
...
-
>
preConcatSamplerMatricesWithInverse
(
matrix
)
)
