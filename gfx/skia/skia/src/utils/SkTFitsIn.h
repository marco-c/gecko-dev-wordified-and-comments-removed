...
:
value
SkTOutOfRange_LT_MinD__minS_gt_minD
)
;
return
s
...
:
value
SkTOutOfRange_GT_MaxD__maxS_lt_maxD
)
;
return
s
...
:
type
sourceCannotExceedDesitination
;
typedef
typename
SkTIf
...
:
is_integer
SkTFitsIn_source_must_be_integer
)
;
SK_COMPILE_ASSERT
(
...
:
is_integer
SkTFitsIn_destination_must_be_integer
)
;
return
!
