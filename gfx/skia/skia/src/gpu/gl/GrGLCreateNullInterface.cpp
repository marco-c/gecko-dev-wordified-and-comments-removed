...
void
notifyAttachmentDeleteWhileBound
(
const
FramebufferAttachment
*
...
:
fCurrDrawFramebuffer
(
0
)
fCurrReadFramebuffer
(
0
)
fCurrRenderbuffer
...
params
=
kDefaultMaxVertexUniformVectors
;
break
;
case
...
params
=
kDefaultMaxFragmentUniformVectors
;
break
;
case
