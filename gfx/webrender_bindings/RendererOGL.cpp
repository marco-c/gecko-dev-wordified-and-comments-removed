...
(
!
wr_renderer_map_recorded_frame
(
mRenderer
mHandle
map
...
{
wr_renderer_set_target_frame_publish_id
(
mRenderer
aPublishId
)
...
static
void
DoWebRenderDisableNativeCompositor
(
layers
:
:
...
(
"
DoWebRenderDisableNativeCompositorRunnable
"
&
DoWebRenderDisableNativeCompositor
mBridge
...
wr_renderer_trigger_memory_pressure_event
(
GetRenderer
(
)
