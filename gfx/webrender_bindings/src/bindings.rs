...
;
fn
wr_transaction_notification_notified
(
handler
:
usize
...
:
bool
frames_since_using_multiple_layers
:
Option
<
u32
...
fn
use_multiple_layers_except_debug_layer
(
&
mut
self
...
{
const
FRAME_COUNT_BEFORE_DISABLING_SYNC_DCOMP_COMMIT
:
u32
=
60
...
:
bool
support_low_priority_threadpool
:
bool
...
"
fn
wr_api_accumulate_memory_report
(
dh
:
&
...
"
fn
wr_api_enable_native_compositor
(
dh
:
&
...
"
fn
wr_transaction_is_rendered_frame_invalidated
(
txn
:
&
...
"
fn
wr_transaction_render_offscreen
(
txn
:
&
...
fn
wr_animation_properties_into_vec
<
T
>
(
...
"
fn
wr_transaction_add_minimap_data
(
txn
:
&
...
"
fn
wr_resource_updates_set_blob_image_visible_area
(
txn
:
&
...
"
fn
wr_resource_updates_delete_blob_image
(
txn
:
&
...
"
fn
wr_resource_updates_add_snapshot_image
(
txn
:
&
...
"
fn
wr_resource_updates_delete_snapshot_image
(
txn
:
&
...
"
fn
wr_transaction_clear_display_list
(
txn
:
&
...
"
fn
wr_dp_push_rect_with_animation
(
state
:
&
...
"
fn
wr_dump_serialized_display_list
(
state
:
&
