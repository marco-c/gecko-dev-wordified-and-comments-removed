...
:
:
GetPrefName_gfx_webrender_enable_angle
(
)
mWrAngleEnabled
)
...
:
:
gfx_webrender_require_angle_AtStartup
(
)
;
mWrDCompWinEnabled
...
:
:
GetPrefDefault_gfx_webrender_enable_angle
(
)
mWrAngleEnabled
)
