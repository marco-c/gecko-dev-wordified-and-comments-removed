...
PipelineOffset
>
next_available_clip_offset
:
usize
next_available_spatial_offset
:
usize
}
impl
...
self
.
get_spatial_node_index_for_clip_id
(
info
.
id
...
self
.
create_brush_kind_for_gradient
(
&
prim_info
info
...
self
.
create_brush_kind_for_radial_gradient
(
&
prim_info
info
