...
GLContextWrapper
>
current_bound_webgl_context_id
:
Option
<
WebGLContextId
...
self
.
publish_frame_and_notify_compositor
(
frame
&
mut
...
self
.
notify_compositor_of_new_scroll_frame
(
true
)
}
