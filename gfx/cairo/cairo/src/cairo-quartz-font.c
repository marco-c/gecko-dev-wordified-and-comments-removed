...
(
*
CTFontGetBoundingRectsForGlyphsPtr
)
(
CTFontRef
CTFontOrientation
...
static
cairo_bool_t
_cairo_quartz_font_symbol_lookup_done
=
FALSE
;
static
cairo_bool_t
_cairo_quartz_font_symbols_present
=
FALSE
;
#
...
inline
CGGlyph
_cairo_quartz_scaled_glyph_index
(
...
static
cairo_int_status_t
_cairo_quartz_init_glyph_metrics
(
cairo_quartz_scaled_font_t
*
font
