...
#
if
PIXMAN_HAS_COMPOSITOR
typedef
struct
_cairo_image_span_renderer
{
...
compositor
=
pixman_image_create_compositor
(
op
r
-
...
pixman_image_compositor_destroy
(
r
-
>
