...
typedef
struct
_cairo_atsui_font_face
cairo_atsui_font_face_t
;
typedef
struct
_cairo_atsui_font
...
typedef
struct
_cairo_atsui_scaled_path
cairo_atsui_scaled_path_t
;
static
cairo_status_t
...
_cairo_atsui_font_face_backend
=
{
...
static
CGContextRef
CGBitmapContextCreateWithCairoImageSurface
(
const
...
static
CGAffineTransform
CGAffineTransformMakeWithCairoScaleFactors
(
const
cairo_matrix_t
*
...
static
cairo_status_t
_cairo_atsui_scaled_font_init_glyph_surface
(
cairo_atsui_font_t
*
scaled_font
