...
static
cairo_operator_t
cairo_operator_from_ft_composite_mode
(
FT_Composite_Mode
mode
)
...
static
cairo_extend_t
cairo_extend_from_ft_paint_extend
(
FT_PaintExtend
extend
)
