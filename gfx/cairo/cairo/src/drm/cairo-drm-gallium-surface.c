...
static
cairo_format_t
_cairo_format_from_pipe_format
(
enum
pipe_format
format
...
static
cairo_bool_t
format_is_supported_destination
(
gallium_device_t
*
device
...
static
int
gallium_format_stride_for_width
(
enum
pipe_format
format
...
cairo_surface_t
*
gallium_surface_create_for_name
(
cairo_drm_device_t
*
base_dev
...
;
return
_cairo_drm_device_create_in_error
(
_cairo_error
(
CAIRO_STATUS_NO_MEMORY
