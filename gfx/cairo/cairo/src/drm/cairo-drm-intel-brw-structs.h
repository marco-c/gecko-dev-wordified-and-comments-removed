...
#
define
BRW_INHIBIT_FLUSH_RENDER_CACHE
0x4
#
define
...
unsigned
int
mask_stack_exception_enable
:
1
;
unsigned
int
timeout_exception_enable
:
1
;
unsigned
...
unsigned
int
monochrome_filter_width
:
3
;
unsigned
int
monochrome_filter_height
:
3
;
}
...
unsigned
int
quantizer_scale_type
:
1
;
unsigned
int
concealment_motion_vector
:
1
;
unsigned
int
frame_predict_frame_dct
:
1
;
unsigned
