...
if
!
HAVE_X11_EXTENSIONS_XSHM_H
|
|
!
(
HAVE_X11_EXTENSIONS_SHMPROTO_H
|
|
HAVE_X11_EXTENSIONS_SHMSTR_H
)
void
...
cairo_surface_t
*
_cairo_xlib_surface_create_shm
(
cairo_xlib_surface_t
*
other
...
cairo_surface_t
*
_cairo_xlib_surface_create_shm__image
(
cairo_xlib_surface_t
*
surface
...
void
_cairo_xlib_shm_surface_mark_active
(
cairo_surface_t
*
_shm
...
void
*
_cairo_xlib_shm_surface_get_obdata
(
cairo_surface_t
*
surface
...
Pixmap
_cairo_xlib_shm_surface_get_pixmap
(
cairo_surface_t
*
surface
...
cairo_bool_t
_cairo_xlib_shm_surface_is_idle
(
cairo_surface_t
*
surface
...
static
void
_cairo_xlib_display_shm_pool_destroy
(
cairo_xlib_display_t
*
display
...
cairo_xlib_shm_surface_t
*
_cairo_xlib_shm_surface_create
(
cairo_xlib_surface_t
*
other
...
static
void
_cairo_xlib_surface_update_shm
(
cairo_xlib_surface_t
*
surface
...
static
cairo_bool_t
has_broken_send_shm_event
(
cairo_xlib_display_t
*
display
cairo_xlib_shm_display_t
*
shm
)
{
...
static
cairo_bool_t
xorg_has_buggy_send_shm_completion_event
(
cairo_xlib_display_t
*
display
