...
status
=
_cairo_xcb_connection_take_socket
(
connection
)
;
...
status
=
_cairo_xcb_surface_cairo_paint
(
surface
op
source
...
status
=
_cairo_xcb_surface_render_mask
(
surface
op
source
...
status
=
_cairo_xcb_surface_cairo_stroke
(
surface
op
source
...
status
=
_cairo_xcb_surface_render_stroke
(
surface
op
source
...
status
=
_cairo_xcb_surface_render_fill
(
surface
op
source
...
status
=
_cairo_xcb_surface_cairo_glyphs
(
surface
op
source
...
cairo_surface_t
*
_xcb_drm_create_surface_for_drawable
(
cairo_xcb_connection_t
*
connection
