...
#
define
RVV_MAKE_SEPARABLE_PDF_COMBINERS
(
name
)
\
...
#
define
rvv_UN8_bcast_UN8x4_v_m4
(
a
vl
)
\
rvv_UN16_bcast_UN8x4_v_m4
(
__riscv_vwcvtu_x
(
a
...
static
void
rvv_composite_over_x888_8_8888
(
pixman_implementation_t
*
__restrict__
...
static
void
rvv_composite_add_n_8888_8888_ca
(
pixman_implementation_t
*
imp
...
static
void
rvv_composite_over_n_8888_8888_ca
(
pixman_implementation_t
*
__restrict__
...
static
void
rvv_composite_over_n_8888_0565_ca
(
pixman_implementation_t
*
__restrict__
...
=
rvv_combine_in_reverse_u_float
;
imp
-
>
...
=
rvv_combine_out_reverse_u_float
;
imp
-
>
...
=
rvv_combine_disjoint_in_u_float
;
imp
-
>
...
=
rvv_combine_conjoint_in_u_float
;
imp
-
>
...
=
rvv_combine_hard_light_u_float
;
imp
-
>
...
=
rvv_combine_soft_light_u_float
;
imp
-
>
...
=
rvv_combine_difference_u_float
;
imp
-
>
...
=
rvv_combine_color_dodge_u_float
;
imp
-
>
...
=
rvv_combine_color_burn_u_float
;
imp
-
>
...
=
rvv_combine_color_dodge_ca_float
;
imp
-
>
...
=
rvv_combine_color_burn_ca_float
;
imp
-
>
...
=
rvv_combine_exclusion_ca_float
;
imp
-
>
