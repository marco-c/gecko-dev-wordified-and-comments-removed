...
typedef
struct
_glitz_program_expand_t
glitz_program_expand_t
;
typedef
struct
_glitz_inop
...
char
*
_gradient_fetch_and_interpolate
[
]
=
{
...
#
define
COLORSPACE_BASE_SIZE
2048
static
glitz_gl_uint_t
_glitz_create_fragment_program
(
