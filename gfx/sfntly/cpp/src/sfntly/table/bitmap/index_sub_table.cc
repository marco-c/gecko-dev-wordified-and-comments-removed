...
:
:
kIndexSubHeader_imageDataOffset
)
;
}
int32_t
...
:
:
kIndexSubTableEntry_firstGlyphIndex
)
;
int32_t
last_glyph_index
...
:
:
kIndexSubTableEntry_lastGlyphIndex
)
;
int32_t
...
:
:
kIndexSubTableEntry_additionalOffsetToIndexSubTable
)
;
int32_t
