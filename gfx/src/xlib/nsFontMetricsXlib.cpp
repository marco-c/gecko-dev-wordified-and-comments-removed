...
PRPackedBool
mAllowDoubleByteSpecialChars
;
PRPackedBool
mForceOutlineScaledFonts
;
PRPackedBool
mScaleBitmapFontsWithDevScale
;
float
mDevScale
;
...
PRUint16
*
mDoubleByteSpecialCharsCCMap
;
PRInt32
mOutlineScaleMinimum
;
#
ifdef
USE_AASB
PRBool
mAABitmapScaleEnabled
;
PRBool
mAABitmapScaleAlways
;
PRInt32
mAABitmapScaleMinimum
;
double
mAABitmapOversize
;
...
sizeof
(
gDoubleByteSpecialCharsCCMapUnion
)
;
mDoubleByteSpecialCharsCCMap
=
...
#
define
ALWAYS_USE_SCALED_FONTS_FOR_XPRINT
1
#
endif
#
