...
constexpr
size_t
kMaxAvailableIdentifierLength
=
1022
;
bool
ShouldEnforceESSL100LoopAndIndexingLimitations
(
ShShaderSpec
spec
int
...
bool
IsSamplerOrStructWithOnlySamplers
(
const
TType
*
...
void
MarkClipCullFirstEncounter
(
const
TSourceLoc
&
line
ClipCullDistanceInfo
*
info
)
{
...
void
MarkClipCullArrayLengthMethodCall
(
const
TSourceLoc
&
...
unsigned
int
GetMaxUniformBlocksForShaderType
(
sh
:
:
...
mPositionRedeclaredForSeparateShaderObject
(
false
)
...
mPositionOrPointSizeUsedForSeparateShaderObject
(
false
)
mUsesDerivatives
...
mFragmentOutputIndex1Used
(
false
)
mFragmentOutputFragDepthUsed
(
false
)
...
{
checkESSL100NoLoopSymbolAssign
(
symNode
line
)
...
:
:
checkDeclarationIsValidArraySize
(
const
TSourceLoc
&
...
{
checkPixelLocalStorageBindingIsValid
(
identifierLocation
type
)
...
justEndedControlFlow
.
loopConditionConstantTrueSymbol
!
=
nullptr
&
...
;
checkDoesNotHaveDuplicateFieldNames
(
fieldList
nameLine
)
...
{
bool
isTextureGatherOffsetOrOffsets
=
BuiltInGroup
:
:
...
:
:
addNonConstructorFunctionCallImpl
(
TFunctionLookup
*
fnCall
