...
bool
ValidateInstancedPathParameters
(
gl
:
:
...
(
GL_INVALID_VALUE
kWebgl2NameLengthLimitExceeded
)
;
return
false
...
(
GL_INVALID_OPERATION
kFragmentInputTypeNotFloatingPoint
)
;
return
false
