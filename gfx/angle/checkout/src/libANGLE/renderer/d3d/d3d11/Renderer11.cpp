...
>
void
CopyTriangleFanIndicesWithRestart
(
const
void
*
...
:
Result
GetTextureD3DResourceFromStorageOrImage
(
const
gl
:
...
(
GLenum
depthStencilBufferInternalFormat
:
depthStencilBufferFormats
)
{
...
:
Rectangle
drawRectMatchingInBoundsReadRect
;
drawRectMatchingInBoundsReadRect
.
x
