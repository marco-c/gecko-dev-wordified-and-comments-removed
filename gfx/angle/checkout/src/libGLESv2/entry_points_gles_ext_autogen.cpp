...
{
ContextPrivateVertexAttribDivisor
(
context
-
>
...
-
>
texStorageMemFlags3DMultisample
(
targetPacked
samples
internalFormat
...
-
>
getFramebufferPixelLocalStorageParameteruivRobust
(
plane
pnamePacked
paramCount
...
ANGLE_CAPTURE_GL
(
GetFramebufferPixelLocalStorageParameteruivRobustANGLE
isCallValid
context
plane
pnamePacked
...
-
>
framebufferMemorylessPixelLocalStorage
(
plane
internalformat
usage
...
-
>
framebufferTexturePixelLocalStorage
(
plane
backingtexturePacked
level
...
-
>
framebufferPixelLocalClearValuefv
(
plane
value
)
...
-
>
framebufferPixelLocalClearValueiv
(
plane
value
)
...
-
>
framebufferPixelLocalClearValueuiv
(
plane
value
)
...
isCallValid
=
ValidateEndPixelLocalStorageImplicitANGLE
(
context
angle
:
...
-
>
framebufferPixelLocalStorageInterrupt
(
)
;
}
...
-
>
framebufferPixelLocalStorageRestore
(
)
;
}
...
-
>
getFramebufferPixelLocalStorageParameterfv
(
plane
pnamePacked
params
...
-
>
getFramebufferPixelLocalStorageParameteriv
(
plane
pnamePacked
params
...
-
>
getFramebufferPixelLocalStorageParameteruiv
(
plane
pnamePacked
params
...
{
ContextPrivateCoverageModulation
(
context
-
>
...
{
ContextPrivateBlendEquationSeparatei
(
context
-
>
...
{
ContextPrivateBlendFuncSeparatei
(
context
-
>
...
{
ContextPrivateShadingRateCombinerOps
(
context
-
>
...
{
ContextPrivatePolygonOffsetClamp
(
context
-
>
...
isCallValid
=
ValidatePrimitiveBoundingBoxEXT
(
context
-
>
...
isCallValid
=
ValidatePrimitiveBoundingBoxOES
(
context
-
>
...
{
ContextPrivateMinSampleShading
(
context
-
>
...
.
multiviewMultisampledRenderToTextureOVR
)
)
{
#
...
-
>
framebufferTextureMultisampleMultiview
(
target
attachment
texturePacked
...
-
>
framebufferFoveationParameters
(
framebufferPacked
layer
focalPoint
