...
#
define
ANGLE_SUPPRESS_D3D11_HAZARD_WARNINGS
1
#
endif
namespace
...
-
>
getSamplerStateWithNativeOffset
(
&
samplerState
)
...
unsigned
int
totalRegisterCountVS
=
0
;
unsigned
int
totalRegisterCountPS
=
0
;
bool
