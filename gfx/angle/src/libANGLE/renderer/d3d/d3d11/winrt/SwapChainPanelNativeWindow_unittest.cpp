...
HRESULT
(
__FIVector_1_Windows__CUI__CXaml__CTriggerBase
*
*
)
)
...
HRESULT
(
__FIVector_1_Windows__CUI__CXaml__CMedia__CAnimation__CTransition
*
*
)
)
...
HRESULT
(
__FIVectorView_1_Windows__CUI__CXaml__CInput__CPointer
*
*
)
)
...
HRESULT
(
IManipulationInertiaStartingEventHandler
*
EventRegistrationToken
*
)
...
(
NativeWindowTest
SwapChainPanelInPropertySetWithSizeAndScale
)
{
EXPECT_HRESULT_SUCCEEDED
(
