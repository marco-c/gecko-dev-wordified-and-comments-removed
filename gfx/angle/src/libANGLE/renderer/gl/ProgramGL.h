#
ifndef
LIBANGLE_RENDERER_GL_PROGRAMGL_H_
#
define
LIBANGLE_RENDERER_GL_PROGRAMGL_H_
#
...
;
void
enableSideBySideRenderingPath
(
)
const
;
void
enableLayeredRenderingPath
(
int
baseViewIndex
)
...
PathRenderingFragmentInput
>
mPathRenderingFragmentInputs
;
bool
mEnablePathRendering
;
GLint
