...
;
bindGenericAtomicCounterBuffer
(
0
)
;
...
{
bindIndexedAtomicCounterBuffer
(
0
i
0
...
bindGenericShaderStorageBuffer
(
0
)
;
...
.
displayRobustResourceInitialization
;
mExtensions
.
