...
GLAPIENTRY
*
fGetSemaphoreParameterui64vEXT
)
(
GLuint
GLenum
...
GLAPIENTRY
*
fGetMemoryObjectParameterivEXT
)
(
GLuint
GLenum
...
GLAPIENTRY
*
fTexStorageMem2DMultisampleEXT
)
(
GLenum
GLsizei
