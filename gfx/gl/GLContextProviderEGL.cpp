...
#
define
GET_NATIVE_WINDOW_FROM_COMPOSITOR_WIDGET
(
aWidget
)
\
...
;
void
DeleteWaylandOffscreenGLSurface
(
EGLSurface
surface
)
...
(
mSurfaceConfig
LOCAL_EGL_BIND_TO_TEXTURE_TARGET_ANGLE
&
eglTarget
)
)
