...
:
:
UpdateTiledThebesLayerTextureUsage
(
eMemoryUse_free
aTile
.
...
mLowPrecisionVideoMemoryTiledBuffer
(
aManager
-
>
...
;
mLowPrecisionMainMemoryTiledBuffer
.
ReadUnlock
(
)
