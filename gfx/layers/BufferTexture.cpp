...
:
:
CbCrStrideFromBufferDescriptor
(
mDescriptor
)
;
...
:
:
ColorSpace2FromBufferDescriptor
(
mDescriptor
)
;
...
:
:
TransferFunctionFromBufferDescriptor
(
mDescriptor
)
;
