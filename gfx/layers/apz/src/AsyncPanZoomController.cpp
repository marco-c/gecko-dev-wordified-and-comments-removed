...
-
>
GetCurrentMetricsForCompositorScrollUpdate
(
aProofOfApzcLock
)
)
...
:
:
apz_touch_scroll_buffer_max_age_AtStartup
(
)
)
2
...
if
(
InScrollAnimationTriggeredByScript
(
)
)
{
...
{
bool
blockPullToRefreshForOverflowHidden
=
aConsumer
=
=
...
:
:
apz_autoscroll_scroll_wheel_cooldown
(
)
)
;
...
:
:
apz_scrollend_event_content_delay_ms
(
)
)
;
...
aFlags
&
ZOOM_TO_FOCUSED_INPUT_ON_RESIZES_VISUAL
)
{
return
true
