...
:
:
gfx_webrender_debug_dump_native_layer_tree_to_file
(
)
)
{
...
:
:
gfx_core_animation_low_power_telemetry_frames_AtStartup
(
)
;
...
:
:
gfx_core_animation_specialize_video
(
)
)
{
...
:
:
gfx_core_animation_specialize_video_log
(
)
)
{
...
:
:
gfx_color_management_hdr_video_assume_rec2020_uses_pq
(
)
)
{
...
:
:
gfx_core_animation_specialize_video_check_color_space
(
)
)
{
...
:
:
gfx_core_animation_specialize_video_spoof_timing
(
)
;
#
