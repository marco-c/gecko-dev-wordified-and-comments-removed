...
{
ByteStringOrLong
ByteStringSequenceOrLongOrString
}
;
use
dom
...
:
{
ByteStringSequenceOrLong
DocumentOrTestTypedef
}
;
use
dom
...
:
{
HTMLElementOrUnsignedLongOrStringOrBoolean
LongSequenceOrBoolean
}
;
use
dom
...
fn
SetUnrestrictedDoubleAttribute
(
&
self
_
...
fn
GetUnrestrictedFloatAttributeNullable
(
&
self
)
...
fn
SetUnrestrictedFloatAttributeNullable
(
&
self
_
...
fn
SetUnrestrictedDoubleAttributeNullable
(
&
self
_
...
fn
SetAttr_to_automatically_rename
(
&
self
_
...
/
fn
PassOptionalNullableUnrestrictedFloatWithDefault
(
self
_
:
...
/
fn
PassOptionalNullableUnrestrictedDoubleWithDefault
(
self
_
:
...
:
:
TestBindingOrStringByteStringRecord
)
{
}
fn
...
:
:
TestBindingOrByteStringSequenceSequenceOrStringByteStringRecord
)
{
}
fn
