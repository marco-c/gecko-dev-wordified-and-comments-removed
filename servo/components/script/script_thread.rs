...
MainThreadScriptMsg
>
user_interaction_task_sender
:
Sender
<
MainThreadScriptMsg
>
networking_task_sender
:
Box
<
ScriptChan
...
:
HistoryTraversalTaskSource
file_reading_task_sender
:
Box
<
ScriptChan
>
performance_timeline_task_sender
:
Box
<
ScriptChan
...
self
.
handle_set_document_activity_msg
(
pipeline_id
activity
)
...
self
.
handle_visibility_change_complete_msg
(
parent_pipeline_id
browsing_context_id
visible
...
pub
fn
handle_serviceworker_registration
(
&
self
scope
...
fn
ask_constellation_for_browsing_context_id
(
&
self
pipeline_id
...
fn
ask_constellation_for_parent_info
(
&
self
pipeline_id
