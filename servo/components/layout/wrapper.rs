...
element
.
get_unsigned_integer_attribute_for_layout
(
UnsignedIntegerAttribute
:
:
...
element
.
get_length_attribute_for_layout
(
length_attribute
)
}
...
element
.
get_integer_attribute_for_layout
(
integer_attribute
)
}
...
element
.
get_simple_color_attribute_for_layout
(
attribute
)
}
