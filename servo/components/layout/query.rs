...
writing_mode
.
block_flow_direction
(
)
writing_mode
.
inline_base_direction
(
)
)
{
...
pub
fn
process_node_scroll_id_request
<
N
:
LayoutNode
...
pub
fn
process_element_inner_text_query
<
N
:
LayoutNode
...
if
is_block_level_or_table_caption
(
&
display
)
