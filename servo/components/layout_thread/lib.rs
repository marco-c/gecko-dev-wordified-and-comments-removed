...
{
let
thread_local_style_context_creation_data
=
ThreadLocalStyleContextCreationInfo
:
:
...
map
(
reflow_query_type_needs_display_list
)
.
unwrap_or
(
...
;
let
sheet_origins_affected_by_device_change
=
self
.
stylist
