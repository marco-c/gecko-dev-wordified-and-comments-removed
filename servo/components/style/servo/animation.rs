...
struct
KeyframeOffsetCacheForProperty
{
last_keyframe_that_defined_property
:
usize
...
{
fn
relative_to_animation_direction
(
&
self
reverse
...
{
fn
next_relevant_keyframe_for_property_in_direction
(
&
self
property_index
...
;
let
transitionable_from_current_value
=
transitionable
&
&
