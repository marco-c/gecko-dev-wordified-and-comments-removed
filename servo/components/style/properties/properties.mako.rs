...
.
fn
is_ignored_when_document_colors_disabled
(
&
self
)
...
const
MAX_SUB_PROPERTIES_PER_SHORTHAND_EXCEPT_ALL
:
usize
=
{
...
;
type
SourcePropertyDeclarationArray
=
[
PropertyDeclaration
;
...
/
/
__servo_display_for_hypothetical_box
except
when
the
/
