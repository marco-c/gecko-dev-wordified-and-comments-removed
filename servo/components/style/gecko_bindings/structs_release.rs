...
pub
type
nsStringRepr_substring_tuple_type
=
root
:
:
...
pub
type
nsStringRepr_const_char_iterator
=
*
const
root
...
fn
bindgen_test_layout_nsStringRepr
(
)
{
assert_eq
...
pub
type
nsCStringRepr_base_string_type
=
root
:
:
...
pub
type
nsCStringRepr_substring_tuple_type
=
root
:
:
...
pub
type
nsCStringRepr_const_char_iterator
=
*
const
root
...
fn
bindgen_test_layout_nsCStringRepr
(
)
{
assert_eq
...
pub
enum
LookAndFeel_OperatingSystemVersion
{
...
pub
const
LookAndFeel_eScrollArrowStyle_Single
:
root
:
:
...
pub
const
LookAndFeel_eScrollArrowStyle_BothAtBottom
:
root
:
:
...
pub
const
LookAndFeel_eScrollArrowStyle_BothAtEachEnd
:
root
:
:
...
pub
const
LookAndFeel_eScrollArrowStyle_BothAtTop
:
root
:
:
...
pub
const
LookAndFeel_eScrollThumbStyle_Normal
:
root
:
:
...
pub
const
LookAndFeel_eScrollThumbStyle_Proportional
:
root
:
:
...
fn
bindgen_test_layout_LookAndFeel
(
)
{
assert_eq
...
=
"
_ZN9nsAString12kMaxCapacityE
"
]
pub
static
nsAString_kMaxCapacity
:
root
:
:
...
=
"
_ZN10nsACString12kMaxCapacityE
"
]
pub
static
nsACString_kMaxCapacity
:
root
:
:
...
fn
bindgen_test_layout_nsACString
(
)
{
assert_eq
...
pub
const
nsIRequest_LOAD_HTML_OBJECT_DATA
:
root
:
:
...
fn
bindgen_test_layout_nsITokenizer
(
)
{
assert_eq
...
fn
bindgen_test_layout_nsParserBase
(
)
{
assert_eq
...
fn
bindgen_test_layout_ProfilerBacktraceDestructor
(
)
{
assert_eq
...
fn
bindgen_test_layout_nsIProperties
(
)
{
assert_eq
...
=
"
_ZN10nsCSSProps20kMozAppearanceKTableE
"
]
pub
static
mut
nsCSSProps_kMozAppearanceKTable
:
[
root
:
...
pub
type
nsCSSValue_Array_HasThreadSafeRefCnt
=
root
:
:
...
pub
type
nsCSSValue_ThreadSafeArray_HasThreadSafeRefCnt
=
root
:
:
...
fn
bindgen_test_layout_nsCSSValue_ThreadSafeArray
(
)
{
assert_eq
...
fn
bindgen_test_layout_BindingHolder
(
)
{
assert_eq
