...
static
void
UpdateGeneratedContentTextIfNeeded
(
nsIFrame
*
aFrame
...
bool
handleAnchorPosAnchorNameChange
=
oldDisp
?
oldDisp
...
-
>
IncrementContentVisibilityHiddenCount
(
)
;
}
...
-
>
DecrementContentVisibilityHiddenCount
(
)
;
}
...
nsIFrame
*
BackfaceHidden3DParticipantFor
(
nsIFrame
*
aAncestor
...
-
>
HasContentVisibilityHiddenFrames
(
)
)
|
...
;
auto
GetPositionMaybeIgnoringScrolling
=
[
aFlags
]
...
ConvertSVGDominantBaselineToAlignmentBaseline
(
