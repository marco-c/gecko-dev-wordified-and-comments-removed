...
static
bool
sUnprefixingServiceGloballyWhitelisted
;
#
endif
static
...
<
1
eParseDeclaration_FromUnprefixingSvc
=
1
<
<
...
;
bool
ParsePropertyWithUnprefixingService
(
const
nsAString
&
...
;
bool
ParseSingleValuePropertyByFunction
(
nsCSSValue
&
aValue
...
;
bool
ParsePositionValueSeparateCoords
(
nsCSSValue
&
aOutX
...
;
bool
ParseImageLayerPositionCoordItem
(
nsCSSValue
&
aOut
...
;
bool
ParseOptionalLineNameListAfterSubgrid
(
nsCSSValue
&
aValue
...
;
bool
ParseGridTrackListWithFirstLineNames
(
nsCSSValue
&
aValue
...
;
bool
ParseGridTemplateColumnsOrAutoFlow
(
bool
aForGridShorthand
)
...
bool
ParseSingleTokenVariantWithRestrictions
(
nsCSSValue
&
aValue
...
bool
ParseSingleTokenOneOrLargerVariant
(
nsCSSValue
&
aValue
...
;
bool
ParseWebkitGradientPointComponent
(
nsCSSValue
&
aComponent
...
bool
ParseReferenceBoxAndBasicShape
(
nsCSSValue
&
aValue
...
;
bool
ParsePositionValueForBasicShape
(
nsCSSValue
&
aOut
...
;
bool
mSheetPrincipalRequired
;
enum
WebkitBoxUnprefixState
:
uint8_t
{
eNotParsingDecls
...
static
bool
SeparatorRequiredBetweenTokens
(
nsCSSTokenSerializationType
aToken1
nsCSSTokenSerializationType
...
REPORT_UNEXPECTED_TOKEN
(
PESupportsConditionExpectedStart
)
;
return
false
...
REPORT_UNEXPECTED_EOF
(
PESupportsConditionInParensStartEOF
)
;
return
false
...
;
nsAutoCSSParserInputStateRestorer
parserStateBeforeTryingToUnprefix
(
this
)
;
...
-
>
GenerateUnprefixedGradientValue
(
aPrefixedFuncName
prefixedFuncBody
unprefixedFuncName
...
static
bool
IsBoxPositionStrictlyEdgeKeywords
(
nsCSSValuePair
&
aPosition
...
static
void
AdjustEdgeOffsetPairForBasicShape
(
nsCSSValue
&
aEdge
