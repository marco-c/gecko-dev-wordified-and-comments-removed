...
;
return
Servo_AnimationValue_Translate
(
&
translate
)
...
p
.
get_ArrayOfPathCommand
(
)
)
;
return
Servo_AnimationValue_SVGPath
(
commands
.
Elements
...
:
return
Servo_AnimationValue_RayFunction
(
&
p
.
...
:
return
Servo_AnimationValue_NoneOffsetPath
(
)
.
Consume
...
:
return
Servo_AnimationValue_OffsetDistance
(
&
aAnimatable
.
...
;
return
Servo_AnimationValue_OffsetRotate
(
&
rotate
)
...
;
return
Servo_AnimationValue_OffsetAnchor
(
&
anchor
)
