...
#
define
build_intra_predictors_mbuv_prototype
(
sym
)
\
...
(
*
build_intra_predictors_mbuv_fn_t
)
)
;
extern
...
#
define
build_intra_predictors_mby_prototype
(
sym
)
\
...
(
*
build_intra_predictors_mby_fn_t
)
)
;
extern
...
static
void
vp8_build_intra_predictors_mby_x86
(
MACROBLOCKD
*
x
