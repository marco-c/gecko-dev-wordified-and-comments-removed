...
static
int
kDataLargeOuterLoopCount
=
128
;
static
int
kDataLargeInnerLoopCount
=
1024
;
namespace
...
;
class
WebrtcProxyChannelTestCallback
;
class
FakeSocketTransportProvider
:
public
nsISocketTransport
{
