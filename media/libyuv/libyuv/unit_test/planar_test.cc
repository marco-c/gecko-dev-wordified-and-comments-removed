...
(
LibYUVPlanarTest
TestDetileSplitUVPlane_Correctness
)
{
int
i
...
(
LibYUVPlanarTest
TestDetileSplitUVPlane_Benchmark
)
{
int
i
...
(
LibYUVPlanarTest
TestHalfFloatPlane_16bit_denormal
)
{
int
diff
...
(
LibYUVPlanarTest
TestHalfFloatPlane_16bit_flush_denormal
)
{
EnableFlushDenormalToZero
(
...
(
LibYUVPlanarTest
TestHalfFloatPlane_10bit_flush_denormal
)
{
EnableFlushDenormalToZero
(
...
defined
(
HAS_HALFWIDTHROW_16TO8_AVX2
)
|
|
defined
(
HAS_HALFWIDTHROW_16TO8_SSSE3
)
|
|
\
defined
(
HAS_HALFWIDTHROW_16TO8_AVX512BW
)
|
|
defined
(
HAS_HALFWIDTHROW_16TO8_NEON
)
TEST_F
(
LibYUVPlanarTest
HalfWidthRow_16To8_Opt
)
{
const
int
...
free_aligned_buffer_page_end_16
(
src_pixels_uv
)
;
