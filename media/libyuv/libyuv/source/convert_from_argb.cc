...
defined
(
HAS_ARGBTOUV444MATRIXROW_SSSE3
)
if
(
TestCpuFlag
...
ARGBToUV444MatrixRow
=
ARGBToUV444MatrixRow_Any_SSSE3
;
if
(
IS_ALIGNED
...
defined
(
HAS_ARGBTOUV444MATRIXROW_AVX512BW
)
if
(
TestCpuFlag
...
ARGBToUV444MatrixRow
=
ARGBToUV444MatrixRow_Any_AVX512BW
;
if
(
IS_ALIGNED
...
defined
(
HAS_ARGBTORGB565DITHERROW_SVE2
)
if
(
TestCpuFlag
...
defined
(
HAS_ARGBTORGB565DITHERROW_LASX
)
if
(
TestCpuFlag
