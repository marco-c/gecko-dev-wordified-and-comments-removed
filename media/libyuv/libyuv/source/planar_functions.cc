...
defined
(
HAS_ARGBCOLORMATRIXROW_NEON_I8MM
)
if
(
TestCpuFlag
...
defined
(
HAS_ARGBTOYMATRIXROW_NEON_DOTPROD
)
if
(
TestCpuFlag
...
ARGBToYMatrixRow
=
ARGBToYMatrixRow_Any_NEON_DotProd
;
if
(
IS_ALIGNED
