...
;
uint32_t
mCurrentSampleInfoCount
;
uint32_t
mCurrentSampleInfoAllocSize
;
uint8_t
*
...
;
uint32_t
mCurrentSampleInfoOffsetsAllocSize
;
uint64_t
*
...
=
0x400
kSampleCompositionTimeOffsetPresent
=
0x800
}
;
