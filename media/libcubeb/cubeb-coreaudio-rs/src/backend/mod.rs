...
fn
audiounit_create_blank_aggregate_device_sync
(
plugin_id
:
&
...
desc
=
get_audiounit_description
(
flags
)
;
create_audiounit_by_description
(
desc
)
}
...
fn
audiounit_get_default_datasource_string
(
side
:
io_side
...
device_property_listener
>
input_alive_listener
:
Option
<
device_property_listener
>
input_source_listener
:
Option
<
device_property_listener
>
output_source_listener
:
Option
<
device_property_listener
...
fn
install_device_changed_callback
(
&
mut
self
