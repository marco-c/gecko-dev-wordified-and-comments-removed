...
;
void
av1_apply_temporal_filter_sse2
(
const
struct
yv12_buffer_config
...
;
void
av1_apply_temporal_filter_avx2
(
const
struct
yv12_buffer_config
...
;
void
av1_build_compound_diffwtd_mask_sse4_1
(
uint8_t
*
mask
...
(
*
av1_estimate_noise_from_single_plane
)
(
const
uint8_t
...
#
define
av1_highbd_convolve8
av1_highbd_convolve8_c
void
av1_highbd_convolve8_horiz_c
(
const
uint8_t
*
...
#
define
av1_highbd_convolve8_horiz
av1_highbd_convolve8_horiz_c
void
av1_highbd_convolve8_vert_c
(
const
uint8_t
*
...
#
define
av1_highbd_convolve_avg
av1_highbd_convolve_avg_c
void
av1_highbd_convolve_copy_c
(
const
uint8_t
*
...
(
*
av1_highbd_dist_wtd_convolve_2d
)
(
const
uint16_t
...
(
*
av1_highbd_dist_wtd_convolve_x
)
(
const
uint16_t
...
(
*
av1_highbd_dist_wtd_convolve_y
)
(
const
uint16_t
...
#
define
av1_highbd_estimate_noise_from_single_plane
av1_highbd_estimate_noise_from_single_plane_c
void
...
#
define
av1_highbd_iwht4x4_1_add
av1_highbd_iwht4x4_1_add_c
int64_t
av1_highbd_pixel_proj_error_c
(
const
uint8_t
*
...
;
void
av1_highbd_upsample_intra_edge_c
(
uint16_t
*
p
...
(
*
av1_highbd_upsample_intra_edge
)
(
uint16_t
*
...
(
*
cdef_copy_rect8_16bit_to_16bit
)
(
uint16_t
*
...
;
void
cdef_copy_rect8_8bit_to_16bit_c
(
uint16_t
*
dst
...
(
*
cfl_get_luma_subsampling_422_hbd
)
(
TX_SIZE
tx_size
...
(
*
cfl_get_luma_subsampling_422_lbd
)
(
TX_SIZE
tx_size
...
(
*
cfl_get_luma_subsampling_444_hbd
)
(
TX_SIZE
tx_size
...
(
*
cfl_get_luma_subsampling_444_lbd
)
(
TX_SIZE
tx_size
