...
typedef
union
_VAConfigAttribValContextPriority
{
struct
{
uint32_t
...
typedef
struct
_VAContextParameterUpdateBuffer
{
union
{
struct
...
;
uint8_t
wrapped_decrypt_blob
[
64
]
;
uint8_t
wrapped_encrypt_blob
[
64
]
;
