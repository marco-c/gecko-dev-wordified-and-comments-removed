...
static
int
sip_sm_request_check_and_store
(
ccsipCCB_t
*
ccb
...
;
void
sip_sm_update_to_from_on_callsetup_finalresponse
(
ccsipCCB_t
*
ccb
...
;
void
sip_sm_update_contact_recordroute
(
ccsipCCB_t
*
ccb
...
char
*
ccsip_find_preallocated_sip_call_id
(
line_t
dn_line
)
...
static
void
ccsip_free_preallocated_sip_call_id
(
line_t
dn_line
)
...
sip_platform_supervision_disconnect_timer_stop
(
ccb
-
>
...
sip_platform_supervision_disconnect_timer_start
(
...
static
boolean
ccsip_check_set_privacy_screen
(
string_t
*
name
...
j
;
sippmh_free_remote_party_id_info
(
ccb
-
>
...
sip_platform_localexpires_timer_start
(
(
local_expires_timeout
+
...
sip_platform_expires_timer_stop
(
ccb
-
>
...
!
(
sip_platform_msg_timer_outstanding_get
(
ccb
-
>
...
sip_platform_unregistration_timer_start
(
2000
(
boolean
...
{
sip_platform_msg_timer_outstanding_set
(
ccb
-
>
...
void
ccsip_handle_transienthold_ev_cc_feature
(
ccsipCCB_t
*
ccb
...
scp
=
sippmh_parse_service_control_body
(
pSipMessage
-
>
