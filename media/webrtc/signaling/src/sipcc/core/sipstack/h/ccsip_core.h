...
#
define
SUPERVISION_DISCONNECT_TIMEOUT
32000
#
define
SIP_WARNING_LENGTH
...
-
1
SIPSPI_EV_INDEX_BASE
=
0
H_IDLE_EV_SIP_INVITE
=
SIPSPI_EV_INDEX_BASE
H_IDLE_EV_CC_SETUP
...
;
void
ccsip_handle_active_ev_cc_feature_xfer
(
ccsipCCB_t
*
ccb
...
;
void
ccsip_handle_active_ev_cc_feature_indication
(
ccsipCCB_t
*
ccb
...
;
void
ccsip_handle_ev_cc_answer_audit_request
(
ccsipCCB_t
*
ccb
...
ccsipCCB_t
*
sip_sm_get_ccb_by_ccm_id_and_index
(
int
ccm_id
line_t
...
ccsipCCB_t
*
sip_sm_get_target_call_by_con_call_id
(
callid_t
con_call_id
)
...
;
callid_t
sip_sm_get_blind_xfereror_ccb_by_gsm_id
(
callid_t
gsm_id
)
...
;
boolean
sip_sm_is_bye_or_cancel_response
(
sipMessage_t
*
response
...
;
void
sip_decrement_backup_active_count
(
ccsipCCB_t
*
ccb
...
;
void
sip_sm_update_to_on_midcall_200
(
ccsipCCB_t
*
ccb
...
sipServiceControl_t
*
ccsip_get_notify_service_control
(
sipMessage_t
*
pSipMessage
...
;
boolean
ccsip_is_special_name_to_mask_display_number
(
const
char
*
