...
;
int
max_tcp_send_msg_q_size
=
0
;
int
max_tcp_send_msg_q_connid
=
0
;
cpr_ip_addr_t
max_tcp_send_msg_q_ipaddr
=
{
0
{
...
;
ushort
max_tcp_send_msg_q_port
=
0
;
static
ccsipRet_e
ccsipSocketSetNonblock
(
cpr_socket_t
fd
int
...
ti_config_table_t
*
ccm_active_table_entry
=
NULL
*
ccm_standby_table_entry
=
NULL
*
ccm_table_entry
