...
#
define
MULTICAST_START_ADDRESS
0xe1000000
#
define
MULTICAST_END_ADDRESS
0xefffffff
#
define
GET_CODEC_TYPE
...
#
define
CAST_DEFAULT_BITRATE
320000
#
define
GSMSDP_MAX_MLINES_PER_CALL
(
8
)
#
define
GSMSDP_PERM_MEDIA_ELEMS
(
LSM_MAX_CALLS
)
static
...
extern
boolean
g_disable_mass_reg_debug_print
;
static
const
cc_media_cap_table_t
*
gsmsdp_get_media_capability
(
fsmdef_dcb_t
*
dcb_p
...
fsmdef_media_t
*
gsmsdp_find_media_by_cap_index
(
fsmdef_dcb_t
*
dcb_p
...
static
uint16_t
gsmsdp_find_unused_media_line_with_type
(
void
*
sdp
...
static
void
gsmsdp_update_local_time_stamp
(
fsmdef_dcb_t
*
dcb_p
...
static
void
gsmsdp_get_local_source_v4_address
(
fsmdef_media_t
*
media
...
static
void
gsmsdp_get_local_source_v6_address
(
fsmdef_media_t
*
media
...
sdp_attr_set_rtpmap_payload_type
(
sdp_p
level
0
...
sdp_attr_set_fmtp_max_average_bitrate
(
sdp_p
level
0
a_inst2
FMTP_MAX_AVERAGE_BIT_RATE
)
;
if
(
...
sdp_attr_set_fmtp_useinbandfec
(
sdp_p
level
0
...
{
sdp_attr_set_fmtp_maxcodedaudiobandwidth
(
sdp_p
level
0
a_inst2
max_coded_audio_bandwidth_table
[
opus_fb
]
.
...
result
=
sdp_attr_set_rtcp_mux_attribute
(
sdp_p
level
0
...
result
=
sdp_attr_set_dtls_fingerprint_attribute
(
sdp_p
level
0
...
;
gsmsdp_update_local_sdp_media_transport
(
dcb_p
sdp_p
media
...
{
gsmsdp_update_crypto_transmit_key
(
dcb_p
media
offer
...
ptype
=
sdp_attr_get_rtpmap_payload_type
(
sdp_p
level
0
...
if
(
sdp_media_dynamic_payload_valid
(
sdp_p
ptype
level
...
num_remote_types
=
sdp_get_media_num_payload_types
(
sdp_p
-
>
...
;
sdp_attr_get_fmtp_useinbandfec
(
sdp_p
-
>
...
sdp_attr_get_fmtp_mode_for_payload_type
(
sdp_p
-
>
...
attr_label
=
ccsdpAttrGetFmtpProfileLevelId
(
sdp_p
level
0
...
static
uint8_t
gsmdsp_find_best_match_media_cap_index
(
fsmdef_dcb_t
*
dcb_p
...
static
boolean
gsmsdp_assign_cap_entry_to_incoming_media
(
fsmdef_dcb_t
*
dcb_p
...
fsmdef_media_t
*
gsmsdp_negotiate_add_media_line
(
fsmdef_dcb_t
*
dcb_p
...
static
boolean
gsmsdp_negotiate_remove_media_line
(
fsmdef_dcb_t
*
dcb_p
...
gsmsdp_update_negotiated_transport
(
dcb_p
sdp_p
media
...
sdp_res
=
sdp_attr_get_rtcp_mux_attribute
(
sdp_p
-
>
...
cc_causes_t
gsmsdp_get_offered_media_types
(
fsm_fcb_t
*
fcb_p
...
gsmsdp_init_sdp_media_transport
(
dcb_p
dcb_p
-
...
;
gsmsdp_set_media_transport_for_option
(
sdp_p
-
>
...
static
boolean
gsmsdp_check_add_local_sdp_media
(
fsmdef_dcb_t
*
dcb_p
...
boolean
is_gsmsdp_media_ip_updated_to_latest
(
fsmdef_dcb_t
*
dcb
...
gsmsdp_reset_sdp_media_transport
(
dcb_p
dcb_p
-
...
cc_initialize_msg_body_parts_info
(
msg_body
)
;
