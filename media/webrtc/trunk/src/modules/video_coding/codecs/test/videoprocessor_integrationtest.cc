...
+
"
foreman_cif_short_video_codecs_test_framework_integrationtests
.
yuv
"
;
...
(
VideoProcessorIntegrationTest
ProcessNoLossSpatialResizeFrameDrop
)
{
config_
.
