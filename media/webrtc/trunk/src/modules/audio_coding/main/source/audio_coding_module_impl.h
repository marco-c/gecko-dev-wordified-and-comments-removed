...
;
bool
_stereoReceiveRegistered
;
bool
_stereoSend
;
int
_prev_received_channel
;
int
_expected_channels
;
WebRtc_Word32
_currentSendCodecIdx
;
int
_current_receive_codec_idx
;
bool
_sendCodecRegistered
;
ACMResampler
_inputResampler
;
...
;
WebRtc_UWord8
_receiveREDPayloadType
;
WebRtc_UWord8
_previousPayloadType
;
WebRtc_Word16
_registeredPlTypes
[
...
;
WebRtc_UWord16
_recvPlFrameSizeSmpls
;
bool
_receiverInitialized
;
ACMDTMFDetection
*
_dtmfDetector
