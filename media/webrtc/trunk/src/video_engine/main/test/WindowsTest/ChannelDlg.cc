...
(
IDC_BITRATE
OnCbnSelchangeBitrate
)
ON_CBN_SELCHANGE
(
IDC_MIN_FRAME_RATE
OnCbnSelchangeMinFrameRate
)
ON_BN_CLICKED
(
IDC_STARTLISTEN
...
ON_BN_CLICKED
(
IDC_BTN_RECORD_INCOMING
&
CDXChannelDlg
:
:
OnBnClickedBtnRecordIncoming
)
ON_BN_CLICKED
(
IDC_BTN_RECORD_OUTGOING
&
CDXChannelDlg
:
:
OnBnClickedBtnRecordOutgoing
)
ON_BN_CLICKED
(
IDC_BTN_CREATE_SLAVE
&
CDXChannelDlg
:
:
OnBnClickedBtnCreateSlave
)
ON_BN_CLICKED
(
IDC_PROT_NACKFEC
