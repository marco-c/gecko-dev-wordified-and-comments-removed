...
(
"
video_engineCaptureStandardTest
"
)
;
webrtc
...
if
(
FLAGS_capture_test_ensure_resolution_alignment_in_capture_device
)
{
capability
.
...
(
"
video_engineCaptureExternalCaptureTest
"
)
;
TbVideoChannel
