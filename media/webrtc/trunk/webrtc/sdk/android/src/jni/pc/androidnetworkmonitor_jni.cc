...
(
jni
Java_NetworkInformation_getName
(
jni
j_network_info
)
...
(
jni
Java_NetworkInformation_getConnectionType
(
jni
j_network_info
)
...
j_ip_addresses
=
Java_NetworkInformation_getIpAddresses
(
jni
j_network_info
)
...
android_sdk_int_
(
Java_NetworkMonitor_androidSdkInt
(
env
)
)
...
(
env
Java_NetworkMonitor_getInstance
(
env
)
)
