...
{
return
Java_MediaType_fromNativeIndex
(
jni
media_type
)
...
;
jfieldID
j_ice_server_tls_alpn_protocols_id
=
GetFieldID
(
jni
...
;
jfieldID
j_ice_server_tls_elliptic_curves_id
=
GetFieldID
(
jni
...
;
jfieldID
j_ice_regather_interval_range_id
=
GetFieldID
(
jni
