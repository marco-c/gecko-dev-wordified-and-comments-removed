...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationBitrate
)
{
auto
runtime_config
...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationPacketLoss
)
{
const
float
...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationFec
)
{
for
(
...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationDtx
)
{
for
(
...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationChannels
)
{
for
(
...
(
RtcEventLogEncoderTest
RtcEventAudioNetworkAdaptationAll
)
{
const
int
...
;
uint8_t
parsed_fraction_loss
;
int32_t
parsed_total_packets
;
parsed_log_
.
