...
SendFrameCallback
*
_send_frame_callback
;
ReceiveFrameCallback
*
_receive_frame_callback
;
unsigned
char
_temporalLayers
...
;
uint32_t
_lastSendRTPTimestamp
;
uint32_t
_lastReceiveRTPTimestamp
;
int64_t
last_receive_time_
;
