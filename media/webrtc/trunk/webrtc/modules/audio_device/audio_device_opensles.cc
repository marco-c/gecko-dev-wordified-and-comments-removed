...
is_recording_dev_specified_
(
false
)
is_playout_dev_specified_
(
false
)
is_initialized_
...
buf
[
PLAY_MAX_TEMP_BUF_SIZE_PER_10ms
]
;
int8_t
*
...
buf
[
REC_MAX_TEMP_BUF_SIZE_PER_10ms
]
;
{
CriticalSectionScoped
