...
;
class
MockTransportSequenceNumberAllocator
:
public
...
(
RtpSenderTestWithoutPacer
WritesTimestampToTimingExtension
)
{
rtp_sender_
-
...
(
RtpSenderVideoTest
TimingFrameHasPacketizationTimstampSet
)
{
uint8_t
kFrame
...
(
RtpSenderVideoTest
RetransmissionTypesVP8BaseLayer
)
{
RTPVideoHeader
header
...
(
RtpSenderVideoTest
RetransmissionTypesVP8HigherLayers
)
{
RTPVideoHeader
header
