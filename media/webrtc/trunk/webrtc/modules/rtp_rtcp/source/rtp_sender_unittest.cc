...
(
RtpSenderTest
RegisterRtpAudioLevelHeaderExtension
)
{
EXPECT_EQ
(
...
(
RtpSenderTest
RegisterRtpVideoRotationHeaderExtension
)
{
EXPECT_EQ
(
...
(
RtpSenderTest
BuildRTPPacketWithVideoRotation_MarkerBit
)
{
rtp_sender_
-
...
(
RtpSenderTest
BuildRTPPacketWithHeaderExtensions
)
{
EXPECT_EQ
(
