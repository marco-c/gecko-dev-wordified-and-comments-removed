#
ifndef
WEBRTC_MODULES_RTP_RTCP_SOURCE_RTCP_UTILITY_H_
#
define
WEBRTC_MODULES_RTP_RTCP_SOURCE_RTCP_UTILITY_H_
#
...
;
struct
RTCPPacketExtendedJitterReportItem
{
uint32_t
Jitter
;
...
;
struct
RTCPPacketXRReceiverReferenceTimeItem
{
uint32_t
NTPMostSignificant
;
...
;
bool
ParseXrReceiverReferenceTimeItem
(
int
block_length_4bytes
)
