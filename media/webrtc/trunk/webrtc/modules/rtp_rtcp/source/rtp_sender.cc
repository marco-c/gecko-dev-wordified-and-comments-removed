...
total_bitrate_observer_
(
*
this
)
retransmit_bitrate_observer_
(
*
this
)
...
;
uint16_t
first_allocated_sequence_number
=
sequence_number_
;
sequence_number_
...
block_length
=
BuildAbsoluteSendTimeExtension
(
extension_data
)
;
...
block_length
=
BuildTransportSequenceNumberExtension
(
extension_data
transport_sequence_number_
)
