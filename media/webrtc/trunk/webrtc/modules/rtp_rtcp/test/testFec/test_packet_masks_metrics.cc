...
testFec
/
average_residual_loss_xor_codes
.
h
"
#
...
float
average_residual_loss_random_mask_random_loss
=
sum_residual_loss_random_mask_random_loss
/
num_loss_rates
;
float
average_residual_loss_bursty_mask_bursty_loss
=
sum_residual_loss_bursty_mask_bursty_loss
/
(
