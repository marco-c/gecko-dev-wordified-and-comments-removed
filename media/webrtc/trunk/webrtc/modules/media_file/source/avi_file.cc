...
_videoStreamDataChunkPrefix
(
0
)
_audioStreamDataChunkPrefix
(
0
)
_created
...
bool
readVideoStreamHeader
=
false
;
bool
readAudioStreamHeader
=
false
;
unsigned
