...
=
"
voe_extended_test_external_thread
"
;
_lock
=
...
#
ifdef
_USE_EXTENDED_TRACE_
TEST
(
SetTraceFileName
-
SetDebugTraceFileName
)
;
ANL
(
...
const
int
MaxNumberOfPlayingChannels
(
kVoiceEngineMaxNumOfActiveChannels
)
;
for
(
