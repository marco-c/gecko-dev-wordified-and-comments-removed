...
;
class
SendRtpRtcpHeaderExtensionsTest
:
public
...
(
SendRtpRtcpHeaderExtensionsTest
SentPacketsIncludeNoAudioLevel
)
{
verifying_transport_
.
...
(
SendRtpRtcpHeaderExtensionsTest
SentPacketsIncludeAbsoluteSenderTime
)
{
EXPECT_EQ
(
...
(
SendRtpRtcpHeaderExtensionsTest
SentPacketsIncludeAllExtensions1
)
{
EXPECT_EQ
(
...
(
SendRtpRtcpHeaderExtensionsTest
SentPacketsIncludeAllExtensions2
)
{
EXPECT_EQ
(
...
;
class
ReceiveRtpRtcpHeaderExtensionsTest
:
public
BeforeStreamingFixture
{
...
(
ReceiveRtpRtcpHeaderExtensionsTest
ReceiveASTEnabledBadExtensionId
)
{
EXPECT_CALL
(
