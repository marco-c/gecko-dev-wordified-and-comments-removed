...
mock
/
mock_send_side_congestion_controller
.
h
"
#
...
(
CallBitrateTest
SetBitrateConfigWithValidConfigCallsSetBweBitrates
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBitrateConfigWithDifferentMinCallsSetBweBitrates
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBitrateConfigWithDifferentStartCallsSetBweBitrates
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBitrateConfigWithDifferentMaxCallsSetBweBitrates
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBitrateConfigWithSameConfigElidesSecondCall
)
{
CallBitrateHelper
call
...
(
CallTest
RecreatingAudioStreamWithSameSsrcReusesRtpState
)
{
constexpr
uint32_t
...
;
auto
create_stream_and_get_rtp_state
=
[
&
]
...
(
CallBitrateTest
SetBweBitratesNotCalledWhenEffectiveMaxUnchanged
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBweBitratesNotCalledWhenStartMaskRemoved
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBitrateConfigAfterSetBitrateConfigMaskWithStart
)
{
CallBitrateHelper
call
...
(
CallBitrateTest
SetBweBitratesNotCalledWhenClampedMinUnchanged
)
{
Call
:
