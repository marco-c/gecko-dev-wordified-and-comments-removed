...
;
void
TestXrReceiverReferenceTimeReport
(
bool
enable_rrtr
)
...
(
EndToEndTest
DISABLED_ReceivedFecPacketsNotNacked
)
{
class
FecNackObserver
...
(
EndToEndTest
TransportFeedbackNotConfigured
)
{
TransportFeedbackTest
(
...
(
EndToEndTest
ReceiverReferenceTimeReportEnabled
)
{
TestXrReceiverReferenceTimeReport
(
...
(
EndToEndTest
ReceiverReferenceTimeReportDisabled
)
{
TestXrReceiverReferenceTimeReport
(
...
(
EndToEndTest
DISABLED_RestartingSendStreamPreservesRtpState
)
{
TestRtpStatePreservation
(
...
(
EndToEndTest
NewSendStreamsRespectNetworkDown
)
{
class
UnusedEncoder
...
(
EndToEndTest
NewReceiveStreamsRespectNetworkDown
)
{
CreateCalls
(
...
(
EndToEndTest
VerifyDefaultReceiveConfigParameters
)
{
VideoReceiveStream
:
