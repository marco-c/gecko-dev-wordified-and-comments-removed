...
(
*
_gnome_vfs_mime_type_from_name_fn
)
(
const
char
...
(
*
_gnome_vfs_mime_get_extensions_list_fn
)
(
const
char
...
(
*
_gnome_vfs_mime_extensions_list_free_fn
)
(
GList
*
...
(
*
_gnome_vfs_mime_get_description_fn
)
(
const
char
...
description
=
_gnome_vfs_mime_get_description
(
aMIMEType
)
;
