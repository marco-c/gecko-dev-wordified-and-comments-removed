...
def
test_method_calls_compare_easily
(
self
)
:
...
def
test_only_allowed_methods_exist
(
self
)
:
...
def
test_wraps_call_with_nondefault_return_value
(
self
)
:
...
def
test_baseexceptional_side_effect
(
self
)
:
...
def
test_mock_calls_create_autospec
(
self
)
:
...
def
test_mock_add_spec_magic_methods
(
self
)
:
