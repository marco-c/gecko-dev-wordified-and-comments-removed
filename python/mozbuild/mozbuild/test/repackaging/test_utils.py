...
def
test_application_ini_data_from_tar
(
...
expected_result
def
test_application_ini_data_from_directory
(
)
:
...
def
test_inject_distribution_folder
(
monkeypatch
)
:
...
"
def
test_inject_desktop_entry_file
(
monkeypatch
)
:
...
"
def
test_get_manifest_from_langpack
(
)
:
