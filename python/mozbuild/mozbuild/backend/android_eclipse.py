...
self
.
_process_android_eclipse_project_data
(
obj
.
wrapped
...
def
_Element_for_referenced_project
(
self
name
)
...
'
'
android_eclipse_empty_resource_directory
'
)
)
