...
(
GeckoProfiler
ThreadRegistration_MainThreadName
)
{
EXPECT_TRUE
(
...
(
GeckoProfiler
ThreadRegistration_NestedRegistrations
)
{
using
TR
...
(
GeckoProfiler
ThreadRegistration_RegistrationEdgeCases
)
{
using
TR
...
struct
GtestBaseMarkerTypeUniqueString
:
public
mozilla
:
...
constexpr
bool
scTestsWithOrWithoutStackSampling
[
]
=
{
...
;
class
GeckoProfilerMarkerBenchNoRecycle
:
public
GeckoProfilerMarkerBench
{
...
;
class
GeckoProfilerMarkerBenchRecycle
:
public
GeckoProfilerMarkerBench
{
...
(
GeckoProfilerMarkerBenchRecycle
MarkerInsertionMultiThreadTiny
[
this
]
(
...
(
GeckoProfilerMarkerBenchRecycle
MarkerInsertionMultiThreadLarge
[
this
]
(
...
(
GeckoProfilerMarkerBenchRecycle
MarkerInsertionMultiThreadFieldsAndStack
[
this
]
(
...
(
aFixture
HistoSingleThreadFieldsAndStack
)
{
\
LatencyHist
...
(
aFixture
HistoMultiThreadFieldsAndStack
)
{
\
LatencyHist
