...
profile
.
mProfileAndAdditionalInformation
)
)
)
;
...
;
double
millisecondsBetweenUnixEpochAndStartTime
=
millisecondsSinceUnixEpoch
-
millisecondsSinceStartTime
...
static
void
profiler_save_profile_to_file_with_progress
(
const
char
*
...
static
void
ScheduledDumpProgressEmitterThread
(
void
*
aArg
