...
#
ifdef
DHW_IMPLEMENT_GLOBALS
#
define
DHW_DECLARE_FUN_GLOBAL
(
typename_
name_
)
...
#
define
DHW_DECLARE_FUN_TYPE_AND_PROTO
(
name_
retval_
conv_
...
#
define
DHW_DECLARE_FUN_TYPE_AND_STATIC_PROTO
(
name_
retval_
conv_
