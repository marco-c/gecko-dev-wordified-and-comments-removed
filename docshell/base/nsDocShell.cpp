...
mHasStartedLoadingOtherThanInitialBlankURI
(
false
)
mBlankTiming
...
utf8Host
;
mozilla_net_recover_keyword_from_punycode
(
&
host
&
...
static
void
CreateAboutBlankAncestorOriginsForNonTopLevel
(
Document
*
aDoc
...
:
:
ComputeNamedTargetBrowsingContext
(
nsDocShellLoadState
*
aLoadState
...
-
>
EndInitialAboutBlankLoadCompleting
(
)
;
}
...
:
:
dom_forms_submit_async_navigation
(
)
)
{
...
-
>
StopPendingJavascriptURLNavigations
(
)
;
targetDocShell
...
:
:
StopPendingJavascriptNavigations
"
_ns
NS_BINDING_ABORTED
)
