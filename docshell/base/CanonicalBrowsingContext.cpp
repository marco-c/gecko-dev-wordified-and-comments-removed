...
:
:
dom_navigation_api_strict_enabled
(
)
)
{
...
void
NoStaticCloneForPrintingWillBeCreated
(
)
{
StaticCloneForPrintingCreated
...
-
>
SendUpdateMediaSessionInterrupt
(
this
aAction
)
...
:
:
privacy_clearSiteDataHeader_cache_bfcache_enabled
(
)
)
{
...
:
:
browser_disable_pickers_background_tabs
(
)
)
{
...
:
:
security_restrict_to_adults_always
(
)
)
{
...
:
:
security_restrict_to_adults_respect_platform
(
)
)
{
