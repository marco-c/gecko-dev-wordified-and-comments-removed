...
NS_DEFINE_NAMED_CID
(
NS_EXTERNALPROTOCOLHANDLER_CID
)
;
NS_DEFINE_NAMED_CID
(
NS_PREFETCHSERVICE_CID
)
;
NS_DEFINE_NAMED_CID
(
NS_OFFLINECACHEUPDATESERVICE_CID
)
;
NS_DEFINE_NAMED_CID
(
NS_OFFLINECACHEUPDATE_CID
)
;
NS_DEFINE_NAMED_CID
(
...
{
&
kNS_CONTENTHANDLERSERVICE_CID
false
nullptr
ContentHandlerServiceConstructor
mozilla
:
:
Module
...
{
&
kNS_EXTERNALPROTOCOLHANDLER_CID
false
nullptr
...
false
nullptr
nsExternalURLHandlerServiceConstructor
}
#
endif
{
...
:
:
CreateTestLoadContext
}
{
&
kNS_PRIVATELOADCONTEXT_CID
false
nullptr
mozilla
:
:
CreatePrivateTestLoadContext
}
{
nullptr
}
...
{
NS_EXTERNALSHARINGAPPSERVICE_CONTRACTID
&
kNS_EXTERNALSHARINGAPPSERVICE_CID
}
{
...
{
NS_SHISTORY_INTERNAL_CONTRACTID
&
kNS_SHISTORY_INTERNAL_CID
}
#
