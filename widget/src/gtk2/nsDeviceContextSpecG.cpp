...
(
"
supports_spoolercommand_change
"
aSupportSpoolerCommandChange
)
;
...
supported_doc_attrs
&
XPUATTRIBUTESUPPORTED_DEFAULT_MEDIUM
)
;
printerFeatures
.
...
supported_doc_attrs
&
XPUATTRIBUTESUPPORTED_LISTFONTS_MODES
)
;
printerFeatures
.
...
MAKE_PR_BOOL
(
XpuGetSupportedJobAttributes
(
pdpy
pcontext
)
&
XPUATTRIBUTESUPPORTED_JOB_NAME
)
;
printerFeatures
.
