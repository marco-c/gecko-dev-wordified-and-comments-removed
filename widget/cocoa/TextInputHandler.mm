...
:
:
widget_macos_automatic_text_replacement
(
)
&
&
...
:
:
widget_macos_automatic_quote_substitution
(
)
&
&
...
:
:
widget_macos_automatic_dash_substitution
(
)
&
&
...
:
:
widget_macos_automatic_text_substitution_fetch_length
(
)
;
uint32_t
