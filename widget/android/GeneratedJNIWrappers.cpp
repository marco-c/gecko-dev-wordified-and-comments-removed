...
:
:
jGetCurrentBatteryInformationWrapper
=
0
;
jmethodID
...
:
:
jGetMimeTypeFromExtensionsWrapper
=
0
;
jmethodID
...
:
:
jGetFrameNameJavaProfilingWrapper
=
0
;
jmethodID
...
:
:
jGetThreadNameJavaProfilingWrapper
=
0
;
jmethodID
...
:
:
jDeactivateProgramAndRestoreState
=
0
;
jmethodID
...
:
:
mImmutableViewportMetricsClass
=
0
;
jmethodID
