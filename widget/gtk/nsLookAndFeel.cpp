...
:
:
widget_content_allow_gtk_dark_theme_selection
(
)
;
}
...
:
:
widget_content_allow_gtk_dark_theme_scrollbars
(
)
;
case
...
:
:
widget_content_allow_gtk_dark_theme_accent
(
)
;
default
