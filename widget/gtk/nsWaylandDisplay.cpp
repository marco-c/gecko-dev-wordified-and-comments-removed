...
:
:
widget_wayland_dmabuf_basic_compositor_enabled
(
)
&
&
...
:
:
widget_wayland_dmabuf_textures_enabled
(
)
&
&
...
:
:
widget_wayland_dmabuf_video_textures_enabled
(
)
&
&
...
:
:
widget_wayland_dmabuf_webgl_enabled
(
)
&
&
...
:
:
widget_wayland_dmabuf_vaapi_enabled
(
)
)
{
