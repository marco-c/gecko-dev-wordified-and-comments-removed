...
;
void
OpaqueCallbackHandler
(
)
;
void
ClearOpaqueCallbackLocked
(
const
WaylandSurfaceLock
&
...
;
bool
HasEmulatedVSyncCallbackLocked
(
const
WaylandSurfaceLock
&
...
;
bool
ConfigureCoordinateScaleLocked
(
const
WaylandSurfaceLock
&
...
;
bool
ConfigureFractionalScaleLocked
(
const
WaylandSurfaceLock
&
