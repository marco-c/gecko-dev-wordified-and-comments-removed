...
(
RuntimeClass_Windows_System_Display_DisplayRequest
mDisplayRequest
)
)
)
...
HRESULT
SHCreateShellItemArrayFromShellItemDynamic
(
IShellItem
*
psi
...
;
SHFn
SHCreateShellItemArrayFromShellItemDynamicPtr
=
(
SHFn
)
