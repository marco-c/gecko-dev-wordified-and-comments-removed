...
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CEdgeGesture_Windows__CUI__CInput__CEdgeGestureEventArgs_t
EdgeGestureHandler
;
typedef
Foundation
:
:
__FITypedEventHandler_2_Windows__CUI__CCore__CCoreDispatcher_Windows__CUI__CCore__CAcceleratorKeyEventArgs_t
...
:
:
__FITypedEventHandler_2_Windows__CUI__CCore__CCoreWindow_Windows__CUI__CCore__CPointerEventArgs_t
PointerEventHandler
;
typedef
Foundation
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CGestureRecognizer_Windows__CUI__CInput__CTappedEventArgs_t
TappedEventHandler
;
typedef
Foundation
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CGestureRecognizer_Windows__CUI__CInput__CRightTappedEventArgs_t
...
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CGestureRecognizer_Windows__CUI__CInput__CManipulationStartedEventArgs_t
...
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CGestureRecognizer_Windows__CUI__CInput__CManipulationUpdatedEventArgs_t
...
:
:
__FITypedEventHandler_2_Windows__CUI__CInput__CGestureRecognizer_Windows__CUI__CInput__CManipulationCompletedEventArgs_t
...
:
:
CoreAcceleratorKeyEventType_KeyUp
:
case
UI
:
...
:
:
CoreAcceleratorKeyEventType_SystemKeyUp
:
OnKeyUp
(
vkey
...
:
:
CoreAcceleratorKeyEventType_KeyDown
:
case
UI
:
...
:
:
CoreAcceleratorKeyEventType_SystemKeyDown
:
OnKeyDown
(
vkey
...
:
:
CoreAcceleratorKeyEventType_SystemCharacter
:
case
UI
:
...
:
:
CoreAcceleratorKeyEventType_UnicodeCharacter
:
OnCharacterReceived
(
vkey
...
static
int
previousVertLeftOverDelta
=
0
;
static
int
previousHorLeftOverDelta
=
0
;
if
...
:
:
GestureSettings_ManipulationTranslateX
|
UI
:
:
