...
:
:
ShouldDeliverInputToRecognizer
(
)
{
return
...
;
DispatchAsyncTouchEvent
(
new
TouchEventQueueEntry
(
touchEvent
currentPoint
)
...
:
:
DeliverNextQueuedEventIgnoreStatus
)
;
NS_DispatchToCurrentThread
(
