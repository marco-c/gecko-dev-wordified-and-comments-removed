...
;
PRInt32
NativeFileOpFileCopyPrepare
(
)
;
PRInt32
NativeFileOpFileCopyComplete
(
)
;
PRInt32
...
;
PRInt32
NativeFileOpFileExecuteComplete
(
)
;
PRInt32
NativeFileOpFileMovePrepare
(
)
;
PRInt32
...
;
PRInt32
NativeFileOpFileRenamePrepare
(
)
;
PRInt32
NativeFileOpFileRenameComplete
(
)
;
PRInt32
...
;
PRInt32
NativeFileOpWindowsShortcutPrepare
(
)
;
PRInt32
NativeFileOpWindowsShortcutComplete
(
)
;
PRInt32
...
;
PRInt32
NativeFileOpWindowsRegisterServerPrepare
(
)
;
PRInt32
