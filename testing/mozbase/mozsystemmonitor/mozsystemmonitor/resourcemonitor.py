...
self
.
_pending_console_trace
=
None
        
self
.
_pending_multiline_console
=
None
...
self
.
_flush_pending_console_trace
(
)
        
self
.
_flush_pending_multiline_console
(
)
...
self
.
_handle_multiline_console_line
(
line
)
:
