...
def
_get_extension_response_internal
(
self
)
:
...
def
_setup_stream_options_internal
(
self
stream_options
)
...
self
.
_incoming_message_filter
.
decompress_next_message
(
)
