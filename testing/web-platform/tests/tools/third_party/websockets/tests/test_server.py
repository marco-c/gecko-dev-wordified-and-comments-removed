...
def
test_reject_response_supports_int_status
(
self
)
:
...
def
test_supported_extension_parameters
(
self
)
:
...
def
test_unsupported_extension_parameters
(
self
)
:
...
def
test_multiple_supported_extension_parameters
(
self
)
:
