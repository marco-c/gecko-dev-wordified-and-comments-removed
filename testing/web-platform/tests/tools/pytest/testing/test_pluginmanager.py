...
def
test_namespace_early_from_import
(
self
testdir
)
...
def
test_warn_on_deprecated_multicall
(
self
pytestpm
)
...
def
test_warn_on_deprecated_addhooks
(
self
pytestpm
)
...
def
test_namespace_has_default_and_env_plugins
(
testdir
)
:
