...
self
.
_response_window_bits
=
None
        
self
.
_response_no_context_takeover
=
False
...
def
set_response_no_context_takeover
(
self
value
)
...
def
_get_compression_processor_response
(
self
)
:
...
def
set_compression_processor_hook
(
self
hook
)
