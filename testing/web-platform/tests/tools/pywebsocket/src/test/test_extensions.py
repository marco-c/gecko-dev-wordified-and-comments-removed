...
class
CompressionMethodParameterParserTest
(
unittest
.
TestCase
...
def
test_parse_method_with_parameter
(
self
)
:
...
def
test_parse_method_with_quoted_parameter
(
self
)
:
...
def
test_parse_method_multiple_methods_with_quoted_parameter
(
self
)
:
...
def
test_create_method_desc_simple
(
self
)
:
...
def
test_create_method_desc_with_parameters
(
self
)
:
...
class
PerMessageCompressExtensionProcessorTest
(
unittest
.
TestCase
