...
def
test_element_hidden_by_overflow_x_is_not_visible
(
self
)
:
...
def
test_element_hidden_by_overflow_y_is_not_visible
(
self
)
:
...
class
BodyElementIsAlwaysDisplayedTest
(
base_test
.
WebDriverBaseTest
...
def
test_visibility_hidden_on_child_takes_precedence
(
self
)
:
...
def
test_visibility_hidden_on_parent_takes_precedence_over_display_block
(
self
)
:
